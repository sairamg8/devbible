...
admin.get('/dashboard', (req, res) => res.json({
  baseUrl: req.baseUrl, path: req.path, originalUrl: req.originalUrl,
}));
app.use('/admin', admin);

const reports = express();                     // sub-app
reports.get('/daily', (req, res) => res.json({
  mountpath: req.app.mountpath, baseUrl: req.baseUrl, path: req.path,
}));
