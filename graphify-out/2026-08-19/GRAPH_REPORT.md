...
## Corpus Check
- 5419 files · ~4,960,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30051 nodes · 39433 edges · 1998 communities (1292 shown, 706 thin omitted)
...
- 02-normalising-at-the-boundary.md
- phase-2-classes-objects/README.md
- 04-lib-target-ambient/README.md
- 02-closest-matches-and-scope.md
...
- 02-autoboxing-integer-cache/README.md
- phase-9-spring-boot/README.md
- 02-where-it-fails.md
...
- phase-1-database/README.md
- 01-project-structure.md
- 04-choosing.md
- 02-clamp-min-max.md
- 01-what-the-browser-is-doing.md
- 20-intl/README.md
- 11-memoize/README.md
- nginx/README.md
- pg_stat_activity
...
- 12-threadlocal-scopedvalue/README.md
...
- 11-error-boundaries-and-retry.md
...
- 01-the-model.md
- 12-feature-detection/README.md
...
- 04-stack/README.md
- 06-bfs/README.md
- 13-non-mutating-counterparts.md
- 06-arrays.md
...
- 4. Senior Engineer Edge Cases & Pitfalls
- Cascade
- 07.2 · The fixes, and which to choose
- 01.2 · Holes, length and sparse arrays
- 01 · Destructuring
...
- Syllabus Part 3 Adaptive visual motion
- 02.1 · push, pop, shift, unshift
- Part 2 — Data, iteration and async
- Phase 6 — Data access
- SAVEPOINT
- Fan-out and aggregates
...
- 02-details-that-feel-native.md
- Feature detection
- Lexical scope
...
- 02-containment-and-jsonpath.md
- Node-API stable ABI
- Event loop phases
...
- 4. Senior Engineer Edge Cases & Pitfalls
- 4. Senior Engineer Edge Cases & Pitfalls
- 01-the-accidental-waterfall.md
...
- SSRF
- Deserialization, open redirects, mass assignment
- Mocking — mock.fn, mock.method and timers
- PostgreSqlContainer
...
- Issuing DDL through the driver
- Generated TypeScript types
- withTransaction wrapper
- SELECT ... FOR UPDATE
- What React is
- 01-pause-and-resume.md
...
- 11-why-virtual-threads-changed-the-answer.md
...
- ex5-totp.mjs
- CSS syllabus
- Author identity required to commit
- JSX interpolation is expression-only
...
- ReDoS
- Timing attacks
- Coverage — why 100% is a bad target
- ESLint flat config
- Phase 9 — Testing
...
- Atomic upsert
- DELETE
- WHERE on right table cancels LEFT JOIN
...
- componentDidCatch
- Children namespace
- An effect has its own lifecycle
- Symmetrical cleanup
...
- pg bigint as string
- 01-accessors-and-paths.md
- 04-build-json-sql.md
...
- Planner costs, WAL, and changing a setting
- Changing a setting
...
- Extension available vs installed

## God Nodes (most connected - your core abstractions)
1. `Phase 1 The type vocabulary` - 23 edges
2. `Phase 5 Networking HTTP and processes` - 19 edges
3. `Phase 12 — Beyond plain tables` - 18 edges
4. `Phase 1 — JSX and what a component returns` - 17 edges
5. `compilerOptions` - 16 edges
6. `Phase 1 Selectors overview` - 16 edges
7. `section()` - 14 edges
8. `runApp()` - 14 edges
9. `section()` - 14 edges
10. `What the cascade compares` - 14 edges
...
## Communities (1998 total, 706 thin omitted)
...
### Community 3 - "phase-9-mern-pern-stack/README.md"
Cohesion: 0.01
...
### Community 4 - "phase-11-podman-in-depth/README.md"
Cohesion: 0.02
...
Cohesion: 0.01
Nodes (188): Gotchas, Improving coverage, Interview questions, 🔴 It compiles rule-breaking code anyway, Making bail-outs visible or fatal, What bailing out looks like, What it must be able to prove, Event handlers are not a grey area (+180 more)
...
Cohesion: 0.04
Nodes (55): Gotchas, Interview questions, The four capabilities that are genuinely hard, The smallest honest example, The split it is actually making, Unstyled is not headless, `aria-activedescendant`, Count it (+47 more)
...
Cohesion: 0.02
Nodes (117): Gotchas, Interview questions, One function, both endings, The two behaviours nobody expects, What goes in the body, When the default handler is enough, Which `err.status` it will believe, 1 · The `headersSent` guard comes first (+109 more)

### Community 16 - "phase-10-strictness/README.md"
Cohesion: 0.03
Nodes (87): Adopting it, Gotchas, Interview questions, The four honest fixes, The honest objections, What it changes, What it does *not* change, Why it finds real bugs (+79 more)

### Community 17 - "10-satisfies/README.md"
Cohesion: 0.02
Nodes (111): Gotchas, Interview questions, `satisfies` is the one that checks, 🔴 The compiler has no opinion about `!`, The rule this gives you, 🔴 The three, ranked by how much the compiler checks, What `as` actually gets you, and where its floor is, 1 · Standing in for a guard the compiler would have done for free (+103 more)
...
### Community 20 - "phase-7-networking/README.md"
Cohesion: 0.02
...
Cohesion: 0.02
Nodes (103): Chunks, Phase gate, Three facts worth carrying out of this topic, Where this connects, Chunks, Phase gate, Three facts worth carrying out of this topic, Where this connects (+95 more)

### Community 23 - "03-the-suppression-tiers.md"
Cohesion: 0.02
Nodes (127): Assignment or argument?, Gotchas, Interview questions, Missing-property errors say which, 🔴 Overload errors, and why they are the worst, The shape, Three techniques that make errors readable, Two errors that mean something structural (+119 more)
...
Cohesion: 0.02
Nodes (91): Gotchas, Interview questions, Only a `type` can do this, Reading the parts, The identity mapping, and why it matters, The one thing to understand first, The syntax, and where it comes from, You can iterate any union, not just `keyof` (+83 more)

### Community 29 - "08-knowing-when-to-stop/README.md"
Cohesion: 0.03
Nodes (87): Gotchas, Interview questions, The event-handler example, in full, The four intrinsics, The limits worth knowing before you commit, Unions expand, and multiple slots multiply, What it is actually for, Constraints are the exception, and that is the whole lever (+79 more)
...
Cohesion: 0.02
Nodes (91): Fix one: flatten it (cosmetic, and that is fine), Fix two: have fewer providers at the root (the real one), Gotchas, Interview questions, Provider count is not the metric, Providers and Server Components, The shape everyone ends up with, What React 19 changed (+83 more)

### Community 32 - "phase-3-generics/README.md"
Cohesion: 0.02
Nodes (126): A type parameter is a variable in the type language, Constraints, in one line ahead of the next page, Gotchas, Interview questions, Multiple type parameters relate their arguments, The problem, before the solution, What you can do with an unconstrained `T` — almost nothing, Where the parameter may appear (+118 more)

### Community 33 - "05-capping-depth-deliberately.md"
Cohesion: 0.03
Nodes (79): Gotchas, Interview questions, Neither limit is the one you should be relying on, The two limits, What counts as a tail call — three conditions, all readable, What the shape looks like in each case, A string accumulator — seed `""`, A tuple accumulator — seed `[]` (+71 more)
...
Cohesion: 0.03
Nodes (81): Gotchas, Interview questions, The dispatcher you write if you do not use a framework, What Express supplies, exactly, What `node:http` actually gives you, Why the pipeline model — and not decorators or a controller registry, `express()` returns a function, not an object, Gotchas (+73 more)
...
### Community 41 - "09-generic-classes.md"
Cohesion: 0.03
Nodes (69): Extending and abstract, Gotchas, Implementing a generic interface, Inference comes from the constructor, Interview questions, Private members make a class nominal-ish, 🔴 Statics cannot reference the class type parameter, Trade-off (+61 more)

### Community 42 - "01-module-and-moduleresolution/README.md"
Cohesion: 0.03
...
### Community 43 - "04-rate-limiting.md"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (74): `beforeinput` — the cancelable one, Focus events on forms, Gotchas, `input` versus `change` — the one people get wrong, Interview questions, Keeping keyboard shortcuts out of forms, `submit`, and the two ways to trigger it, Chunks (+66 more)
...
### Community 49 - "13-project-references/README.md"
Cohesion: 0.03
...
### Community 51 - "02-normalising-at-the-boundary.md"
Cohesion: 0.04
Nodes (44): Gotchas, Interview questions, JSON cannot carry `undefined`, Nested destructuring defaults have the same hole, twice, `??`, not `||`, The decision under the fix: is `null` "absent" or is it a value?, Destructuring defaults fire on `undefined` only, Gotchas (+36 more)

### Community 52 - "phase-2-classes-objects/README.md"
Cohesion: 0.04
Nodes (51): Class initialization comes first — once, lazily, Field shadowing — one name, two fields, Gotchas, Instance initialization — the sequence to memorize, Instance initializer blocks, precisely, Interview questions, The parts, and what each is for, Constructor chaining with `this(...)` (+43 more)
...
### Community 54 - "02-closest-matches-and-scope.md"
Cohesion: 0.05
Nodes (36): Both child collections are live, Gotchas, Interview questions, `parentNode` and `parentElement` differ in exactly one place, When a manual walk is actually right, Why the `Node` family bites: whitespace is a node, `closest` — the up-walk, done properly, Containment: `contains` and `compareDocumentPosition` (+28 more)
...
Cohesion: 0.04
Nodes (55): `accept`, `multiple`, `capture` — hints, not rules, Drag and drop, Gotchas, Interview questions, Paste, 🔴 Selecting the same file twice fires nothing, The input, Validating on the client (+47 more)
...
### Community 61 - "phase-5-built-in-library/README.md"
Cohesion: 0.03
Nodes (81): `at(index)` — the reason `arr[-1]` never worked, Choosing, in one line each, Gotchas, Interview questions, `slice(start, end)` — a shallow copy of a range, `splice(start, deleteCount, ...items)` — remove, insert, or both, Strings: `slice` is the one to use, The loop bug this topic exists to prevent (+73 more)

### Community 62 - "03-reading-writing-and-arithmetic.md"
Cohesion: 0.03
...
### Community 63 - "04-operators-overflow/README.md"
Cohesion: 0.04
...
### Community 65 - "11-spring-security/README.md"
Cohesion: 0.03
Nodes (81): Phase gate, Where this connects, 1. `DelegatingFilterProxy` — the bridge into Spring, 2. `FilterChainProxy` — the bean it delegates to, 3. `SecurityFilterChain` — one per "kind of request", Gotchas, Interview questions, Matching is not limited to URLs (+73 more)
...
### Community 67 - "03-try-with-resources/README.md"
Cohesion: 0.04
...
### Community 68 - "13-decorators.md"
Cohesion: 0.03
Nodes (80): 1. `this` as a return type — polymorphic `this`, 2. `this` parameters — a fake first parameter, 3. `this`-based type guards, Arrow property or method? The `this` question, Gotchas, Interview questions, `noImplicitThis`, Trade-off (+72 more)
...
### Community 71 - "01-the-product-grid/README.md"
Cohesion: 0.03
...
### Community 72 - "02-the-ioc-container/README.md"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (75): Cancelling deliberately, Combining the caller's signal with the wrapper's timeout, Distinguishing the three failures, Gotchas, Interview questions, The timeout is one line, Version 4 — timeout and cancellation wired in, Announcing the change (+67 more)

### Community 75 - "phase-3-generics-collections/README.md"
Cohesion: 0.04
Nodes (49): Gotchas, Interview questions, One marker, one seam worth knowing, Program to the interface, Reading a JDK signature against the map, The map itself, Why `Map` is not a `Collection`, `Arrays` — the same jobs for raw arrays (+41 more)

### Community 76 - "03-error-and-subclasses/README.md"
Cohesion: 0.03
Nodes (59): Gotchas, Interview questions, The bug it exists to catch, The corners, The genuinely modern use: an abstract base class, The `instanceof` guard — the ES5 way, The `new.target` guard — direct and honest, The two guards, and why the older one is worse (+51 more)

### Community 77 - "phase-10-server-components/README.md"
Cohesion: 0.01
Nodes (184): "before bundling", Build time — no web server at all, Gotchas, "in an environment separate from your client app or SSR server", Interview questions, "renders ahead of time", Request time — your data layer, without an API, The two modes, and why "server" is a misleading name (+176 more)

### Community 78 - "03-target-lib-and-types.md"
Cohesion: 0.03
Nodes (59): Gotchas, Interview questions, Path A — `tsc` emits, Node runs the output, Path B — Node runs the `.ts` files, `tsc` only checks, 🔴 The trap: `allowImportingTsExtensions` and its version-dependent rule, What Path B costs you, Which path should a service take?, Format is detected per file, not set globally (+51 more)

### Community 79 - "01-what-a-bundler-does.md"
Cohesion: 0.03
Nodes (79): Default exports, Gotchas, Interview questions, Live bindings — the part that is not obvious, Named exports, Namespace imports, Re-exporting, The specifier must be a string literal (+71 more)
...
Cohesion: 0.03
Nodes (72): Where this connects, Why this is a Master topic, Gotchas, Interview questions, Messages that help at 3 a.m., Never lose the cause, One exception per layer, or per case?, The shape of a well-built custom exception (+64 more)
...
### Community 85 - "02-mount-order-is-the-content.md"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (52): Chunks, Phase gate, The three things that go wrong, Where this connects, Chunks, Phase gate, The three that catch people, Where this connects (+44 more)
...
### Community 91 - "02-floating-promises.md"
Cohesion: 0.08
Nodes (22): Disguise 2: the missing `await`, Disguise 3: `forEach` with an `async` callback, Disguise 4: deliberate fire-and-forget, Gotchas, Interview questions, MDN's own worked example, The rule, and the tooling, A `catch` that only logs (+14 more)

### Community 92 - "02-exactness-any-and-choosing-a-tool.md"
Cohesion: 0.06
Nodes (31): Gotchas, Interview questions, The two directions, and only one of them is load-bearing, `@ts-expect-error` as an assertion, Where they earn their place, 🔴 Which means: a type test outside the program is not a test, 🔴 `any` defeats the naive version of both, Choosing a tool (+23 more)
...
### Community 95 - "09-queues-deques.md"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (76): Clickjacking — your page inside someone else's, Framing someone else: `sandbox`, Gotchas, Interview questions, `postMessage` — the two checks nobody writes, `window.opener` — the handle you give away, Defence in depth: CSP and Trusted Types, Dependencies — the code you did not write (+68 more)
...
Cohesion: 0.04
Nodes (53): 1. Assigning a non-string coerces it — and that is deprecated, 2. Windows is case-insensitive, 3. Worker threads get a *copy*, 4. Modifications do not escape the process, 5. The empty string is present and falsy, Five runtime behaviours that break the mental model, Gotchas, Interview questions (+45 more)
...
Cohesion: 0.03
Nodes (59): `cause` — chaining without losing the original, Gotchas, Interview questions, Never branch on the message, The built-in subclasses, The four properties, Throwing non-errors, 1. Forward `options` to `super` — or lose `cause` (+51 more)

### Community 103 - "react-p1/harness.mjs"
Cohesion: 0.06
Nodes (37): a, b, require, noise, noise, noise, require, FORWARD (+29 more)

### Community 104 - "react-p0/harness.mjs"
Cohesion: 0.05
Nodes (34): pkg, R, require, cel, el, keyed, React, require (+26 more)

### Community 105 - "02-autoboxing-integer-cache/README.md"
Cohesion: 0.05
Nodes (43): `byte` and `short`: storage types, not arithmetic types, Choosing the integer type — the working rules, Gotchas, Interview questions, Literals — the fine print that bites, The full table, Gotchas, Identity, `hashCode` and the header (+35 more)

### Community 106 - "phase-9-spring-boot/README.md"
Cohesion: 0.03
Nodes (73): Gotchas, Interview questions, Mapping: the shortcut annotations and the class-level prefix, The path a request takes, as far as a controller author needs it, The two annotations, and what the composition actually does, URI patterns: `PathPattern`, not `AntPathMatcher`, Choosing between 404, 405, 415 and 406, `consumes` narrows by `Content-Type` (+65 more)

### Community 107 - "02-where-it-fails.md"
Cohesion: 0.05
Nodes (41): A setter still runs on a frozen object, Arrays — locked, but they fail two different ways, Every copy comes out unfrozen, Gotchas, Interview questions, `Map`, `Set`, `Date`, `WeakMap` — freeze does nothing at all, `#private` fields survive a freeze, What is still protected, and is easy to forget (+33 more)
...
### Community 109 - "05-the-cost.md"
Cohesion: 0.05
Nodes (40): Gotchas, Interview questions, Start from what a homomorphic mapping already gives you, 🔴 The part everybody guards against unnecessarily, Where the mapping goes when it does apply, 1. Methods are destroyed, and the mechanism is structural, 2. Class instances become structurally different objects, 3. `DeepPartial` makes array elements possibly `undefined` (+32 more)

### Community 110 - "05-isolatedmodules/README.md"
Cohesion: 0.04
...
Cohesion: 0.02
Nodes (106): Buffering: why, and when not, Bytes or characters — pick the right hierarchy, Decoding failure is a policy, and the JDK ships two, Gotchas, Interview questions, JEP 400 — UTF-8 by default since JDK 18, The small print that bites, Bodies in and out (+98 more)

### Community 114 - "01-the-high-frequency-events.md"
Cohesion: 0.05
Nodes (40): Breakpoints belong to `matchMedia`, Cleanup, Gotchas, Interview questions, Pick the signal that matches the question, `resize`: the window event versus `ResizeObserver`, `scroll`, in one paragraph, The entry properties (+32 more)
...
### Community 116 - "09-arrays.md"
Cohesion: 0.05
Nodes (44): `Arrays.asList` — the three-trap method, Covariance and `ArrayStoreException`, Gotchas, Interview questions, `java.util.Arrays` — the missing methods, What an array is, Why collections replace arrays in application code, Gotchas (+36 more)

### Community 117 - "01-why-a-long-list-freezes.md"
Cohesion: 0.04
Nodes (55): Cost: what observing actually charges you, Fix 1 — do not write sizes at all, Fix 2 — write to a different element, Fix 3 — skip the write when the size is already right, Fix 4 — defer the write out of the delivery, Gotchas, Interview questions, Testing and environments without one (+47 more)
...
### Community 120 - "02-lazy-sequences.md"
Cohesion: 0.04
...
### Community 121 - "02-promisifying.md"
Cohesion: 0.05
Nodes (39): Gotchas, Interview questions, The same anti-pattern in `async` clothing, When `new Promise` is correct, Why it is harmful, not just verbose, Gotchas, Interview questions, Most of the time you should not be using the constructor at all (+31 more)

### Community 122 - "05-distributive-conditionals.md"
Cohesion: 0.05
Nodes (46): Distributing on purpose, Gotchas, Interview questions, The rule, The three results that surprise people, Turning it off, What "naked" means, precisely, Why the whole union-filter family depends on it (+38 more)

### Community 123 - "02-import-type-and-verbatim-module-syntax/README.md"
Cohesion: 0.05
...
### Community 124 - "01-the-three-sections.md"
Cohesion: 0.04
...
### Community 127 - "05-one-to-squillions.md"
Cohesion: 0.05
...
### Community 128 - "01-comparison-operators.md"
Cohesion: 0.05
...
### Community 131 - "01-the-shape-and-numberformat.md"
Cohesion: 0.14
...
Cohesion: 0.06
Nodes (32): Catching at the right level, Distinguishing failures, `finally` behaves normally here, Gotchas, Interview questions, It does not catch a call you forgot to `await`, It does not catch errors in callbacks you pass elsewhere, `return` inside `try` is the subtle case (+24 more)

### Community 133 - "08-records/README.md"
Cohesion: 0.05
Nodes (42): Gotchas, Interview questions, The five rules of `equals`, The `hashCode` contract, `==` vs `equals`, restated once, What the defaults mean, Why the pairing exists: what `HashMap` actually does, `BigDecimal`: the field that lies in both directions (+34 more)

### Community 134 - "04-polymorphism-dispatch/README.md"
Cohesion: 0.05
Nodes (41): Constructors and dispatch: the initialization-order bug, Covariant returns and bridge methods, Gotchas, Interview questions, The two-step resolution, precisely, What is dynamic, and what is not, Gotchas, Interview questions (+33 more)

### Community 135 - "10-deriving-function-types/README.md"
Cohesion: 0.07
Nodes (27): Async — wrap the return in a promise, without double-wrapping, Gotchas, Interview questions, Labels and optionality survive; that is the point, One parameter changed, the rest forwarded, The three variations you will need, `this` — preserved, or deliberately removed, `typeof` needs a value, and that is a constraint on your design (+19 more)

### Community 136 - "03-path-aliases/README.md"
Cohesion: 0.05
...
### Community 137 - "04-gradle/README.md"
Cohesion: 0.05
...
### Community 139 - "11-infer-in-conditional-types.md"
Cohesion: 0.04
Nodes (50): Conditional types, in one paragraph, Constrained `infer` (TypeScript 4.8), 🔴 Distribution over unions, Gotchas, `infer` names a piece of the pattern, `infer` position decides union or intersection, Interview questions, The library's own `infer` types, read from the source (+42 more)

### Community 140 - "02-client-side-security/01-the-trust-boundary.md"
Cohesion: 0.06
Nodes (29): Gotchas, Hidden UI is not access control, Interview questions, Secrets, The honest list, The one sentence the whole topic rests on, Validation, What CORS does and does not protect (+21 more)

### Community 141 - "02-uploading-and-submitting.md"
Cohesion: 0.05
Nodes (42): Chunks, Phase gate, The one thing to remember, Where this connects, Adding files without losing the ones already there, Every entry point feeds the same function, Gotchas, Interview questions (+34 more)
...
Cohesion: 0.03
Nodes (74): Bounded input is a security property, not a nicety, Gotchas, Interview questions, The DTO carries constraints; the domain type carries invariants, The trade-off, Three different things are called "invalid", What validation is not, Gotchas (+66 more)
...
### Community 148 - "01-stacking-contexts.md"
Cohesion: 0.05
...
### Community 151 - "12-freeze-and-seal/README.md"
Cohesion: 0.05
Nodes (43): Chunks, Phase gate, Where this connects, Compare and group, Create and copy, Gotchas, Interview questions, Protect (+35 more)

### Community 152 - "01-what-is-safe-to-retry.md"
Cohesion: 0.04
Nodes (51): Gotchas, Interview questions, Question 1 · Transient or permanent, Question 2 · Is repeating it safe?, `Retry-After` outranks your backoff, Timeouts come before retries, Where retries belong: one layer, not every layer, Fail fast, or degrade — decide per boundary (+43 more)
...
Cohesion: 0.07
Nodes (26): Gotchas, `--onto`, in the one situation it is needed, The same conflict, several times, Trade-off, Undoing a rebase, `--update-refs`, for stacked branches, What it does, When it stops (+18 more)

### Community 156 - "09-optimistic-update-helpers.md"
Cohesion: 0.04
...
### Community 157 - "phase-17-machine-coding/README.md"
Cohesion: 0.04
Nodes (48): `allSettled` — never rejects, Gotchas, Interview questions, The behaviour that matters in production, The implementation, What the specification requires, `any` — first to fulfil, Gotchas (+40 more)
...
Cohesion: 0.05
Nodes (43): Gotchas, Interview questions, The design choices, The implementation, The problem, Using it in the app, What to notice, Gotchas (+35 more)
...
### Community 164 - "11-memoize/README.md"
Cohesion: 0.05
...
### Community 166 - "pg_stat_activity"
Cohesion: 0.05
...
### Community 167 - "Phase 4 — CRUD and DML"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (42): Gotchas, `Instant` — a point on the timeline, Interview questions, The choosing table, The `Local` family — "local" means *no zone at all*, Why `Date` and `Calendar` are read-only legacy, `ZonedDateTime` vs `OffsetDateTime` — rules vs a frozen offset, `Duration` — seconds, exactly (+34 more)

### Community 169 - "javascript/pages/README.md"
Cohesion: 0.03
Nodes (64): 🔒 Chunk claims, 🔒 FOUR CHUNKS — `docs/javascript/` is split between four sessions (2026-08-15), 🔴🔴 How a session is started NOW — **give the phase, say continue** (2026-08-15), How these pages are verified, Phases, 🔴 The critical rule — a line cap is a FILE-SIZE rule, never a content budget, The older form — `pick javascript A`, still understood, Working order — 🔴 Master-first is FINISHED; the tiers are the work (+56 more)
...
Cohesion: 0.04
Nodes (45): Assuming `WebClient` means the application is reactive, Choosing between the two models, Functional endpoints, Gotchas, Interview questions, Losing validation when moving a controller to a handler function, Mixing `RouterFunction` and annotated controllers on the same path, WebClient, and its blocking twin (+37 more)

### Community 173 - "`cache` — deduplicate a query across one request"
Cohesion: 0.50
...
### Community 176 - "02-platform-vs-virtual-threads/README.md"
Cohesion: 0.03
Nodes (65): Creating and starting, Daemon threads and JVM exit, Gotchas, Interview questions, `join` — waiting for a thread to finish, The API you should ignore, The six states, When a thread dies by exception (+57 more)

### Community 177 - "06-deep-clone/README.md"
Cohesion: 0.05
...
### Community 179 - "phase-1-everyday-loop/README.md"
Cohesion: 0.09
...
### Community 180 - "10-methods.md"
Cohesion: 0.03
Nodes (60): From `java -jar` to your first line, Gotchas, Interpret first, compile what's hot, Interview questions, Lazy loading: classes arrive at first use, Verification: the JVM does not trust bytecode, What "managed runtime" buys you, When does the process actually exit? (+52 more)

### Community 181 - "17-set.md"
Cohesion: 0.06
Nodes (34): Choosing between `Set`, array and object, Equality is SameValueZero — which decides what "unique" means, Gotchas, Interview questions, The set operations, The two idioms, What a `Set` is not, `Collator` — sorting human text (+26 more)

### Community 182 - "04-extractors.md"
Cohesion: 0.05
Nodes (36): Chaining: first match wins, `extends` asks "is assignable to", Gotchas, Interview questions, The syntax is a ternary, The two things that break the rule, Using a conditional to extract, Assignability between conditionals (+28 more)

### Community 183 - "08-rewrite-and-return.md"
Cohesion: 0.05
...
### Community 184 - "13-null-and-npe/README.md"
Cohesion: 0.05
Nodes (37): Gotchas, Helpful messages: JEP 358, Interview questions, Reading the trace around it, The five places an NPE can happen, The unboxing NPE — no dot in sight, Fail at the boundary: `Objects.requireNonNull`, Gotchas (+29 more)

### Community 185 - "12-threadlocal-scopedvalue/README.md"
Cohesion: 0.05
Nodes (37): Gotchas, `InheritableThreadLocal` — and why executors break it, Interview questions, The mechanics, The pooled-thread leak, The three classic uses, Virtual threads: supported, but the economics flip, Gotchas (+29 more)
...
Cohesion: 0.06
Nodes (32): Chroma is not saturation, and it has no fixed maximum, Gotchas, Interview questions, The problem with HSL, The related notations, Trade-off, What OkLCh changes, Wider gamuts, safely (+24 more)

### Community 190 - "02-transition-traps.md"
Cohesion: 0.06
...
### Community 191 - "14-the-traps.md"
Cohesion: 0.04
Nodes (51): `AuthorizationFilter`, `CsrfFilter`, `ExceptionTranslationFilter`, Gotchas, Interview questions, `SecurityContextHolderFilter`, The authentication filters, The CORS handling (+43 more)
...
Cohesion: 0.06
Nodes (31): Gotchas, Interview questions, The choices worth defending, The DDL, The problem, Three conventions, argued once, Using it in the app, Gotchas (+23 more)
...
Cohesion: 0.06
Nodes (28): Background tabs: the throttling that breaks polling, Cancelling, and the id pool, Gotchas, Interview questions, `setInterval` has two failure modes, and both are silent, The honest list of what replaces a timer, The nesting clamp — where `setTimeout(fn, 0)` stops being 0, The one-sentence model (+20 more)

### Community 196 - "02-cleanup.md"
Cohesion: 0.04
Nodes (45): `defer` and `async` usually remove the need, Gotchas, Interview questions, `readyState`, and the race you did not know you had, Restored from the bfcache: `pageshow`, The two events, What to do at startup, and what not to, Chunks (+37 more)
...
### Community 198 - "08-the-golden-rule.md"
Cohesion: 0.06
...
### Community 201 - "Structured logging"
Cohesion: 0.07
...
### Community 202 - "08-when-a-ref-is-wrong.md"
Cohesion: 0.03
Nodes (78): `addEventListener` with a stable handler, Gotchas, Interview questions, Observers, 🔴 Only `capture` participates in matching, `setInterval` with a changing delay, What the leaks actually look like, Choosing between the two (+70 more)
...
### Community 204 - "⚙️ Code Splitting: Dynamic Imports, `SplitChunksPlugin` & Runtime Chunks"
Cohesion: 0.18
...
### Community 206 - "phase-8-modules-errors/README.md"
Cohesion: 0.05
Nodes (41): Bare names and import maps, Getting the module into the page, Gotchas, Interview questions, `.mjs` or `.js`, The specifier, Top-level `await`, Two loading failures that are not code failures (+33 more)

### Community 207 - "11-error-boundaries-and-retry.md"
Cohesion: 0.15
Nodes (11): Gotchas, Interview questions, The decisions, The implementation, The problem, Gotchas, If the switch happens, Interview questions (+3 more)

### Community 208 - "02-cause-chains-and-boundaries.md"
Cohesion: 0.05
Nodes (37): Build the chain at each layer that adds meaning, Errors do not survive most boundaries intact, Gotchas, `instanceof` is not identity across boundaries, Interview questions, Reading a chain, Several failures at once, Translate at a boundary; do not leak the layer below (+29 more)
...
### Community 210 - "02-inheritance.md"
Cohesion: 0.06
...
### Community 211 - "02-choosing-a-basis.md"
Cohesion: 0.06
...
### Community 213 - "15-webflux-reactive/README.md"
Cohesion: 0.02
Nodes (85): Creating one, Gotchas, Interview questions, `thenApply` vs `thenCompose` — map vs flatMap, `thenCombine` — two independent futures, one result, Which thread runs the callback, `anyOf` — first settled wins, including failures, Gotchas (+77 more)
...
### Community 216 - "phase-1-language-core/README.md"
Cohesion: 0.07
Nodes (29): Constant folding — why `"a" + "b" == "ab"`, Gotchas, Interview questions, The string pool, `==` vs `equals` — the bug that passes its tests, Why immutability, actually, `format` and `formatted`, Gotchas (+21 more)

### Community 217 - "11-customising-serialisation.md"
Cohesion: 0.03
Nodes (74): A type you do not own: `@JacksonMixin`, Global settings: `JsonMapperBuilderCustomizer`, Gotchas, Interview questions, One type: `@JacksonComponent`, The trade-off: one mapper, many contracts, Three levels, in order of preference, 🔴 Why not define your own `JsonMapper` bean (+66 more)
...
### Community 219 - "01-source-to-bytecode.md"
Cohesion: 0.05
Nodes (37): Gotchas, Interview questions, `--release`, not `-source`/`-target`, The class file: anatomy and the version stamp, What bytecode is, What comes out: one class file per type, What `javac` deliberately does not do, Gotchas (+29 more)
...
Cohesion: 0.07
Nodes (27): Phase state — unchanged by this chunk, Phases, Progress, Reading order, Example policy, Explanations, Parts, Prerequisites (+19 more)

### Community 223 - "03-upgrading-in-stages.md"
Cohesion: 0.06
Nodes (33): Gotchas, How to find them, in order of effort, Interview questions, 🔴 The one distinction that sorts your whole toolchain, The tools that import it, by what they need it for, What the audit typically finds, Gotchas, Interview questions (+25 more)

### Community 224 - "03-patch-mode.md"
Cohesion: 0.07
Nodes (25): `e` — editing the hunk by hand, Gotchas, Hunk size is a setting, Interview questions, The keys, The mind-bending part, The other interactive subcommands, Trade-off (+17 more)

### Community 225 - "java/README.md"
Cohesion: 0.07
Nodes (25): Explanations, Parts, Prerequisites, Reading order, Sources, Tier distribution, Tier legend, Version facts (+17 more)

### Community 226 - "01-why-frameworks-servlet-model/README.md"
Cohesion: 0.03
Nodes (55): Gotchas, Interview questions, Overriding `service` and wondering why `doGet` stopped running, State on a servlet or a singleton bean, The interface everything sits on, The `javax` → `jakarta` rename is not cosmetic, The `javax.servlet` jar that is still on the classpath, The lifecycle, and why it produces a threading rule (+47 more)

### Community 227 - "real-world/README.md"
Cohesion: 0.10
...
### Community 230 - "Git 2.55.0 environment probe"
Cohesion: 0.08
...
### Community 231 - "ex3-this.mjs"
Cohesion: 0.07
Nodes (19): a, b, bound, boundToExplicit, bp, collector, counter, madeWithNew (+11 more)

### Community 232 - "02-urlsearchparams.md"
Cohesion: 0.08
Nodes (22): Building a query without a URL, Four ways to build one, Gotchas, Interview questions, Iteration and ordering, Reading — `get` versus `getAll`, The live link with `URL`, Writing — `set` versus `append` (+14 more)
...
### Community 235 - "06-map/01-the-mechanism.md"
Cohesion: 0.07
...
### Community 236 - "phase-2-server-and-location/README.md"
Cohesion: 0.07
...
### Community 237 - "04-watching-and-restoring.md"
Cohesion: 0.05
Nodes (38): Compatibility mouse events, Gotchas, Interview questions, `pointercancel` — the one with no mouse equivalent, The events, The properties that mouse events never had, `touch-action` decides who wins the gesture, When to reach for pointer events (+30 more)
...
### Community 239 - "phase-0-how-storybook-runs/README.md"
Cohesion: 0.08
...
### Community 240 - "01-what-a-decorator-is.md"
Cohesion: 0.07
...
### Community 241 - "02-making-your-own-object-iterable.md"
Cohesion: 0.07
...
### Community 245 - "phase-8-build-dependencies/README.md"
Cohesion: 0.04
Nodes (55): Gotchas, Interview questions, `java -jar` ignores `-cp`. All of it., `MANIFEST.MF` — the attributes that carry weight, `META-INF/services/` — how `ServiceLoader` finds anything, Multi-release jars, The layout, When the format is not the answer (+47 more)
...
### Community 247 - "02-call-apply-bind/README.md"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (32): But `@PostConstruct` is still too early for some things, Destroy-method inference — the one that happens without you, Gotchas, Initialization: three mechanisms, one order, Interview questions, The trade-off, Which one to use, Why not the constructor? (+24 more)
...
### Community 252 - "phase-5-type-level/README.md"
Cohesion: 0.04
Nodes (46): Contextual typing, on its own, Gotchas, How the two directions interleave in a generic call, Inference from the contextual type, Interview questions, Making the context explicit when it is missing, Object and array literals get context too, Reading what actually happened (+38 more)

### Community 253 - "ex14-validation.mjs"
Cohesion: 0.07
Nodes (25): bad, badInput, big, body, dst, Nested, num, out (+17 more)

### Community 254 - "docker/README.md"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (31): An endpoint is a bean with annotated methods, Gotchas, Interview questions, The dependency, What that separation buys you, When one technology needs something the other does not, Gate 1 — does the endpoint exist?, Gate 2 — what access does the endpoint permit? (+23 more)
...
### Community 258 - "12-feature-detection/README.md"
Cohesion: 0.04
...
### Community 262 - "phase-4-objects-and-classes/README.md"
Cohesion: 0.03
Nodes (73): Class accessors live on the prototype — and it shows in JSON, Defining them after the fact, Gotchas, Interview questions, The half-defined cases, The infinite-recursion trap, They are invisible, and things read them without asking, What accessors are actually for (+65 more)
...
Cohesion: 0.13
Nodes (15): Capital letter is a JSX compilation rule, React calls the component not you, The two rules of a pure component, Inputs are props state and context, Module-level write during render, Component purity, Writing a ref during render is unsupported, useSyncExternalStore for external sources (+7 more)

### Community 265 - "patterns/README.md"
Cohesion: 0.02
Nodes (121): Context is the channel, Gotchas, Interview questions, The problem it solves, Gotchas, Interview questions, The guard that throws, What `useMemo` is actually protecting (+113 more)
...
### Community 267 - "phase-2-args-and-controls/README.md"
Cohesion: 0.08
...
### Community 268 - "02-the-message-boundary.md"
Cohesion: 0.08
...
### Community 269 - "Phase 7 — Background work and resilience"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (22): Gotchas, Interview questions, Non-functional requirements, Roles, The entities, The flows, The product in one paragraph, What is out of scope (+14 more)

### Community 272 - "📸 Visual Tests: Chromatic Snapshots, Review Workflow & TurboSnap"
Cohesion: 0.08
...
### Community 273 - "♿ Accessibility Panel: a11y Addon, axe-core & CI Gates"
Cohesion: 0.08
...
### Community 274 - "01-args-as-the-source-of-truth.md"
Cohesion: 0.08
...
Cohesion: 0.12
Nodes (12): Phase gate, Where this connects, Phase gate, Where this connects, Phase gate, Where this connects, Phase gate, Where this connects (+4 more)

### Community 281 - "12-unknown-in-catch.md"
Cohesion: 0.04
Nodes (47): 🔴 A parameter type is a promise the compiler cannot keep at a boundary, Four shapes, and when each is right, Gotchas, Interview questions, Returning `unknown`, 🔴 The mistake this design is usually confused with, The move, in one line, Validate once, at the edge (+39 more)
...
### Community 284 - "Attributes vs props"
Cohesion: 0.10
...
### Community 287 - "⚡ Dev Server Mechanics: Native ESM Serving, HMR & Dependency Pre-Bundling"
Cohesion: 0.18
...
### Community 288 - "⚙️ Advanced Tooling: Writing Custom Loaders & Plugins"
Cohesion: 0.18
...
### Community 290 - "ex6-closures.mjs"
Cohesion: 0.08
Nodes (14): bindings, c1, c2, eachFns, handlers, iifeFns, letFns, ofFns (+6 more)

### Community 291 - "ex54-pgbouncer.mjs"
Cohesion: 0.10
Nodes (21): a, adm, admin, bench(), clients, concPids, connectCost(), DIRECT (+13 more)

### Community 292 - "babel/README.md"
Cohesion: 0.03
Nodes (51): 1. Concept & Under-the-Hood Mechanics, 2. Real-World Engineering Scenario, 3.1 Config File Forms, 3.2 Config Resolution & Root (Monorepos), 3.3 env-based Config, 3.4 overrides, 3. Production-Grade Code Example, 4. Senior Engineer Edge Cases & Pitfalls (+43 more)
...
### Community 294 - "phase-7-async/README.md"
Cohesion: 0.03
Nodes (63): Chunks, Phase gate, The three sentences to keep, Where this connects, Chunks, Phase gate, The three sentences to keep, Where this connects (+55 more)

### Community 295 - "16-new-create-instanceof/README.md"
Cohesion: 0.09
...
### Community 297 - "▶️ Interactions Panel: `play` Functions, Step Debugger & Behavioral Tests"
Cohesion: 0.09
...
### Community 298 - "typescript/pages/README.md"
Cohesion: 0.09
Nodes (18): Phases, Phase 0 — How TypeScript runs, Phase 1 — The type vocabulary, Phase 2 — Narrowing and control flow analysis, Phase 3 — Generics, Where this connects, Phase 4 — Classes, objects and declaration merging, Phase 5 — Type-level programming (+10 more)

### Community 299 - "🚀 Caching Strategies & Production RUM Tooling"
Cohesion: 0.18
...
### Community 300 - "ex5-call-apply-bind.mjs"
Cohesion: 0.09
Nodes (16): arrayLike, bench(), big, bound, BoundPoint, fail(), logger, nums (+8 more)

### Community 301 - "11-module-system.md"
Cohesion: 0.07
...
### Community 303 - "Exactly where it suspends"
Cohesion: 0.13
...
### Community 304 - "Timers"
Cohesion: 0.12
Nodes (24): await yields to the microtask queue, ESM top-level is a microtask, Macrotasks, Microtask queue, process.nextTick queue, Microtasks, macrotasks and nextTick, queueMicrotask vs process.nextTick, setImmediate wins inside an I/O callback (+16 more)

### Community 305 - "Temp plus fsync plus rename"
Cohesion: 0.10
...
### Community 306 - "⚡ Actions Panel: Callback Logging, Spies & Event Verification"
Cohesion: 0.09
...
### Community 307 - "in operator narrowing"
Cohesion: 0.10
Nodes (22): in operator narrowing, k in obj narrows obj never k, Optional properties break in narrowing, The in operator, Prefer a discriminant for designed types, in walks the prototype chain, instanceof narrowing, instanceof narrowing (+14 more)

### Community 308 - "ex2-parameters.mjs"
Cohesion: 0.09
Nodes (3): calls, NOTE: printed with util.inspect, not JSON.stringify — the latter turns, shared

### Community 309 - "docs/README.md"
Cohesion: 0.06
Nodes (14): Coverage, Imported from the frontend-bible corpus (2026-08-14), 🔴 The critical rule — do not violate this, What "Verified" means, 1. Under-The-Hood Mechanics, 2. Real-World Engineering Scenario, 3. Production-Grade Code Example, 4. Senior Engineer Edge Cases & Pitfalls (+6 more)
...
### Community 311 - "02-making-it-usable.md"
Cohesion: 0.12
...
### Community 313 - "06.3 · Private elements"
Cohesion: 0.18
...
### Community 314 - "Phase 0 — The runtime model"
Cohesion: 0.10
...
### Community 315 - "06-force-pushing-safely.md"
Cohesion: 0.07
...
### Community 316 - "02-the-asymmetry.md"
Cohesion: 0.10
...
### Community 317 - "Floating promises"
Cohesion: 0.12
Nodes (19): Promise.prototype.finally, Promise states and chaining, Promises are eager, Return or it is not chained, .then(f, g) vs .then(f).catch(g), Promise pending / fulfilled / rejected, await inside forEach, Create then await is already parallel (+11 more)

### Community 318 - "Password storage"
Cohesion: 0.11
...
### Community 320 - "01-the-six-apis.md"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (26): Gotchas, Interview questions, Naming, The facade and the registry, The four meter types that matter, The trade-off, Exporting them: Prometheus as the worked example, Gotchas (+18 more)
...
### Community 325 - "03-git-commit.md"
Cohesion: 0.05
Nodes (37): `-a`: the flag with a hole in it, `--amend`: a new commit, always, Author versus committer, Committing specific paths, Gotchas, The flags worth knowing about, The message, Trade-off (+29 more)

### Community 326 - "04-resolving-conflicts.md"
Cohesion: 0.10
...
### Community 327 - "05-queue-and-deque/README.md"
Cohesion: 0.11
...
### Community 329 - "15-isolateddeclarations/README.md"
Cohesion: 0.07
...
### Community 332 - "06-testing-the-config.md"
Cohesion: 0.10
...
### Community 333 - "Globals worth knowing"
Cohesion: 0.11
...
### Community 334 - "Shared schema with RLS"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (33): Gotchas, Interview questions, `strict` is a meta-flag over nine options, The default is `true`, and that changes how you read a config, Three of the nine are not about types at all, Why "just turn it all on" is the right default *and* not always possible, Adopting it on a codebase that has not, Definite assignment is a different `!` (+25 more)
...
### Community 341 - "dependencies"
Cohesion: 0.10
Nodes (19): dependencies, @babel/core, babel-plugin-react-compiler, @babel/preset-react, esbuild, puppeteer-core, react, react-dom (+11 more)

### Community 342 - "pages/index.js"
Cohesion: 0.10
Nodes (17): css, docker, express, git, java, javascript, LAYERS, mongodb (+9 more)
...
Cohesion: 0.05
Nodes (37): Binary files and generated output, Comparing commits and branches, Diffing things that are not commits, Gotchas, Limiting the diff, Reading a unified diff, The options that make diffs readable, The three you use every day (+29 more)

### Community 346 - "09-reflog.md"
Cohesion: 0.07
Nodes (25): Gotchas, The four disasters, and their fixes, The limits — worth knowing before you rely on it, The recovery procedure, The `@{...}` syntax, Trade-off, What each entry tells you, What it records (+17 more)

### Community 347 - "02-getting-it-right.md"
Cohesion: 0.06
...
### Community 348 - "phase-14-data-structures/README.md"
Cohesion: 0.06
...
### Community 349 - "04-stack/README.md"
Cohesion: 0.11
...
### Community 350 - "06-bfs/README.md"
Cohesion: 0.11
...
### Community 351 - "13-non-mutating-counterparts.md"
Cohesion: 0.11
...
### Community 353 - "Phase 5 Networking HTTP and processes"
Cohesion: 0.19
...
### Community 354 - "EXPLAIN vs EXPLAIN ANALYZE"
Cohesion: 0.18
...
### Community 356 - "Phase 1 — psql, mastered"
Cohesion: 0.18
...
### Community 357 - "RETURNING and merge_action"
Cohesion: 0.16
...
### Community 358 - "Controlled and uncontrolled"
Cohesion: 0.13
...
### Community 359 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.11
...
### Community 361 - "07.2 · The fixes, and which to choose"
Cohesion: 0.20
...
### Community 362 - "01.2 · Holes, length and sparse arrays"
Cohesion: 0.21
...
### Community 363 - "01 · Destructuring"
Cohesion: 0.17
...
### Community 364 - "playwright/README.md"
Cohesion: 0.08
Nodes (20): 1. Under-The-Hood Mechanics, 2. Real-World Engineering Scenario, 3. Production-Grade Code Example, 4. Senior Engineer Edge Cases & Pitfalls, 🎭 Auto-Waiting & Assertions: Web-First Assertions, Actionability & Soft Assertions, ⚠️ Pitfall 1: Adding Manual `waitForTimeout()` Delays "Just in Case", ⚠️ Pitfall 2: Using Regular `expect()` When Checking Several Independent, Unrelated Conditions, ⚠️ Pitfall 3: Assuming Actionability Checks Substitute for Explicit Assertions About State (+12 more)

### Community 365 - "Lists and key"
Cohesion: 0.13
Nodes (18): Duplicate keys may omit children, Index keys rewrite text in place, Key on the map callback's outermost child, Lists and key, Stable keys move DOM nodes, Missing-key warning is deduplicated, Wrapper div breaks HTML nesting and flex, Fragment groups without a DOM node (+10 more)

### Community 367 - "3. Production-Grade Examples"
Cohesion: 0.11
...
### Community 370 - "ex15-validation-followups.mjs"
Cohesion: 0.11
Nodes (15): Capped, cases, D, Loose, many, obj, one, Patch (+7 more)

### Community 371 - "Combinators"
Cohesion: 0.14
...
### Community 374 - "04.1 · Choosing a method"
Cohesion: 0.20
...
### Community 376 - "Phase 8 — Security"
Cohesion: 0.18
...
### Community 377 - "node:test — the built-in runner"
Cohesion: 0.15
...
### Community 380 - "03-write-once-run-anywhere.md"
Cohesion: 0.08
...
### Community 383 - "p7-background-work/package.json"
Cohesion: 0.12
Nodes (15): bullmq, ioredis, dependencies, bullmq, ioredis, pg, description, pg (+7 more)

### Community 384 - "Phase 0 How CSS runs"
Cohesion: 0.19
...
### Community 385 - "Syllabus Part 3 Adaptive visual motion"
Cohesion: 0.20
...
### Community 386 - "02.1 · push, pop, shift, unshift"
Cohesion: 0.20
...
### Community 387 - "Part 2 — Data, iteration and async"
Cohesion: 0.13
...
### Community 388 - "Phase 6 — Data access"
Cohesion: 0.17
...
### Community 390 - "Fan-out and aggregates"
Cohesion: 0.29
Nodes (11): Fan-out and aggregates, count(DISTINCT) rescues counts only, Join fan-out, Result grain, Pre-aggregate the child then join, LEFT JOIN at-least-once guarantee, Fan-out compounds across independent branches, array_agg FILTER plus coalesce (+3 more)

### Community 391 - "Minimal migration runner"
Cohesion: 0.17
...
### Community 392 - "Phase 1 — JSX and what a component returns"
Cohesion: 0.15
Nodes (16): Objects are not valid as a React child, What can be rendered, Promise child suspends, Renderable child types, Silent no-render values, Returning undefined throws, Do not call components as functions, Capitalization decides everything (+8 more)

### Community 393 - "ref as a prop (React 19)"
Cohesion: 0.12
...
### Community 394 - "05-full-text-search.md"
Cohesion: 0.12
Nodes (15): Gotchas, Interview questions, The design choices, The implementation, The problem, Using it in the app, What Postgres FTS does not do, Gotchas (+7 more)
...
### Community 396 - "ex51-secrets.mjs"
Cohesion: 0.14
Nodes (11): bad, bad2, c, enc, line(), log, logger, p (+3 more)

### Community 397 - "ex11-deser-redirect-massassign.mjs"
Cohesion: 0.12
Nodes (11): Account, body, clone, deny, filtered, naive, parsed, patched (+3 more)

### Community 398 - "eslint-oxlint/README.md"
Cohesion: 0.07
Nodes (24): 10.1 Authoring a Rule, 10.2 Testing with RuleTester, 10.3 Processors, 1. Concept & Under-the-Hood Mechanics, 2. Real-World Engineering Scenario, 3. Production-Grade Code Example, 4. Senior Engineer Edge Cases & Pitfalls, 🛠️ Custom ESLint Rules, Testing & Processors (+16 more)

### Community 399 - "02-details-that-feel-native.md"
Cohesion: 0.18
Nodes (10): Debug output, Decide whether iteration is live or a snapshot — and say so, Gotchas, Identity: what counts as "the same item", If the backing store is remote or closable, Interview questions, `JSON.stringify` ignores your iterator — provide `toJSON`, Operations return new collections (+2 more)
...
### Community 402 - "05.1 · The shape that stays readable"
Cohesion: 0.22
...
### Community 403 - "Buffer typed read and write"
Cohesion: 0.13
...
### Community 404 - "Buffer extends Uint8Array"
Cohesion: 0.13
...
### Community 405 - "Transform stream"
Cohesion: 0.15
...
### Community 406 - "XSS and output encoding"
Cohesion: 0.18
...
### Community 407 - "idle in transaction"
Cohesion: 0.16
...
Cohesion: 0.12
Nodes (24): Automatically updatable view, A view cannot take a parameter, WITH CHECK OPTION, Triggers — BEFORE/AFTER, row versus statement, Triggers maintain data not behaviour, Extensions, Set-returning functions in FROM, Put SRFs in FROM not SELECT (+16 more)
...
### Community 414 - "3. Production-Grade End-to-End Setup"
Cohesion: 0.13
...
### Community 415 - "04-the-story-context.md"
Cohesion: 0.13
...
### Community 417 - "ex6-time.mjs"
Cohesion: 0.13
Nodes (10): ac, all, Budget, paidAt, plus7ms, slow, start, t (+2 more)

### Community 418 - "1. Concept & Under-the-Hood Mechanics"
Cohesion: 0.14
...
### Community 419 - "@supports feature queries"
Cohesion: 0.22
Nodes (13): CSS.supports and style round-trip, @supports, @supports tests parse not correctness, @supports selector(), @supports feature queries, Baseline and shipping decisions, Baseline Limited availability, Local support is not shipping safety (+5 more)

### Community 420 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.14
...
### Community 423 - "Express.js syllabus"
Cohesion: 0.18
...
### Community 425 - "Phase 0 — How Git stores things"
Cohesion: 0.25
...
Cohesion: 0.10
Nodes (19): Containment is structural, not equality, Gotchas, Interview questions, jsonpath, for what containment cannot express, Mutation, The predicates, Trade-off, Why `@>` and not `->>` (+11 more)

### Community 428 - "Node-API stable ABI"
Cohesion: 0.14
...
### Community 429 - "Event loop phases"
Cohesion: 0.18
...
### Community 430 - "Phase 12 — Native and advanced"
Cohesion: 0.25
...
### Community 431 - "Promise combinators"
Cohesion: 0.18
...
### Community 432 - "Injection — SQL, NoSQL and command"
Cohesion: 0.19
...
### Community 433 - "EXPLAIN (ANALYZE, BUFFERS)"
Cohesion: 0.20
...
### Community 434 - "Transactional DDL"
Cohesion: 0.14
...
### Community 439 - "Phase 9 CRUD patterns for a real API"
Cohesion: 0.18
...
### Community 440 - "JSX is a function call"
Cohesion: 0.19
...
### Community 441 - "02-what-earns-a-test.md"
Cohesion: 0.14
...
### Community 444 - "06-retries.md"
Cohesion: 0.06
Nodes (31): 1. What is retryable?, 2. Is the *request* safe to repeat?, 3. How long to wait?, Gotchas, Interview questions, Two things every attempt must rebuild, What a complete wrapper ends up with, Gotchas (+23 more)

### Community 445 - "02-building-a-shortcut.md"
Cohesion: 0.06
Nodes (29): `code` — use it for positions, Gotchas, IME composition: the guard nobody writes first, Interview questions, `key` — use it for text and for named keys, `keyCode` is deprecated, Modifier state, The event sequence (+21 more)

### Community 446 - "12-timers/01-the-api.md"
Cohesion: 0.08
Nodes (24): A string as the first argument is `eval`, Arguments after the delay are passed to the callback, Clearing is teardown, and teardown is not optional, Clearing: the part that is actually easy to get wrong, Gotchas, Interview questions, Node's `Timeout` object earns its extra methods, The delay argument is coerced, clamped and capped (+16 more)

### Community 447 - "1. Concept & Under-the-Hood Mechanics"
Cohesion: 0.15
...
### Community 450 - "1. Concept & Under-the-Hood Mechanics"
Cohesion: 0.15
...
### Community 451 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.15
...
### Community 452 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.15
...
### Community 453 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.15
...
### Community 456 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.15
...
### Community 459 - "Temporal dead zone"
Cohesion: 0.18
...
### Community 464 - "Type stripping"
Cohesion: 0.20
Nodes (10): dependencies vs devDependencies vs peerDependencies, npm ci, npm ci --omit=dev, Erasable vs non-erasable syntax, ERR_UNSUPPORTED_TYPESCRIPT_SYNTAX, ERR_UNSUPPORTED_NODE_MODULES_TYPE_STRIPPING, Node is not a type checker, tsc --noEmit (+2 more)

### Community 465 - "SplitLines framing Transform"
Cohesion: 0.18
...
### Community 466 - "Secrets handling"
Cohesion: 0.19
...
### Community 469 - "LISTEN/NOTIFY from Node"
Cohesion: 0.15
...
### Community 470 - "The critical one — CVE-2025-55182"
Cohesion: 0.40
...
### Community 474 - "1. Under-The-Hood Mechanics"
Cohesion: 0.15
...
### Community 475 - "1. Under-The-Hood Mechanics"
Cohesion: 0.15
...
### Community 476 - "02-urls-and-parsing.md"
Cohesion: 0.08
...
### Community 483 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.17
...
### Community 484 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.17
...
### Community 485 - "01-the-accidental-waterfall.md"
Cohesion: 0.11
Nodes (17): `forEach` — nothing is awaited, Gotchas, Interview questions, `map` without `Promise.all` — an array of promises, Spotting it: the dependency test, The loop is the expensive version, Two loop shapes that do not do what they look like, What it costs, and what it does not (+9 more)
...
### Community 489 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.17
...
### Community 490 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.17
...
### Community 491 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.17
...
### Community 492 - "03-boundaries-at-scale.md"
Cohesion: 0.10
Nodes (19): Gotchas, Interview questions, `private` is class-level, not instance-level, The §6.6.2 subtlety on `protected`, The four levels, precisely, Where each modifier may appear, Collections: the leak that setters don't cause, Encapsulation is about behaviour, not getters (+11 more)
...
### Community 494 - "🏛️ Project Structure: Feature-Based vs Layer-Based, Colocation & Barrel Files"
Cohesion: 0.17
...
### Community 497 - "🏛️ Authentication & Authorization: Token Storage, Refresh Flows & UI Gating"
Cohesion: 0.17
...
### Community 498 - ".git/index binary file"
Cohesion: 0.18
...
### Community 501 - "Class lexical declaration and TDZ"
Cohesion: 0.20
...
### Community 502 - "Array and call spread"
Cohesion: 0.20
...
### Community 504 - "🧪 Snapshot Testing: `toMatchSnapshot()`, Serializers & When Not to Use Them"
Cohesion: 0.09
...
### Community 505 - "1. Under-The-Hood Mechanics"
Cohesion: 0.03
Nodes (54): 1. Under-The-Hood Mechanics, 2. Real-World Engineering Scenario, 3. Production-Grade Code Example, 4. Senior Engineer Edge Cases & Pitfalls, `alias`: Must Be Mirrored in `tsconfig.json`'s `paths`, `dedupe`: Solving the "Two Copies of React" Problem, ⚡ Path Resolution & Aliases: `resolve.alias`, `extensions` & `dedupe`, ⚠️ Pitfall 1: Configuring `resolve.alias` Without Mirroring It in `tsconfig.json` (+46 more)
...
### Community 508 - "http.createServer"
Cohesion: 0.17
...
### Community 511 - "withTransaction helper"
Cohesion: 0.18
...
### Community 513 - "Deserialization, open redirects, mass assignment"
Cohesion: 0.27
...
### Community 514 - "Mocking — mock.fn, mock.method and timers"
Cohesion: 0.26
...
### Community 515 - "PostgreSqlContainer"
Cohesion: 0.18
...
### Community 522 - "NULL three-valued logic"
Cohesion: 0.17
...
### Community 524 - "Three-valued logic in WHERE"
Cohesion: 0.18
...
### Community 525 - "Phase 5 — Joins and set operations"
Cohesion: 0.23
...
### Community 526 - "UNION INTERSECT EXCEPT"
Cohesion: 0.23
...
### Community 527 - "NULL-skipping aggregate rule"
Cohesion: 0.18
...
### Community 528 - "NULL as a grouping key"
Cohesion: 0.17
...
### Community 530 - "Row-constructor tuple comparison"
Cohesion: 0.20
...
### Community 531 - "INSERT ... RETURNING"
Cohesion: 0.17
...
### Community 537 - "📦 Immer Internals: Proxy Drafts & The Mutate-Or-Return Rule"
Cohesion: 0.17
...
### Community 538 - "📦 Redux DevTools: Time-Travel, Action Replay & Trace Mode"
Cohesion: 0.17
...
### Community 539 - "📦 Migrating From Classic Redux to RTK"
Cohesion: 0.17
...
### Community 540 - "📖 Core Concepts: Component-Driven Development & CSF3"
Cohesion: 0.17
...
### Community 541 - "Phase 1 The type vocabulary"
Cohesion: 0.27
...
### Community 546 - "🚀 LCP Optimization: Preloading, Render-Blocking Elimination & TTFB"
Cohesion: 0.17
...
### Community 547 - "🚀 INP Optimization: Yielding, Debouncing & Prioritized Updates"
Cohesion: 0.17
...
### Community 548 - "🚀 CLS Optimization: Reserved Space, Font Loading & Safe DOM Insertion"
Cohesion: 0.17
...
### Community 549 - "1. Under-The-Hood Mechanics"
Cohesion: 0.17
...
### Community 550 - "⚙️ Multi-Config & Environment: Composition, `--env`, and Multi-Compiler Builds"
Cohesion: 0.17
...
### Community 561 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.18
...
### Community 562 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.18
...
### Community 563 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.18
...
### Community 564 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.18
...
### Community 567 - "🎨 Transition Types: `tween`, `spring` & `inertia`"
Cohesion: 0.18
...
### Community 568 - "🎨 Gestures: `whileHover`/`whileTap`/`whileFocus`, `drag` & Constraints"
Cohesion: 0.18
...
### Community 569 - "🎨 `AnimatePresence`: Exit Animations & Mode Configuration"
Cohesion: 0.18
...
### Community 570 - "🎨 Layout Animations: The `layout` Prop & `layoutId` Shared Transitions"
Cohesion: 0.18
...
### Community 571 - "🎨 Scroll-Linked Animations: `useScroll`, `whileInView` & Parallax"
Cohesion: 0.18
...
### Community 572 - "🎨 Animation Controls: `useAnimate()`/`useAnimation()` & Chained Sequences"
Cohesion: 0.18
...
### Community 573 - "🎨 SVG Animations: `pathLength`, Stroke Drawing & Path Morphing"
Cohesion: 0.18
...
### Community 574 - "🎨 Advanced Patterns: Shared Layout Transitions, Next.js Integration & Reduced Motion"
Cohesion: 0.18
...
### Community 575 - "🏛️ Component Architecture: Compound Components, Headless UI & Composition Over Configuration"
Cohesion: 0.18
...
### Community 579 - "🏛️ Observability & Monitoring: RUM, Error Tracking & Event Architecture"
Cohesion: 0.18
...
### Community 585 - "The default and the comparator"
Cohesion: 0.25
...
### Community 586 - "Map and Set stringify as {}"
Cohesion: 0.20
...
### Community 596 - "05-request-phases.md"
Cohesion: 0.18
...
### Community 598 - "Env validation at boot"
Cohesion: 0.18
...
### Community 599 - "Phase 11 — Deployment and operations"
Cohesion: 0.31
...
### Community 600 - "WebAssembly in Node"
Cohesion: 0.18
...
### Community 603 - "async_hooks and AsyncResource"
Cohesion: 0.22
...
### Community 604 - "zlib Transform streams"
Cohesion: 0.18
...
### Community 607 - "Exponential backoff and jitter"
Cohesion: 0.22
...
### Community 609 - "🎭 Test Runner: `@playwright/test`, Built-In Fixtures & the Projects Matrix"
Cohesion: 0.18
...
### Community 610 - "🎭 Actions & Interactions: Core Methods & Low-Level Keyboard/Mouse APIs"
Cohesion: 0.18
...
### Community 611 - "🎭 Navigation & Network: `page.goto()`, `page.route()` & HAR Replay"
Cohesion: 0.18
...
### Community 612 - "🎭 Authentication & State: `storageState` & Global Setup Projects"
Cohesion: 0.18
...
### Community 613 - "🎭 Parallelism & Sharding: Workers, `describe.serial()` & CI Sharding"
Cohesion: 0.18
...
### Community 614 - "🎭 Component Testing: Mounting Components in a Real Browser"
Cohesion: 0.18
...
### Community 615 - "02-patterns-and-limits.md"
Cohesion: 0.10
...
### Community 617 - "🎭 Advanced Patterns: Page Object Model, Custom Matchers & Test Tagging"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (11): Cluster, Database, Four-level namespace, Qualify names in migrations, Schema, search_path, Identifier case folding, postgres database (+3 more)
...
### Community 621 - "Roles, GRANT and REVOKE"
Cohesion: 0.25
...
### Community 622 - "pg_settings.context"
Cohesion: 0.22
...
### Community 623 - "Row-level security"
Cohesion: 0.18
...
### Community 624 - "Point-in-time recovery"
Cohesion: 0.24
...
### Community 625 - "UNIQUE constraint vs unique index"
Cohesion: 0.18
...
### Community 626 - "GROUP BY and aggregates"
Cohesion: 0.35
...
### Community 628 - "pool.connect and release"
Cohesion: 0.20
...
### Community 629 - "Phase 7 — The pg driver, end to end"
Cohesion: 0.20
...
### Community 630 - "Issuing DDL through the driver"
Cohesion: 0.29
...
### Community 631 - "Generated TypeScript types"
Cohesion: 0.18
...
### Community 632 - "withTransaction wrapper"
Cohesion: 0.18
...
### Community 633 - "SELECT ... FOR UPDATE"
Cohesion: 0.20
...
### Community 635 - "01-pause-and-resume.md"
Cohesion: 0.07
Nodes (24): Calling it runs nothing, Ending it early — `return()` and `throw()`, Every place `function*` can be written, Generator objects are one-shot, and are their own iterator, Gotchas, Interview questions, `next(value)` sends a value back in, What `next()` does (+16 more)
...
### Community 639 - "📦 Middleware Stack & `listenerMiddleware`"
Cohesion: 0.18
...
### Community 642 - "📖 Decorators: Global, Story-Level & Composition Order"
Cohesion: 0.18
...
### Community 643 - "📖 Composition & Design Systems: Design Tokens, Variant Matrices & Storybook Composition"
Cohesion: 0.18
...
### Community 644 - "04-upstream-tracking.md"
Cohesion: 0.11
Nodes (16): Gotchas, `push.default`, Setting it, The fork setup, Trade-off, `@{u}` and `@{push}`, What it is, Where the counts come from (+8 more)

### Community 645 - "📖 Build & Configuration: `.storybook/main.js` Deep Dive"
Cohesion: 0.18
...
### Community 646 - "📖 Advanced Patterns: Living Style Guide, PR-Based Visual Review & Outside-In Development"
Cohesion: 0.18
...
### Community 647 - "🔄 `useQuery` Deep Dive: `queryKey`, `staleTime` vs `gcTime`, `enabled` & `select`"
Cohesion: 0.18
...
### Community 648 - "🔄 Background Refetching: Window Focus, Reconnect & Polling Intervals"
Cohesion: 0.18
...
### Community 649 - "🔄 Dependent & Parallel Queries: `enabled` Chaining & `useQueries()`"
Cohesion: 0.18
...
### Community 653 - "08-suppression-directives/README.md"
Cohesion: 0.07
Nodes (29): A review checklist, Gotchas, Interview questions, The one practice that covers most of it, The position to hold, The seven, and the honest mitigation for each, What this does *not* cover, Gotchas (+21 more)
...
### Community 661 - "⚙️ Webpack Core Concepts: Entry, Output, Loaders, Plugins & The Module Graph"
Cohesion: 0.18
...
### Community 662 - "⚙️ Configuration Deep Dive: Entry & Output"
Cohesion: 0.18
...
### Community 663 - "⚙️ Loader Mechanics: Pitching Phase, Async Loaders & Options"
Cohesion: 0.18
...
### Community 672 - "Powered by React Illustration"
Cohesion: 0.33
...
### Community 673 - "undraw Docusaurus Tree Illustration"
Cohesion: 0.31
...
### Community 674 - "10-interactive-and-tty.md"
Cohesion: 0.20
...
### Community 675 - "06-spa-fallback.md"
Cohesion: 0.20
Nodes (8): Gotchas, Interview questions, Trade-off, Gotchas, Interview questions, Order that works, Trade-off, What fails

### Community 676 - "verification-claude-pages.md"
Cohesion: 0.20
...
### Community 677 - "🎨 Core Concepts: Declarative Animation & `motion` Components"
Cohesion: 0.20
...
### Community 678 - "🎨 Variants: Reusable Named States, Orchestration & Propagation"
Cohesion: 0.20
...
### Community 679 - "🎨 Keyframes: Array Syntax & The `times` Array"
Cohesion: 0.20
...
### Community 680 - "🎨 Performance Considerations: GPU-Accelerated Properties & `will-change`"
Cohesion: 0.20
...
### Community 681 - "4. Senior Engineer Edge Cases & Pitfalls"
Cohesion: 0.20
...
### Community 682 - "🏛️ Testing Strategy: The Real-World Pyramid & Contract Testing"
Cohesion: 0.20
...
### Community 685 - "Optional chaining ?."
Cohesion: 0.20
...
### Community 687 - "Object.create(null) dictionary"
Cohesion: 0.20
...
### Community 688 - "sort compareFn contract"
Cohesion: 0.20
...
### Community 693 - "01-talking-back.md"
Cohesion: 0.14
...
### Community 698 - "Node.js — Syllabus"
Cohesion: 0.29
...
### Community 699 - "Node CI/CD pipeline"
Cohesion: 0.20
...
### Community 700 - "AbortController and cancellation"
Cohesion: 0.24
...
### Community 701 - "Durable exclusive claim visibility ack"
Cohesion: 0.20
...
### Community 702 - "Sync vs background"
Cohesion: 0.22
...
### Community 704 - "Mutation testing"
Cohesion: 0.20
...
### Community 705 - "03-debounce-throttle/README.md"
Cohesion: 0.11
...
### Community 706 - "11-why-virtual-threads-changed-the-answer.md"
Cohesion: 0.08
Nodes (23): Assuming a benchmark settles it, Be fair: what WebFlux still genuinely wins, Enabling virtual threads and keeping the reactive code, Expecting the migration to be one property, Gotchas, Interview questions, The clearest evidence is Reactor's own, The comparison, stated honestly (+15 more)
...
### Community 709 - "Phase 13 — Security, operations and production"
Cohesion: 0.29
...
### Community 710 - "Oldest transaction age as leading indicator"
Cohesion: 0.20
...
### Community 713 - "Generated column"
Cohesion: 0.20
...
### Community 714 - "Logical query processing order"
Cohesion: 0.29
...
### Community 715 - "LATERAL"
Cohesion: 0.16
Nodes (16): One row per matching pair, INNER JOIN matching pairs, JOIN is INNER JOIN, NOT NULL FK makes child-to-parent count knowable, Phase 5 join fixture j_customers j_orders j_order_items, Order 14 orphan NULL customer_id, CROSS JOIN, Accidental comma join (+8 more)

### Community 716 - "array_agg"
Cohesion: 0.29
...
### Community 718 - "Simple query protocol"
Cohesion: 0.20
...
### Community 719 - "🧪 Coverage & Configuration: `jest.config.js`, Thresholds & Transform Pipeline"
Cohesion: 0.17
...
Cohesion: 0.22
Nodes (10): Iterables as children, Four conditional forms, Early return after every hook, Reset a subtree with key, Conditional rendering, Conditionals decide identity, A key is an identity, not an index, Fragment occupies a React-tree position (+2 more)

### Community 721 - "Props are read-only"
Cohesion: 0.22
...
### Community 722 - "Fetching data in an effect"
Cohesion: 0.24
Nodes (10): Effects only run on the client, react.dev You Might Not Need an Effect, Application init belongs at module level, typeof window guard around module init, subscribe must be declared outside the component, useSyncExternalStore, Twelve cases; only fetching survives, Fetching data in an effect (+2 more)

### Community 723 - "03-choosing-the-type.md"
Cohesion: 0.20
...
### Community 724 - "04-what-redis-is-not.md"
Cohesion: 0.20
...
### Community 725 - "01-what-redis-is/README.md"
Cohesion: 0.20
...
### Community 733 - "📖 Testing Integration: `@storybook/test-runner`, Stories as the Single Source of Truth"
Cohesion: 0.20
...
### Community 734 - "📖 Publishing & Deployment: `build-storybook`, Static Hosting & Chromatic Publish"
Cohesion: 0.20
...
### Community 735 - "🔄 Core Concepts: The Server-State Model, `QueryClient` & Why Server State Is Different"
Cohesion: 0.20
...
### Community 736 - "🔄 `useMutation`: Lifecycle Callbacks, Optimistic Updates & `mutate` vs `mutateAsync`"
Cohesion: 0.20
...
### Community 742 - "null vs undefined"
Cohesion: 0.22
...
### Community 749 - "02-merging-forwarding-and-identity.md"
Cohesion: 0.11
Nodes (16): A default is code, so it runs like code, A fresh value every call — and the identity it costs, Forwarding through a wrapper, Gotchas, Interview questions, Merging options: three mechanisms, three answers, When identity matters: hoist, and then freeze, Choosing, in one pass (+8 more)

### Community 750 - "⚡ Testing Integration: Vitest's Shared Config & Transform Pipeline"
Cohesion: 0.20
...
### Community 753 - "ex1-crypto.mjs"
Cohesion: 0.20
Nodes (8): a, b, c, salt, scrypt, secret, sig, t2

### Community 754 - "ex26-index-ops.mjs"
Cohesion: 0.27
Nodes (5): bytes(), plan(), pool, q(), size()

### Community 755 - "ex30-vacuum-horizon.mjs"
Cohesion: 0.24
Nodes (4): pool, q(), size(), stats()

### Community 756 - "ex50-privileges.mjs"
Cohesion: 0.22
Nodes (6): admin, admin2, c1, own, q(), tryAdmin()

### Community 757 - "infer.ts"
Cohesion: 0.20
Nodes (8): constCity, frozen, maybe, mixed, mutableCity, nested, rates, tupleish

### Community 758 - "undraw Docusaurus Mountain Illustration"
Cohesion: 0.36
...
### Community 759 - "Deploy to GitHub Pages"
Cohesion: 0.25
Nodes (9): Broken-links report step, Enable corepack before setup-node, Deploy to GitHub Pages, Yarn node-modules linker, Approved colour palette, Dev Bible, Docusaurus delivery, MERN and PERN stacks (+1 more)

### Community 760 - "🎨 Orchestration & Staggering: Parent-Child Timing & Custom Per-Child Stagger"
Cohesion: 0.22
...
### Community 761 - "Five config scopes"
Cohesion: 0.22
...
### Community 763 - "01-what-the-notation-says.md"
Cohesion: 0.22
...
### Community 764 - "Exponentiation ** right-associative"
Cohesion: 0.22
...
### Community 765 - "arguments object"
Cohesion: 0.28
...
### Community 770 - "package.json essentials"
Cohesion: 0.22
...
### Community 771 - "package-lock.json"
Cohesion: 0.17
Nodes (12): Caret vs tilde ranges, Commit the lockfile, Lockfile integrity hash, package-lock.json, package.json overrides, Semantic versioning, save-exact, Pre-release dist-tag (+4 more)

### Community 772 - "Buffer basics"
Cohesion: 0.22
...
### Community 773 - "HTTPS, TLS and mTLS"
Cohesion: 0.25
...
### Community 774 - "TCP is a byte stream"
Cohesion: 0.22
...
### Community 777 - "🚀 Loading & Rendering Performance: Delivery Optimization & Runtime Efficiency"
Cohesion: 0.20
...
### Community 779 - "PUBLICATION and SUBSCRIPTION"
Cohesion: 0.22
...
### Community 780 - "Table rewrite via relfilenode"
Cohesion: 0.22
...
### Community 782 - "string_agg, array_agg, jsonb_agg"
Cohesion: 0.31
...
### Community 784 - "CTE inlining conditions"
Cohesion: 0.25
...
### Community 787 - "DDL as ordinary query"
Cohesion: 0.22
...
### Community 789 - "Allowlist is a lookup not validation"
Cohesion: 0.22
...
### Community 790 - "Repository module per resource"
Cohesion: 0.25
...
### Community 791 - "Bound parameter cannot become SQL"
Cohesion: 0.25
...
### Community 792 - "BEFORE UPDATE updated_at trigger"
Cohesion: 0.22
...
### Community 793 - "react-dom renderer"
Cohesion: 0.28
...
### Community 794 - "02-operations-where-the-data-is.md"
Cohesion: 0.22
...
### Community 798 - "02-indexing-and-ranking.md"
Cohesion: 0.17
Nodes (11): A generated column instead, Gotchas, Interview questions, Ranking, Snippets, The `42P17` trap, The baseline, The payoff, and the exact-match rule (+3 more)

### Community 799 - "⚙️ Plugins In-Depth: The Essential Build-Extension Toolkit"
Cohesion: 0.22
...
### Community 800 - "ex12-runners/package.json"
Cohesion: 0.22
Nodes (8): jest, dependencies, jest, vitest, name, private, type, vitest

### Community 801 - "development"
Cohesion: 0.22
...
### Community 802 - "ex1-version-facts.sh"
Cohesion: 0.25
...
### Community 819 - "Object name is SHA of header plus content"
Cohesion: 0.25
...
### Community 824 - "undefined versus missing key"
Cohesion: 0.25
...
### Community 828 - "Horizontal replicas"
Cohesion: 0.25
...
### Community 829 - "node_modules walk"
Cohesion: 0.32
...
### Community 830 - "Process crash handler"
Cohesion: 0.50
Nodes (4): Timeout.unref, Process crash handler, isOperational flag, Operational vs programmer errors

### Community 831 - "Async iterators and generators"
Cohesion: 0.29
...
### Community 835 - "Authentication vs authorization"
Cohesion: 0.29
...
### Community 838 - "04-shared-buffers.md"
Cohesion: 0.25
Nodes (7): From Node, Gotchas, Interview questions, See the setting, Trade-off, Where a row lives, Why it exists

### Community 839 - "Write-ahead log"
Cohesion: 0.25
...
Cohesion: 0.18
Nodes (10): Against full-text search, `%` compares whole strings — the trap, GIN or GiST, Gotchas, Interview questions, Ordering by distance, The indexes, Trade-off (+2 more)

### Community 846 - "Connection limits and PgBouncer"
Cohesion: 0.39
...
### Community 847 - "work_mem per sort or hash operation"
Cohesion: 0.29
...
### Community 848 - "ACCESS EXCLUSIVE lock queue"
Cohesion: 0.25
...
### Community 849 - "bigint for surrogate primary keys"
Cohesion: 0.25
...
### Community 850 - "text vs varchar vs char"
Cohesion: 0.25
...
### Community 852 - "CHECK constraint"
Cohesion: 0.29
...
### Community 853 - "Joining on expressions"
Cohesion: 0.40
Nodes (6): Nested Loop Hash Join Merge Join, Joining on expressions, EXCLUDE USING gist no-overlap, Expression index pays only when selective, Non-equality ON leaves nested loop only, Range join with tstzrange @>

### Community 854 - "FILTER (WHERE …)"
Cohesion: 0.25
...
### Community 855 - "42P20 windowing_error"
Cohesion: 0.25
...
### Community 856 - "One-pass WHERE fragment builder"
Cohesion: 0.25
...
### Community 857 - "Soft delete as UPDATE"
Cohesion: 0.25
...
### Community 859 - "⚙️ Long-Term Caching: Content Hashes & Persistent Build Cache"
Cohesion: 0.20
...
### Community 861 - "02-data-types.md"
Cohesion: 0.25
...
### Community 863 - "02-file-structure-and-the-glob.md"
Cohesion: 0.25
...
### Community 864 - "strictNullChecks"
Cohesion: 0.25
...
### Community 865 - "Intersection types"
Cohesion: 0.36
...
### Community 888 - "The rendering pipeline"
Cohesion: 0.43
...
### Community 890 - "Application settings (app.set / app.get)"
Cohesion: 0.29
...
### Community 896 - "?? default-value idiom"
Cohesion: 0.29
...
### Community 897 - "var-in-a-loop bug"
Cohesion: 0.33
...
### Community 898 - "Low lag plus high p99"
Cohesion: 0.29
...
### Community 899 - "Health checks — liveness vs readiness"
Cohesion: 0.33
...
### Community 902 - "async and await"
Cohesion: 0.22
Nodes (9): Event loop delay cannot detect starvation, async function, await accepts any thenable, await is a microtask yield, async and await, Top-level await, async does not stop blocking, CPU-bound work (+1 more)

### Community 903 - "Promise anti-patterns"
Cohesion: 0.25
Nodes (9): util.callbackify, Error-first callback convention, new Promise only wraps callback APIs, Callbacks, promisify and callbackify, util.promisify, util.promisify.custom, Explicit construction antipattern, Nesting .then instead of chaining (+1 more)

### Community 904 - "Readable stream"
Cohesion: 0.33
...
### Community 905 - "for await of Readable"
Cohesion: 0.29
...
### Community 906 - "pool.query BEGIN bug"
Cohesion: 0.29
...
### Community 907 - "Concurrency limiting"
Cohesion: 0.33
...
### Community 908 - "Testcontainers — real database integration tests"
Cohesion: 0.29
...
### Community 913 - "Three questions three views"
Cohesion: 0.29
...
### Community 914 - "Expand and contract"
Cohesion: 0.29
...
### Community 915 - "Direct vs pooled endpoints"
Cohesion: 0.33
...
### Community 916 - "Point-in-time recovery"
Cohesion: 0.33
...
### Community 919 - "The guarantee and its NULLs"
Cohesion: 0.36
Nodes (8): WHEN NOT MATCHED BY SOURCE, The guarantee and its NULLs, count(*) vs count(col) after LEFT JOIN, LEFT JOIN IS NULL anti-join, Manufactured NULLs indistinguishable from stored, Calendar spine gap fill, EXCEPT, count(*) arrives as a string from pg

### Community 920 - "RIGHT and FULL OUTER"
Cohesion: 0.33
...
### Community 921 - "Alias discipline"
Cohesion: 0.38
...
### Community 925 - "Counting for pagination"
Cohesion: 0.29
...
### Community 926 - "pg-cursor streaming"
Cohesion: 0.29
...
### Community 927 - "ACCESS EXCLUSIVE lock"
Cohesion: 0.29
...
### Community 928 - "Pass db through every layer"
Cohesion: 0.38
...
### Community 929 - "Part 3 Node + raw pg (proposed)"
Cohesion: 0.29
...
### Community 930 - "The classic runtime and @jsxImportSource"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (7): Object and function identity re-runs the Effect, ref.current is not tracked, Ref guard anti-fix, useEffectEvent, Move 4 — call a pure function prop during render, Objects and functions as dependencies, Ref used to hide a dependency

### Community 933 - "Extra setup+cleanup cycle"
Cohesion: 0.29
Nodes (7): Remount principle, StrictMode only doubles the mount, Extra setup+cleanup cycle, Partial StrictMode skips the extra effect cycle, State as a message queue, Door-lock analogy, Move 7 — move the code to an event handler

### Community 934 - "PostgreSQL cross-phase correctness review"
Cohesion: 0.33
...
### Community 935 - "Phase 0 How TypeScript runs"
Cohesion: 0.33
...
### Community 937 - "docusaurus.config.js"
Cohesion: 0.29
Nodes (3): config, dirname, searchContexts

### Community 938 - "ex14-property/package.json"
Cohesion: 0.29
Nodes (6): fast-check, dependencies, fast-check, name, private, type

### Community 939 - "Dev Bible standing brief"
Cohesion: 0.33
...
### Community 940 - "ex10-migrations.mjs"
Cohesion: 0.33
...
### Community 942 - "express-verify/package.json"
Cohesion: 0.29
Nodes (6): dependencies, express, express, name, private, type

### Community 943 - "ex11-benchmark-lies.mjs"
Cohesion: 0.29
Nodes (3): data, r, t0

### Community 944 - "dependencies"
Cohesion: 0.29
Nodes (6): dependencies, express, supertest, express, type, supertest

### Community 945 - "ex15-mutation/package.json"
Cohesion: 0.29
Nodes (6): dependencies, @stryker-mutator/core, name, private, type, @stryker-mutator/core

### Community 946 - "ex17-contract/package.json"
Cohesion: 0.29
Nodes (6): dependencies, zod, zod, name, private, type

### Community 947 - "convert.mjs"
Cohesion: 0.43
Nodes (3): convert(), NOTE: convert.mjs is deliberately NOT imported at the top., fetchRate()

### Community 948 - "ex23-index-basics.mjs"
Cohesion: 0.33
Nodes (3): plan(), pool, q()

### Community 949 - "ex24-index-not-used.mjs"
Cohesion: 0.33
Nodes (3): plan(), pool, q()

### Community 951 - "ex36c-agg-checks.mjs"
Cohesion: 0.48
Nodes (5): jj(), pool, q(), rows(), tryq()

### Community 952 - "ex36e-shaping.mjs"
Cohesion: 0.48
Nodes (5): jj(), pool, q(), rows(), tryq()

### Community 953 - "ex46-views-triggers.mjs"
Cohesion: 0.38
Nodes (4): plan(), pool, q(), tryq()

### Community 954 - "ex47-functions.mjs"
Cohesion: 0.38
Nodes (4): planOf(), pool, q(), tryq()

### Community 955 - "gen-phases-b.mjs"
Cohesion: 0.33
Nodes (5): mkPhase(), p7, p8, p9, w()

### Community 956 - "typo.ts"
Cohesion: 0.29
Nodes (4): m, Mixed, Options, opts

### Community 958 - "sym.ts"
Cohesion: 0.29
Nodes (6): Alias, KEY, loose, Maybe, r, Registry

### Community 959 - "guards.ts"
Cohesion: 0.29
Nodes (3): ApiError, Cat, Dog

### Community 960 - "Grok project rules"
Cohesion: 0.40
Nodes (6): Explanation cadence, Grok project rules, Never-delete rule, Single-agent default, Node 24 Active LTS target, Incremental working process

### Community 961 - "ex5-totp.mjs"
Cohesion: 0.40
Nodes (5): RFC-6238, hotp(), s1, s256, totp()

### Community 962 - "CSS syllabus"
Cohesion: 0.29
Nodes (8): CSS is resolved not executed, Critical-path CSS syllabus, CSS owns what the browser paints, CSS syllabus, CSS example policy, Single-engine limitation, web-features Baseline dataset, Priority tiers

### Community 964 - "Author identity required to commit"
Cohesion: 0.33
...
### Community 965 - "JSX interpolation is expression-only"
Cohesion: 0.33
...
### Community 966 - "Labelled break and continue"
Cohesion: 0.33
...
### Community 968 - "Three-tier property enumeration order"
Cohesion: 0.33
...
### Community 969 - "prototype vs [[Prototype]]"
Cohesion: 0.33
...
### Community 970 - "Node vs the browser"
Cohesion: 0.40
...
### Community 972 - "🔄 DevTools: Live Cache Inspection & Manual Cache Manipulation"
Cohesion: 0.18
...
### Community 973 - "V8/Node startup snapshot"
Cohesion: 0.33
...
### Community 975 - "CORS is a browser rule not authorization"
Cohesion: 0.33
...
### Community 977 - "Shutdown drain order"
Cohesion: 0.33
...
### Community 978 - "Transient vs permanent errors"
Cohesion: 0.33
...
### Community 979 - "Time on the server"
Cohesion: 0.33
...
### Community 981 - "--test-rerun-failures"
Cohesion: 0.33
...
### Community 982 - "Part 3 — Application Layer"
Cohesion: 0.33
...
### Community 983 - "postgresql:// connection URI"
Cohesion: 0.47
...
### Community 986 - "Custom dump format -Fc"
Cohesion: 0.33
...
### Community 987 - "pg_stat_database"
Cohesion: 0.33
...
### Community 988 - "Many-to-many join table"
Cohesion: 0.33
...
### Community 989 - "NOT IN NULL trap"
Cohesion: 0.40
...
### Community 992 - "dangerouslySetInnerHTML"
Cohesion: 0.40
...
### Community 993 - "You might not need an effect"
Cohesion: 0.33
...
### Community 994 - "Dependencies should match the code"
Cohesion: 0.33
...
### Community 997 - "The consequences you will actually hit"
Cohesion: 0.33
...
### Community 998 - "The four steps, in order"
Cohesion: 0.33
...
### Community 999 - "The mapping — the table to bookmark"
Cohesion: 0.33
...
### Community 1000 - "The language server is not the build"
Cohesion: 0.40
...
### Community 1001 - "tsconfig.json anatomy"
Cohesion: 0.40
...
### Community 1003 - "check.cjs"
Cohesion: 0.40
Nodes (5): app, app2, app3, express, srv

### Community 1004 - "ex4-hosts.mjs"
Cohesion: 0.33
Nodes (4): browserOnly, languageGlobals, nodeOnly, webPlatform

### Community 1005 - "ex5-references.mjs"
Cohesion: 0.33
Nodes (5): cart1, deep, frozen, frozenish, shallow

### Community 1006 - "ex8-null-nan-equality.mjs"
Cohesion: 0.33
Nodes (3): { a = 'dflt' }, { b = 'dflt' }, wrapped

### Community 1007 - "ex11-misc-operators.mjs"
Cohesion: 0.33
Nodes (4): arr, calls, frozen, o

### Community 1008 - "ex3-control-flow.mjs"
Cohesion: 0.33
Nodes (4): arr, base, child, out

### Community 1010 - "ex2-lag.mjs"
Cohesion: 0.33
Nodes (4): h, h2, t0, t2

### Community 1011 - "ex10-ssrf-guard.mjs"
Cohesion: 0.40
Nodes (4): guardedLookup(), isPrivate(), redirector, srv

### Community 1012 - "ex12-redos.mjs"
Cohesion: 0.33
Nodes (4): iv, shapes, t, t0

### Community 1013 - "ex19-crypto.mjs"
Cohesion: 0.33
Nodes (3): b64, data, hmac

### Community 1014 - "ex8-ssrf.mjs"
Cohesion: 0.40
Nodes (4): guarded, isPrivate(), redirector, srv

### Community 1015 - "ex37f-frame-extras.mjs"
Cohesion: 0.47
Nodes (4): pool, q(), rows(), tryq()

### Community 1016 - "ex40-api-concurrency.mjs"
Cohesion: 0.40
Nodes (3): pool, q(), seed()

### Community 1017 - "ex42-testing-rollback.mjs"
Cohesion: 0.40
Nodes (3): pool, q(), seed()

### Community 1018 - "ex44-jsonb-ops.mjs"
Cohesion: 0.40
Nodes (3): planLines(), pool, q()

### Community 1019 - "ex57-vs-mysql.sh"
Cohesion: 0.53
Nodes (5): hdr(), MY(), pg(), PGPASSWORD, ex57-vs-mysql.sh script

### Community 1020 - "nonerasable.ts"
Cohesion: 0.33
Nodes (3): o, Order, Status

### Community 1022 - "four.ts"
Cohesion: 0.33
Nodes (3): nv, s, v

### Community 1023 - "json.ts"
Cohesion: 0.33
Nodes (4): JsonValue, menu, MenuItem, payload

### Community 1025 - "res.sendFile"
Cohesion: 0.40
Nodes (5): res.attachment, res.download, res.sendFile, sendFile root option, Signed URL offload

### Community 1026 - "Inbound webhooks"
Cohesion: 0.50
...
### Community 1027 - "🏛️ Performance & Scalability Patterns: Rendering Strategy & Caching Layers"
Cohesion: 0.20
...
### Community 1030 - "Defaults evaluated at call time"
Cohesion: 0.40
...
### Community 1036 - "uncaughtException and unhandledRejection"
Cohesion: 0.50
...
### Community 1042 - "Shared Zod UserResponse schema"
Cohesion: 0.40
...
### Community 1043 - "Response add-safe, request tighten-unsafe"
Cohesion: 0.40
...
### Community 1044 - "Graceful shutdown"
Cohesion: 0.40
...
### Community 1045 - "EXCLUDE USING gist"
Cohesion: 0.40
...
### Community 1046 - "Referencing-side FK index"
Cohesion: 0.40
...
### Community 1048 - "DDL is an ownership right"
Cohesion: 0.40
...
### Community 1049 - "ALTER DEFAULT PRIVILEGES"
Cohesion: 0.40
...
### Community 1050 - "pg_dump REPEATABLE READ snapshot"
Cohesion: 0.40
...
### Community 1051 - "Variables are textual substitution"
Cohesion: 0.50
...
### Community 1052 - "Table inheritance"
Cohesion: 0.40
...
### Community 1053 - "Parameterized queries"
Cohesion: 0.40
...
### Community 1057 - "Join fan-out inflates sum"
Cohesion: 0.40
...
### Community 1062 - "StrictMode doubling is the test"
Cohesion: 0.40
...
### Community 1063 - "D1–D5 review scoring rubric"
Cohesion: 0.40
...
### Community 1066 - "Erasable vs non-erasable syntax"
Cohesion: 0.50
Nodes (5): Numeric enum IIFE, Erasable vs non-erasable syntax, erasableSyntaxOnly, Node strip-only mode, isolatedModules

### Community 1067 - "devDependencies"
Cohesion: 0.40
Nodes (5): @docusaurus/module-type-aliases, @docusaurus/types, devDependencies, @docusaurus/module-type-aliases, @docusaurus/types

### Community 1068 - "Priority tiers"
Cohesion: 0.40
Nodes (5): KNOW tier, MASTER tier, Priority tiers, UNDERSTAND tier, WHEN-NEEDED tier

### Community 1069 - "ex1-builtins.mjs"
Cohesion: 0.40
Nodes (3): h, snap, t0

### Community 1070 - "phase-1-routing_06-router-param_md__1.mjs"
Cohesion: 0.40
Nodes (4): app, db, items, server

### Community 1071 - "phase-1-routing_07-app-route-and-hosts_md__2.mjs"
Cohesion: 0.40
Nodes (4): admin, app, reports, server

### Community 1072 - "phase-2-middleware_02-execution-order_md__1.mjs"
Cohesion: 0.50
Nodes (4): api, app, log(), server

### Community 1073 - "run-all.mjs"
Cohesion: 0.40
Nodes (4): errs, manifest, results, run

### Community 1074 - "v10-mount.mjs"
Cohesion: 0.40
Nodes (4): admin, app, reports, server

### Community 1075 - "v6-etag.mjs"
Cohesion: 0.40
Nodes (3): app, {port}, server

### Community 1076 - "v7-ifmatch.mjs"
Cohesion: 0.40
Nodes (3): app, {port}, server

### Community 1077 - "v9-mountpath.mjs"
Cohesion: 0.40
Nodes (4): admin, app, server, sub

### Community 1078 - "ex2-logical-optional.mjs"
Cohesion: 0.40
Nodes (3): empty, nf, user

### Community 1079 - "ex4-spread-bitwise.mjs"
Cohesion: 0.40
Nodes (3): { a, ...others }, copy, orig

### Community 1080 - "ex6-optional-limits.mjs"
Cohesion: 0.40
Nodes (4): a, b, checks, empty

### Community 1085 - "ex4-shutdown.mjs"
Cohesion: 0.40
Nodes (3): child2, connection, q

### Community 1087 - "ex7-xss.mjs"
Cohesion: 0.40
Nodes (4): safe, sep, srv, user

### Community 1089 - "p9-testing/package.json"
Cohesion: 0.40
Nodes (4): name, private, type, version

### Community 1090 - "ex14-crud.mjs"
Cohesion: 0.50
Nodes (3): pool, q(), show()

### Community 1092 - "ex17-update.mjs"
Cohesion: 0.50
Nodes (3): pool, q(), reset()

### Community 1093 - "ex19-series-values.mjs"
Cohesion: 0.50
Nodes (3): pool, q(), show()

### Community 1094 - "ex32-psql-io.sh"
Cohesion: 0.60
Nodes (4): line(), PGPASSWORD, run_err(), ex32-psql-io.sh script

### Community 1095 - "ex37e-ordered-set-checks.mjs"
Cohesion: 0.50
Nodes (3): pool, q(), rows()

### Community 1101 - "merge.ts"
Cohesion: 0.40
Nodes (4): b, Box, missing, TBox

### Community 1102 - "deep.ts"
Cohesion: 0.40
Nodes (4): A, B, C, Deep

### Community 1103 - "Claude project bridge"
Cohesion: 0.50
Nodes (4): Grok memory store, Global rules vs project memory split, Claude memory store, Claude project bridge

### Community 1104 - "Headers already sent"
Cohesion: 0.50
...
### Community 1116 - "First matching pg_hba rule wins"
Cohesion: 0.50
...
### Community 1117 - "generate_series and helpers"
Cohesion: 0.50
...
### Community 1118 - "CREATE TABLE IF NOT EXISTS race"
Cohesion: 0.50
...
### Community 1123 - "phase-0-express-basics_02-app-router-server_md__1.mjs"
Cohesion: 0.50
Nodes (3): app, server, users

### Community 1124 - "phase-1-routing_03-router-composition_md__1.mjs"
Cohesion: 0.50
Nodes (3): app, server, users

### Community 1125 - "phase-1-routing_03-router-composition_md__2.mjs"
Cohesion: 0.50
Nodes (3): app, comments, server

### Community 1127 - "phase-4-responses_06-spa-fallback_md__1.mjs"
Cohesion: 0.50
Nodes (3): app, dir, server

### Community 1128 - "v8-trustproxy.mjs"
Cohesion: 0.67
Nodes (3): get(), hdrs, mk()

### Community 1130 - "ex7-strings-symbols-bigint.mjs"
Cohesion: 0.50
Nodes (3): id1, id2, o

### Community 1131 - "ex5-assign-contrast.mjs"
Cohesion: 0.50
Nodes (3): frozen, frozen2, t

### Community 1133 - "ex3-diag.mjs"
Cohesion: 0.50
Nodes (3): seen, srv, tc

### Community 1134 - "ex4-throughput.mjs"
Cohesion: 0.50
Nodes (3): P, s, salt

### Community 1147 - "ex31-psql-basics.sh"
Cohesion: 0.67
Nodes (3): line(), PGPASSWORD, ex31-psql-basics.sh script

### Community 1148 - "ex36b-agg-plans.mjs"
Cohesion: 0.67
Nodes (3): pool, q(), show()

### Community 1150 - "ex3-advisory-fix.mjs"
Cohesion: 0.50
Nodes (3): errors, pool, t0

### Community 1153 - "ex6-collation.mjs"
Cohesion: 0.67
Nodes (3): pool, q(), show()

### Community 1154 - "ex9-bulk-at-scale.mjs"
Cohesion: 0.67
Nodes (3): pool, q(), reset()

### Community 1155 - "Glean client ID (react-p0)"
Cohesion: 0.67
...
### Community 1642 - "The status codes worth choosing deliberately"
Cohesion: 0.29
Nodes (7): 201 and the `Location` header, 202 when the work has not happened yet, 204 versus 200 with a body, 400 versus 422, 🔴 404 versus 403, and the case for lying, 405, 409 and 412, The status codes worth choosing deliberately

### Community 1827 - "01-accessors-and-paths.md"
Cohesion: 0.22
Nodes (8): Array elements, Comparisons need text, and then a cast, Gotchas, Interview questions, The accessors, The null trap, Trade-off, Why the return type decides everything

### Community 1828 - "04-build-json-sql.md"
Cohesion: 0.22
Nodes (8): Gotchas, Interview questions, The constructors, The empty-collection trap, The reverse direction, Trade-off, What the types become, Whether to do it in SQL at all

### Community 1829 - "ESM — the standard module system"
Cohesion: 0.25
...
### Community 1969 - "01-sessions.md"
Cohesion: 0.15
Nodes (11): Gotchas, Interview questions, The choices that carry the security, The implementation, The problem, Gotchas, Interview questions, The honest comparison, on this app's requirements (+3 more)

### Community 1971 - "01-what-it-still-does.md"
Cohesion: 0.15
Nodes (11): `fetch(url, { keepalive: true })`, Gotchas, Interview questions, `navigator.sendBeacon()`, 🔴 The event you fire it from matters more than the API, Gotchas, Interview questions, Mapping it onto `fetch` (+3 more)
...
### Community 1974 - "02-composing-signals.md"
Cohesion: 0.17
Nodes (11): A per-operation controller, when only the latest one matters, `AbortSignal.abort()` — the already-cancelled signal, `AbortSignal.any([...])` — the composition primitive, `AbortSignal.timeout(ms)` — and why its reason is different, Gotchas, Interview questions, One controller per scope, aborted in teardown, `Promise.race` with a timer is not cancellation (+3 more)
...
### Community 1976 - "01-the-problem-reactive-solved.md"
Cohesion: 0.18
...
### Community 1977 - "🧪 Jest Core Concepts: Test Structure, Hooks & Parameterization"
Cohesion: 0.18
...
### Community 1980 - "⚡ Build System: Rollup Options, `manualChunks` & Library Mode"
Cohesion: 0.18
...
### Community 1981 - "⚙️ `webpack-dev-server` & Hot Module Replacement"
Cohesion: 0.18
...
### Community 1983 - "🎭 Fixtures & Test Isolation: Scoping, Automatic Fixtures & Fresh Contexts"
Cohesion: 0.20
...
Cohesion: 0.20
Nodes (9): `getServerSnapshot`, `getSnapshot`, Gotchas, Interview questions, 🔴 It must have a stable identity, `subscribe`, 🔴 The caching error, The remaining caveats (+1 more)

### Community 1986 - "02-the-surprising-cases.md"
Cohesion: 0.20
Nodes (9): Aliased conditions — narrowing through a `const` boolean, 🔴 And that is a deliberate unsoundness, `await` does **not** lose the narrowing, Element access narrows only with a stable key, Gotchas, Interview questions, Properties narrow, and stay narrowed further than you expect, The four patterns that end the problem (+1 more)
...
### Community 1993 - "What actually causes it, and the fix for each"
Cohesion: 0.33
Nodes (6): A deep mapped type where an interface would do, Accumulating types that are not tail-recursive, Template-literal explosion → `TS2590`, The library case, where the type is not yours, Unbounded recursive conditional types, What actually causes it, and the fix for each
...
### Community 1997 - "Extension available vs installed"
Cohesion: 0.67
Nodes (3): Extension available vs installed, Extensions are per database not per cluster, pgvector is not in the stock image

## Knowledge Gaps
- **20868 isolated node(s):** `dirname`, `searchContexts`, `config`, `name`, `version` (+20863 more)
...
- **Why does `Phase 10 — Indexes and the query planner` connect `ANALYZE` to `phase-1-database/README.md`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `🔤 Storybook Custom Fonts & Typography` connect `3. Production-Grade Examples` to `01-global-colors-themes-and-tokens.md`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `⚙️ Advanced Customization: `.storybook/main` & `preview` In Depth` connect `3. Production-Grade Customization Reference` to `01-global-colors-themes-and-tokens.md`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `dirname`, `searchContexts`, `config` to the rest of the system?**
  _20868 weakly-connected nodes found - possible documentation gaps or missing edges._
