...
- Flame graphs
- Microtask queue
- Callbacks, promisify and callbackify
- Readable stream
...
Cohesion: 0.02
Nodes (108): Gotchas, Guarding `unknown`, Guards on `this`, Interview questions, The compiler does not check the body, The guards worth having in every codebase, The syntax and the measurement, Trade-off (+100 more)
...
Cohesion: 0.02
Nodes (126): Assignment or argument?, Gotchas, Interview questions, Missing-property errors say which, 🔴 Overload errors, and why they are the worst, The shape, Three techniques that make errors readable, Two errors that mean something structural (+118 more)
...
Cohesion: 0.02
Nodes (90): `-?` also removes `undefined`, and that is not obvious, `+` and `-`, Gotchas, Interview questions, The four one-liners worth knowing by heart, What "homomorphic" means, and why the word matters, Writing a modifier, Building the standard utilities from an empty file (+82 more)
...
Cohesion: 0.02
Nodes (121): A type parameter is a variable in the type language, Constraints, in one line ahead of the next page, Gotchas, Interview questions, Multiple type parameters relate their arguments, The problem, before the solution, What you can do with an unconstrained `T` — almost nothing, Where the parameter may appear (+113 more)
...
Cohesion: 0.03
Nodes (56): Adopting it, Gotchas, Interview questions, `override` is erased, The bug it exists for, The five diagnostics, and what each one is telling you, What it does not cover, What the flag requires (+48 more)
...
Cohesion: 0.04
Nodes (52): Gotchas, Interview questions, The first problem: side effects, The second problem: the compiler cannot always decide, What elision does *not* remove, What elision is, Why it exists, and why it is usually right, Gotchas (+44 more)
...
### Community 139 - "03-designing-apis-with-it.md"
Cohesion: 0.09
Nodes (21): How it relates to `<T extends string>`, The fix: move `as const` into the signature, The mental model to carry, The problem: the call site throws the literals away, Three things you get back, not one, What it looks like without a constraint, 🔴 No-op #1 — the argument was written somewhere else, 🔴 No-op #2 — a mutable constraint, and no error at all (+13 more)

### Community 140 - "02-client-side-security/01-the-trust-boundary.md"
Cohesion: 0.04
Nodes (43): Gotchas, Hidden UI is not access control, Interview questions, Secrets, The honest list, The one sentence the whole topic rests on, Validation, What CORS does and does not protect (+35 more)
...
Cohesion: 0.04
Nodes (45): And the declarations follow the same families, Gotchas, Interview questions, The complete list, The unambiguous extensions are self-documenting, What each one emits, Why `.mts` and `.cts` exist at all, Declarations and implementations are separate sets (+37 more)
...
Cohesion: 0.05
Nodes (36): `Awaited<Type>`, Gotchas, Interview questions, Multiple `infer` sites, and which way they combine, The function family, The overload rule — the sharpest edge in the family, The `this` pair, Gotchas (+28 more)
...
### Community 204 - "⚡ Build System: Rollup Options, `manualChunks` & Library Mode"
Cohesion: 0.06
...
### Community 216 - "01-immutability-pool-equality.md"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (27): Gotchas, How to find them, in order of effort, Interview questions, 🔴 The one distinction that sorts your whole toolchain, The tools that import it, by what they need it for, What the audit typically finds, Gotchas, Interview questions (+19 more)
...
Cohesion: 0.06
Nodes (29): Before 5.4, Gotchas, Interview questions, Position matters, and getting it wrong is silent, The fix, The problem, in the release notes' own example, The workaround, and why the notes call it a smell, What it does and does not do (+21 more)
...
### Community 317 - "async and await"
Cohesion: 0.10
Nodes (25): Promise.prototype.finally, Promise states and chaining, Promises are eager, Return or it is not chained, .then(f, g) vs .then(f).catch(g), Promise pending / fulfilled / rejected, async function, await inside forEach (+17 more)
...
### Community 364 - "🎭 Auto-Waiting & Assertions: Web-First Assertions, Actionability & Soft Assertions"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (9): Atomic migrations, Transactional DDL, DROP CASCADE, DROP RESTRICT default, DROP CASCADE vs ON DELETE CASCADE, Gapless counter row, RETURNING id over currval, Sequence (+1 more)
...
### Community 470 - "12-december-2025-advisories.md"
Cohesion: 0.15
Nodes (12): Denial of service, Gotchas, Interview questions, Source code exposure, The critical one — CVE-2025-55182, The follow-ups — 11 December, The frameworks named, The timeline (+4 more)
...
Cohesion: 0.33
Nodes (6): Natural key, Surrogate key, UNIQUE constraint vs unique index, Partial unique index, Deferred unique column swap, Uniqueness is per tenant
...
### Community 771 - "Semantic versioning"
Cohesion: 0.22
...
Cohesion: 0.29
Nodes (8): Function around the column, Partial index, Partial indexes, Partial-index predicate implication, Expression index, Expression indexes, Expression-index statistics, IMMUTABLE index expressions

### Community 842 - "SQLSTATE"
Cohesion: 0.25
Nodes (8): Partial UNIQUE index, CREATE INDEX CONCURRENTLY, indisvalid, CREATE INDEX ShareLock, SQLSTATE 25001, SQLSTATE classes 23 and 40, pg error object mapping, SQLSTATE
...
### Community 903 - "Callbacks, promisify and callbackify"
Cohesion: 0.29
