...
|---|---|---|---|
| **React** — all of `docs/react/` | session `6ffd754d` | 2026-08-14 | 🔴 **Active.** **Phases 0–4 COMPLETE** (106 files, 0 broken links). **Phases 0–5 COMPLETE** (124 files). **Phase 6 · Rendering performance and the Compiler** in progress — **11 of 17 topics** (136 files). |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [150 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [136 pages](./react/pages/README.md), **phases 0–5 complete**, phase 6 at 11/17 |
