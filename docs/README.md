...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `2ee7a9a3` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React Phase 7 will look missing on `main`). Phases 0–6 COMPLETE. **Phase 7 in progress — 8 of 12 topics** (01–08 written; 07 chunked into 5 parts, 03/04 into 4 each, 05/06/08 into 2 each). **Resume at topic 09 · Conditional hooks and the correct restructure.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | Pending — [150 pages](./react/pages/README.md), **phases 0–6 complete**, phase 7 under way (8 of 12)                                       |
