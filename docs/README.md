...
|---|---|---|---|
| **React** — all of `docs/react/` | session `6ffd754d` | 2026-08-14 | 🔴 **Active.** **Phases 0–4 COMPLETE** (106 files, 0 broken links). **Phases 0–6 COMPLETE** — Phase 6 finished 17/17, **142 files**, 0 broken links, 0 over cap. Starting **Phase 7 · Custom hooks and the Rules of React**. |
...
| **MongoDB** — all of `docs/mongodb/` | session `6f020813` | 2026-08-14 | 🔴 **Active.** Syllabus **cut to the critical path: 204 → 82 topics** (Master tier only, capped at 6 per phase). **Phase 0 COMPLETE (5/5).** Next: **Phase 1 · Documents, BSON types and `_id` (6 topics)**. Picked up on finishing CSS. Documentation-validated against the MongoDB Manual under the no-new-sandboxes rule. |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [152 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [142 pages](./react/pages/README.md), **phases 0–6 complete**, phase 7 next |
