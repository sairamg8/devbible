...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | Pending — [221 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–16 complete, phase 17 under way                  |
...
| **[Express](./expressjs/README.md)**     | 4 parts · 114 topics | 🔴 **Master-tier depth pass** — [86 pages](./expressjs/pages/README.md) across 11 phases; all 114 topics covered and verified, but the 28 Master topics were sized to the cap (63–200 lines, none chunked) and are being rewritten to full depth. **14 of 28 done — halfway** — phases 0–4 complete and build-verified |
