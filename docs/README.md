...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — `docs/react/`, SPLIT A/B       | **A:** session `bfcb390b` · **B:** session `05921047` | 2026-08-14 | 🔴 **Active on `main`** — the `react-phase-7` worktree was **merged** (`d74e74f`), nothing is stranded. **Phases 0–10 COMPLETE — 217 pages.** **Part A** = Phase 11 topics 08–17 + phase close (**9/17 written**). **Part B** = Phase 14 · Testing React, 14 topics, **writing — 2/14**. Split rules: `devbible/project_react_split_parts_ab.md`; handoff: `devbible/progress_react_phase7.md`.                                                              |
...
| **JavaScript · lane B** — phases **9–12, 17, 18** (platform + applied) | session `75e511e6` | 2026-08-14 | 🔴 **Active — LANE B of the two-way split**, and 🔴 **now written in the worktree `devbible-js-lane-b`, branch `js-lane-b`** (user's instruction, 2026-08-14) — **not merged into `main` yet**; the work is there and the merge is outstanding. DOM, events, network/storage, browser platform, machine coding, and the three kept storefront topics. **53 topics left**. 🎉 ✅ **PHASE 9 · THE DOM IS COMPLETE — 19 of 19 at every tier, 59 files** (Master 01–06, Understand 07–15, Know 16–18, When Needed 19); this lane wrote 46 of those files, every topic chunked, every file under the 300-line cap. 🚧 **Now in phase 10 · Events and user input — **Understand tier COMPLETE — 05–11 ✅** (Form/input, Keyboard, Pointer, Custom events, Scroll/resize/visibility, Page lifecycle, Default actions); Know under way — **12–13 ✅**, only 14 left. Same rules as lane A: tier-locked to Understand+Know, Master is closed and not to be reopened, the scope cut applies, per-file save cadence. ⚠️ A full `yarn build` is currently **blocked by a React MDX error** inherited at the branch point (not lane B's file); verification meanwhile is a relative-link pass over `docs/javascript/pages` — **2,300+ links, 0 broken, 0 files over 300**. See the [JavaScript claim notice](javascript/pages/README.md) for the lane table and the shared-file rules |
...
| **[React](./react/README.md)**           | 4 parts · 210 topics | Pending — [227 pages](./react/pages/README.md), **phases 0–10 complete**; Phase 11 writing (9/17), Phase 14 writing (2/14); 12/13 dropped                                                                                                                                 |
