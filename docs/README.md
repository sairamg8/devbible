...
| **JavaScript · lane B** — phases **9–12, 17, 18** (platform + applied) | *(open — claim it)* | 2026-08-14 | 🟡 **Open lane.** DOM, events, network/storage, browser platform, machine coding, and the three kept storefront topics. **75 topics left**, all Understand/Know. Same rules as lane A: tier-locked to Understand+Know, Master is closed and not to be reopened, the scope cut applies, per-file save cadence. Start at **phase 9 topic 07 · Traversal**. See the [JavaScript claim notice](javascript/pages/README.md) for the lane table and the shared-file rules |
...
| **[React](./react/README.md)**           | 4 parts · 210 topics | Pending — [216 pages](./react/pages/README.md), **phases 0–10 complete**; Phase 11 writing (6/17), Phase 14 approved (14); 12/13 dropped                                                                                                                                 |
