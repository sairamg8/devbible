...
| **[Docker & Podman](./docker/README.md)** | 4 parts · 192 topics | 🔴 In progress — **[45 pages](./docker/pages/README.md), phases 0–2 complete**; phase 3 next. Both engines together; **no sandbox**, documentation-validated with no console blocks |
