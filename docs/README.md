...
| **[Express](./expressjs/README.md)**     | 4 parts · 114 topics | 🔴 **Master-tier depth pass** — [86 pages](./expressjs/pages/README.md) across 11 phases; all 114 topics covered and verified, but the 28 Master topics were sized to the cap (63–200 lines, none chunked) and are being rewritten to full depth. **23 of 28 done** — phases 0–7 complete (0–6 build-verified), topic 24 part-written |
