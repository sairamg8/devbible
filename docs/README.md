...
| **JavaScript · lane A** — phases **3–8** (the language) | session `ec7d13f7` | 2026-08-14 | 🔴 **Active — LANE A of a two-way split (2026-08-14): functions, objects, built-ins, iteration, async, modules. 70 topics left. TIER-LOCKED to Understand and Know.** 🔴 **Every Master tier is COMPLETE, phases 0–18 (99 of 99 topics)** and is not to be reopened for depth. **143 of 316 in-scope topics written (45%)**; **139 remain — Understand 95 · Know 41 · When Needed 3**. 🔴 **Scope cut 2026-08-14 — language focus:** the DSA block parked (13, 14, 15), Dynamic programming **dropped**, storefront trimmed to three. **21 dropped, 34 parked, nothing written deleted**; the original syllabus is preserved as `*.md.bak`. Order is phase by phase, and inside a phase Understand → Know → When Needed. ✅ **Phase 3 is COMPLETE at every tier (20/20).** Now in **phase 4** (9/20) — next: **topic 10 · Getters and setters**. Phases 0–2 are complete at every tier. Thinnest: phase 12 (2/21), 16 (3/16), 13 (3/10), 6 (3/13). See the [JavaScript claim notice](javascript/pages/README.md) |
| **JavaScript · lane B** — phases **9–12, 17, 18** (platform + applied) | session `b4ffc223` | 2026-08-14 | 🔴 **Active — LANE B of the two-way split.** DOM, events, network/storage, browser platform, machine coding, and the three kept storefront topics. **69 topics left**, all Understand/Know. Same rules as lane A: tier-locked to Understand+Know, Master is closed and not to be reopened, the scope cut applies, per-file save cadence. **Phase 9 Understand 07–12 ✅** — Traversal, Classes and styles, Forms, Removing and replacing, Batching, Layout thrashing (all chunked; 19 files). Next: **phase 9 topic 13 · Measuring elements**. See the [JavaScript claim notice](javascript/pages/README.md) for the lane table and the shared-file rules |
