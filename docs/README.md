...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `2ee7a9a3` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React Phase 7 will look missing on `main`). Phases 0–6 COMPLETE. **Phase 7 in progress — 5 of 12 topics** (01 Rules of Hooks, 02 Writing a custom hook, 03 Share logic not state, 04 Rules of React beyond hooks, 05 Why the rules exist — 03/04 chunked into 4 parts each, 05 into 2). **Resume at topic 06 · Designing a hook's API.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | Pending — [141 pages](./react/pages/README.md), **phases 0–6 complete**, phase 7 under way (5 of 12)                                       |
