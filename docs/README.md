...
| **CSS** — all of `docs/css/` | session `6f020813` | 2026-08-14 | 🔴 **Active.** Syllabus **re-scoped to the critical path: 119 → 74 topics** (SCSS is now usage-only; the architecture phase was cut). **Phases 0–3 written — 37 pages**; **38 topics left**. Doc-validated under the no-new-sandboxes rule. **Phases 4 (Flexbox) and 5 (Grid) are to be written at full Master depth** on the user's instruction. **Phases 0–4 complete (Flexbox at full Master depth, 7 topics / 13 pages)**. **Phases 0–8 complete** — Flexbox and Grid at full Master depth. Next unit: **Phase 9 · Motion (3 topics)** |
...
| **[CSS](./css/README.md)**               | 4 parts · 74 topics  | In progress — [70 pages](./css/pages/README.md), phases 0–8 complete; critical-path scope |
