...
| **JavaScript** — all of `docs/javascript/` | session `016cfc46` | 2026-08-14 | 🔴 **Active — TIER-LOCKED to Understand and Know.** 🔴 **Every Master tier is COMPLETE, phases 0–18 (99 of 99 topics)** and is not to be reopened for depth. **132 of 337 topics written (39%)**; **205 remain — Understand 147 · Know 55 · When Needed 3**. Order is phase by phase, and inside a phase Understand → Know → When Needed. Next: **Phase 3 topic 12 · Composition**. Phases 0–2 are complete at every tier. Thinnest: phase 12 (2/21), 16 (3/16), 13 (3/10), 6 (3/13). See the [JavaScript claim notice](javascript/pages/README.md) |
...
| **Git** — all of `docs/git/`               | session `45e775dc` | 2026-08-14 | 🔴 **Active — LOCKED** (*"There was git course yet to complete the explanations can you pick it up ? and lock it in ?"*). Syllabus complete (13 phases, **191 topics**, 4 parts, 55 Master). **Phase 0 COMPLETE — 14 pages**, sandbox-proven from `sandbox/git-p0/ex1`+`ex2`. **Phases 1–12 remain — 177 topics, zero pages.** Next: **Phase 1 · The everyday loop (16 topics)**. ⚠️ Phase 1 onward is **documentation-validated, not sandbox-proven** — the no-new-sandboxes rule closed the `ex3` plan the old memory carried; pages reuse the recorded `ex1`/`ex2` output where it genuinely covers a claim and otherwise carry **no console block**. Resume point: `devbible/progress_git_pages.md`. |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | Pending — **132 topics / [231 pages](./javascript/pages/README.md)**; phases 0–2 complete at every tier, and the **Master tier of every phase 0–18 complete (99/99)**. Understand and Know tiers under way — 205 topics remain |
...
| **[Git](./git/README.md)**               | 4 parts · 191 topics | 🔴 In progress — [14 pages](./git/pages/README.md), phase 0 complete, phase 1 writing                                                                                       |
| **[Express](./expressjs/README.md)**     | 4 parts · 114 topics | 🔴 **Master-tier depth pass** — [86 pages](./expressjs/pages/README.md) across 11 phases; all 114 topics covered and verified, but the 28 Master topics were sized to the cap (63–200 lines, none chunked) and are being rewritten to full depth. **26 of 28 done** — phases 0–8 complete (0–6 build-verified); the three Phase 8 Master topics chunked to 3 each |
