...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — `docs/react/`, SPLIT A/B       | **A:** session `bfcb390b` · **B:** session `05921047` | 2026-08-14 | 🔴 **Active on `main`** — the `react-phase-7` worktree was **merged** (`d74e74f`), nothing is stranded. **Phases 0–10 COMPLETE — 217 pages.** **Part A** = Phase 11 topics 08–17 + phase close (**15/17 written**). **Part B** = Phase 14 · Testing React, 14 topics, **writing — 2/14**. Split rules: `devbible/project_react_split_parts_ab.md`; handoff: `devbible/progress_react_phase7.md`.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 210 topics | Pending — [236 pages](./react/pages/README.md), **phases 0–10 complete**; Phase 11 writing (15/17), Phase 14 writing (2/14); 12/13 dropped                                                                                                                                 |
