...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `33f8be33` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React phases 7+ will look missing on `main`). **Phases 0–9 COMPLETE — 189 pages.** **Phase 10 🚧 WRITING — 10 of 19 topics, 12 leaf pages, Master tier complete.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | Pending — [201 pages](./react/pages/README.md), **phases 0–9 complete**, phase 10 writing (10/19)                                                                                                                                 |
