...
| **JavaScript · chunk B** — phases **6, 17** (iteration + machine coding) | session `7c6611b4` | 2026-08-15 | 🔴 **Chunk B of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** **21 topics left** — phase 6 (7: topics 07–13, paginating → driving an iterator by hand) and phase 17 (14: topics 05–18, `EventEmitter` → a virtual-DOM diff). Generators and iterators are the machinery the implement-it-yourself phase builds on. 🚧 **3 written, 21 left** — ✅ **6/04 · The iteration protocols** (3 files, 585 lines), ✅ **6/05 · Generators** (3 files, 604 lines) and ✅ **6/06 · Async iterators** (3 files, 541 lines). **Next: 6/07 · Paginating an API with an async generator.** Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
