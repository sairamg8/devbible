...
|---|---|---|---|
| **React** — all of `docs/react/` | session `6ffd754d` | 2026-08-14 | 🔴 **Active.** **Phases 0–4 COMPLETE** (106 files, 0 broken links). **Phase 5 · Refs, context and reducers** in progress — **5 of 16 topics** (113 files), then straight through 6–14. |
...
| **JavaScript** — all of `docs/javascript/` | session `01ECVvH5` | 2026-08-13 | 🔴 **Active.** **Phases 3–6 Master tiers COMPLETE** — P3 01–08, P4 01/03–08, P5 01/02/04–07/09/10, P6 01–03. **Phase 7 Master tier COMPLETE** (all 11). **Phase 8 in progress** — Master 02 of 4. See the [JavaScript claim notice](javascript/pages/README.md) |
| **CSS** — all of `docs/css/` | session `6f020813` | 2026-08-14 | 🔴 **Active.** Syllabus **re-scoped to the critical path: 119 → 74 topics** (SCSS is now usage-only; the architecture phase was cut). **Phases 0–3 written — 37 pages**; **38 topics left**. Doc-validated under the no-new-sandboxes rule. **Phases 4 (Flexbox) and 5 (Grid) are to be written at full Master depth** on the user's instruction. **Phases 0–4 complete (Flexbox at full Master depth, 7 topics / 13 pages)**. **Phases 0–5 complete** — Flexbox and Grid both at full Master depth. Next unit: **Phase 6 · Container queries (3 topics)** |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [138 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
| **[TypeScript](./typescript/README.md)** | 4 parts · 187 topics | In progress — [37 pages](./typescript/pages/README.md), phases 0–2                   |
| **[CSS](./css/README.md)**               | 4 parts · 74 topics  | In progress — [60 pages](./css/pages/README.md), phases 0–5 complete; critical-path scope |
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [113 pages](./react/pages/README.md), **phases 0–4 complete**, phase 5 at 5/16 |
