...
|---|---|---|---|
| **React** — all of `docs/react/` | session `52a29103` | 2026-08-13 | 🔴 **Active.** **Phases 0–3 COMPLETE**; **Phase 4 · Effects** in progress — **15 of 18 topics** (103 files). See the [React claim notice](react/pages/README.md) |
...
| **JavaScript** — all of `docs/javascript/` | session `01ECVvH5` | 2026-08-13 | 🔴 **Active.** **Phases 3–6 Master tiers COMPLETE** — P3 01–08, P4 01/03–08, P5 01/02/04–07/09/10, P6 01–03. **Phase 7 in progress** — Master 01–07 done, writing 08–11. See the [JavaScript claim notice](javascript/pages/README.md) |
| **CSS** — all of `docs/css/` | session `6f020813` | 2026-08-14 | 🔴 **Active.** Syllabus **re-scoped to the critical path: 119 → 74 topics** (SCSS is now usage-only; the architecture phase was cut). **Phases 0–2 written — 33 pages**; **42 topics left**. Phase 2 is doc-validated under the no-new-sandboxes rule. Next unit: **Phase 3 · Custom properties (4 topics)** |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [123 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
| **[TypeScript](./typescript/README.md)** | 4 parts · 187 topics | In progress — [37 pages](./typescript/pages/README.md), phases 0–2                   |
| **[CSS](./css/README.md)**               | 4 parts · 74 topics  | In progress — [33 pages](./css/pages/README.md), phases 0–2 complete; critical-path scope |
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [103 pages](./react/pages/README.md), **phases 0–3 complete**, phase 4 at 15/18 |
