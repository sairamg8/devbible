...
|---|---|---|---|
| **React** — all of `docs/react/` | session `52a29103` | 2026-08-13 | 🔴 **Active.** **Phases 0–3 COMPLETE**; **Phase 4 · Effects** in progress — **8 of 18 topics** (93 files). See the [React claim notice](react/pages/README.md) |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [93 pages](./react/pages/README.md), **phases 0–3 complete**, phase 4 at 8/18 |
