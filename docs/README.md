...
| **JavaScript · chunk B** — phases **6, 17** (iteration + machine coding) | session `7c6611b4` | 2026-08-15 | 🔴 **Chunk B of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** **16 topics left** — phase 6 (2: topics 12–13, a collection class → driving an iterator by hand) and phase 17 (14: topics 05–18, `EventEmitter` → a virtual-DOM diff). Generators and iterators are the machinery the implement-it-yourself phase builds on. 🚧 **8 written, 16 left — the phase-6 Understand tier is COMPLETE (04–08), Know under way** — ✅ **6/04 · The iteration protocols** (3 files, 585 lines), ✅ **6/05 · Generators** (3 files, 604 lines) ✅ **6/06 · Async iterators** (3 files, 541 lines) ✅ **6/07 · Paginating an API with an async generator** (3 files, 553 lines) ✅ **6/08 · Early exit inside iteration** (3 files, 483 lines) ✅ **6/09 · Two-way generators** (3 files, 503 lines) ✅ **6/10 · `yield*` delegation** (3 files, 461 lines) and ✅ **6/11 · Iterator helpers** (3 files, 421 lines). **Next: 6/12 · A collection class that iterates cleanly.** Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
| **JavaScript · chunk C** — phases **7, 8** (async + modules, errors, tooling) | session `f6dffd4a` | 2026-08-15 | 🔴 **Chunk C of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** 🚧 **18 topics left, 7 written** — ✅ **7/12 · Timers** (4 files, 822 lines), ✅ **7/13 · Creating promises** (3, 533), ✅ **7/14 · Cancellation** (3, 548), ✅ **7/15 · Timeouts, retries, backoff and jitter** (3, 486), ✅ **7/16 · Concurrency limiting** (3, 506) ✅ **7/17 · Race conditions in a UI** (3, 497) and ✅ **7/18 · `queueMicrotask`** (3, 442). Phase 7 (4 left: topics 19–22, the two event loops → backpressure) and phase 8 (14: topics 05–18, dynamic `import()` → linting). **Next: 7/19 · Event loop: browser vs Node — the last Understand topic of phase 7.** The natural pair: error handling, the event loop and the toolchain sit either side of the same seam. Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
