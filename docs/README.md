...
|---|---|---|---|
| **React** — all of `docs/react/` | session `52a29103` | 2026-08-13 | 🔴 **Active.** **Phases 0–3 COMPLETE**; **Phase 4 · Effects** in progress — **4 of 18 topics** (86 files). See the [React claim notice](react/pages/README.md) |
...
| **JavaScript** — all of `docs/javascript/` | session `01ECVvH5` | 2026-08-13 | 🔴 **Active.** **Phases 3–6 Master tiers COMPLETE** — P3 01–08, P4 01/03–08, P5 01/02/04–07/09/10, P6 01–03. **Phase 7 in progress** — Master 01–03 done, writing 04–11. See the [JavaScript claim notice](javascript/pages/README.md) |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [114 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [86 pages](./react/pages/README.md), **phases 0–3 complete**, phase 4 at 4/18 |
