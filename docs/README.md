...
|---|---|---|---|
| **React** — all of `docs/react/` | session `52a29103` | 2026-08-13 | 🔴 **Active.** **Phases 0–4 COMPLETE** — Phase 4 · Effects finished 18/18, **106 files**, 0 broken links, 0 over cap. Starting **Phase 5 · Refs, context and reducers**. See the [React claim notice](react/pages/README.md) |
