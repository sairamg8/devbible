...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `2ee7a9a3` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React Phase 7 will look missing on `main`). Phases 0–6 COMPLETE. **Phase 7 ✅ COMPLETE — all 12 topics, 25 pages, 7,084 lines, 0 files over 300, build-verified.** **Phase 8 ✅ COMPLETE — 18 topics, 20 pages, 4,827 lines.** **Phase 9 under way — 7 of 14 topics; the phase's Master tier is complete.** **Resume at Phase 9 topic 08 · Multiple actions in one form.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | Pending — [182 pages](./react/pages/README.md), **phases 0–8 complete**, phase 9 under way (7 of 14)                                                                             |
