...
| **[Docker & Podman](./docker/README.md)** | 4 parts · 192 topics | 🔴 In progress — **[14 pages](./docker/pages/README.md), phase 0 complete**; phase 1 next. Both engines together; **no sandbox**, documentation-validated with no console blocks |
