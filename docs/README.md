...
|---|---|---|---|
| **React** — all of `docs/react/` | session `52a29103` | 2026-08-13 | 🔴 **Active.** Phases 0–2 done; **Phase 3 in progress**. See the [React claim notice](react/pages/README.md) |
...
| **JavaScript** — all of `docs/javascript/` | session `01ECVvH5` | 2026-08-13 | 🔴 **Active.** Phase 3 Master **done** (01–08); **Phase 4 Master in progress** — 01, 03, 04, 05, 06 done, 07 in progress, 08 next. See the [JavaScript claim notice](javascript/pages/README.md) |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [60+ pages](./react/pages/README.md), **phases 0–2 complete**, phase 3 active |
