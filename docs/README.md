...
| **[Docker & Podman](./docker/README.md)** | 4 parts · 192 topics | 🔴 In progress — **[30 pages](./docker/pages/README.md), phases 0–1 complete**; phase 2 next. Both engines together; **no sandbox**, documentation-validated with no console blocks |
