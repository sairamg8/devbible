...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `2ee7a9a3` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React Phase 7 will look missing on `main`). Phases 0–6 COMPLETE. **Phase 7 in progress — 6 of 12 topics** (01–06 written; 03/04 chunked into 4 parts each, 05/06 into 2 each). **Resume at topic 07 · The standard set, written out — this one needs chunking, ten hooks each with its gotcha.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | Pending — [143 pages](./react/pages/README.md), **phases 0–6 complete**, phase 7 under way (6 of 12)                                       |
