...
| **JavaScript · chunk C** — phases **7, 8** (async + modules, errors, tooling) | session `f6dffd4a` | 2026-08-15 | 🔴 **Chunk C of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** 🚧 **15 topics left, 10 written** — ✅ **7/12 · Timers** (4 files, 822 lines), ✅ **7/13 · Creating promises** (3, 533), ✅ **7/14 · Cancellation** (3, 548), ✅ **7/15 · Timeouts, retries, backoff and jitter** (3, 486), ✅ **7/16 · Concurrency limiting** (3, 506) ✅ **7/17 · Race conditions in a UI** (3, 497), ✅ **7/18 · `queueMicrotask`** (3, 442) and ✅ **7/19 · Event loop: browser vs Node** (4, 563). ✅ **The Understand tier of phase 7 is COMPLETE — topics 12–19, all eight, 26 files / 4,397 lines.** Phase 7 (**1 left**: Know 22; ✅ **20 · `Promise.withResolvers`** 199 lines and ✅ **21 · Thenables** 213 lines) and phase 8 (14: topics 05–18, dynamic `import()` → linting). **Next: 7/22 · Async work and backpressure — the last topic of phase 7.** The natural pair: error handling, the event loop and the toolchain sit either side of the same seam. Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
