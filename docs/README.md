...
| **JavaScript · chunk C** — phases **7, 8** (async + modules, errors, tooling) | session `f6dffd4a` | 2026-08-15 | 🔴 **Chunk C of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** ✅ **PHASE 7 IS COMPLETE AT EVERY TIER — 22/22, 69 files, 11,962 lines, 0 over the 300-line cap.** Eleven topics written in this session: Understand **12–19** (Timers · Creating promises · Cancellation · Timeouts, retries, backoff and jitter · Concurrency limiting · Race conditions in a UI · `queueMicrotask` · Event loop: browser vs Node — 26 files / 4,397 lines) and Know **20–22** (`Promise.withResolvers` · Thenables · Async work and backpressure — 3 flat files / 644 lines). 🚧 **6 topics left, all in phase 8** — topics 13–18, bundlers → linting. ✅ **8/05 · Dynamic `import()`** (3 files, 493 lines), ✅ **8/06 · Circular imports** (3, 474) ✅ **8/07 · `throw`, `try`/`catch`/`finally`** (3, 510) ✅ **8/08 · Custom error classes** (3, 468) ✅ **8/09 · Failing well** (3, 463) ✅ **8/10 · Global error handling** (3, 521) ✅ **8/11 · The memory model** (3, 494) and ✅ **8/12 · Finding a leak** (3, 428). 🔴 **Cadence tightened to PER FILE** on the user's warning that usage is above 90%. **Next: 8/13 · Bundlers and the build.** Documentation-validated throughout — MDN, the HTML Standard, ECMAScript, RFC 9110, the Node docs and the AWS Builders' Library, each named in the page's `> Verified:` line; **no sandbox, no console blocks**. Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_chunk_c.md` (cursor also in `devbible/progress_javascript_split_4way.md`). See the [JavaScript claim notice](javascript/pages/README.md) |
