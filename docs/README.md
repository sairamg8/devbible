...
| **JavaScript** — all of `docs/javascript/` | session `01ECVvH5` | 2026-08-13 | 🔴 **Active.** **Phases 3–6 Master tiers COMPLETE** — P3 01–08, P4 01/03–08, P5 01/02/04–07/09/10, P6 01–03. **Phase 7 in progress** — Master 01–09 done, writing 10–11. See the [JavaScript claim notice](javascript/pages/README.md) |
| **CSS** — all of `docs/css/` | session `6f020813` | 2026-08-14 | 🔴 **Active.** Syllabus **re-scoped to the critical path: 119 → 74 topics** (SCSS is now usage-only; the architecture phase was cut). **Phases 0–3 written — 37 pages**; **38 topics left**. Doc-validated under the no-new-sandboxes rule. **Phases 4 (Flexbox) and 5 (Grid) are to be written at full Master depth** on the user's instruction. 🚧 **Phase 4 · Flexbox in progress — 2 of 7 topics** (full Master depth, chunked) |
...
| **[JavaScript](./javascript/README.md)** | 5 parts · 337 topics | In progress — [128 pages](./javascript/pages/README.md); phases 0–2 complete, Master tiers of 3–6 complete, phase 7 under way |
