...
| **JavaScript · chunk A** — phases **5, 11** (built-in library + data transfer) | session `21d2f5de` | 2026-08-15 | 🔴 **Chunk A of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** 🚧 **18 topics left** — phase 5 is at **22/26 with the Understand tier COMPLETE (14/14)**; only the four **Know** topics remain (23 `WeakMap`/`WeakSet` · 24 `Temporal` · 25 typed arrays · 26 text encoding). Written 2026-08-15: ✅ **18 · `Object` statics** 1,045 lines, ✅ **19 · `Date`** 1,070, ✅ **20 · `Intl`** 918, ✅ **21 · `structuredClone`** 207, ✅ **22 · Array-likes and iterables** 569 and phase 11 (14: topics 08–21, aborting → `XMLHttpRequest`). They pair on purpose: `structuredClone`, typed arrays and `TextEncoder` are what phase 11's `postMessage`, `Blob` and streams pages lean on. Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
| **JavaScript · chunk B** — phases **6, 17** (iteration + machine coding) | session `7c6611b4` | 2026-08-15 | 🔴 **Chunk B of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** **15 topics left** — phase 6 (1: topic 13, driving an iterator by hand) and phase 17 (14: topics 05–18, `EventEmitter` → a virtual-DOM diff). Generators and iterators are the machinery the implement-it-yourself phase builds on. 🚧 **9 written, 15 left — the phase-6 Understand tier is COMPLETE (04–08), Know under way** — ✅ **6/04 · The iteration protocols** (3 files, 585 lines), ✅ **6/05 · Generators** (3 files, 604 lines) ✅ **6/06 · Async iterators** (3 files, 541 lines) ✅ **6/07 · Paginating an API with an async generator** (3 files, 553 lines) ✅ **6/08 · Early exit inside iteration** (3 files, 483 lines) ✅ **6/09 · Two-way generators** (3 files, 503 lines) ✅ **6/10 · `yield*` delegation** (3 files, 461 lines) ✅ **6/11 · Iterator helpers** (3 files, 421 lines) and ✅ **6/12 · A collection class** (3 files, 465 lines) — **the Know tier is complete (09–12)**. **Next: 6/13 · Driving an iterator by hand, then phase 17.** Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
| **JavaScript · chunk C** — phases **7, 8** (async + modules, errors, tooling) | session `f6dffd4a` | 2026-08-15 | 🔴 **Chunk C of a FOUR-way split (2026-08-15) — this replaces the old lane A/B split, which is closed.** 🚧 **16 topics left, 9 written** — ✅ **7/12 · Timers** (4 files, 822 lines), ✅ **7/13 · Creating promises** (3, 533), ✅ **7/14 · Cancellation** (3, 548), ✅ **7/15 · Timeouts, retries, backoff and jitter** (3, 486), ✅ **7/16 · Concurrency limiting** (3, 506) ✅ **7/17 · Race conditions in a UI** (3, 497), ✅ **7/18 · `queueMicrotask`** (3, 442) and ✅ **7/19 · Event loop: browser vs Node** (4, 563). ✅ **The Understand tier of phase 7 is COMPLETE — topics 12–19, all eight, 26 files / 4,397 lines.** Phase 7 (2 left: **Know** 21–22; ✅ **20 · `Promise.withResolvers`**, 199 lines) and phase 8 (14: topics 05–18, dynamic `import()` → linting). **Next: 7/21 · Thenables.** The natural pair: error handling, the event loop and the toolchain sit either side of the same seam. Tier-locked to **Understand and Know** — Master is closed at 99/99 and is not reopened for depth. The 2026-08-14 scope cut stands (21 dropped, 34 parked). Work on `main`, stage explicit paths, **never `git add -A`**. Resume file: `devbible/progress_javascript_split_4way.md`. See the [JavaScript claim notice](javascript/pages/README.md) |
