...
| ------------------------------------------ | ------------------ | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **React** — all of `docs/react/`           | session `33f8be33` | 2026-08-14 | 🔴 **Active — written in a WORKTREE**, `Backup/Knowledge/devbible-react`, branch **`react-phase-7`** (unmerged — React phases 7+ will look missing on `main`). **Phases 0–9 COMPLETE — 189 pages.** **Phase 10 🚧 WRITING — 17 of 19 topics, 19 leaf pages, Master tier complete.** Handoff: `devbible/progress_react_phase7.md` in the memory store.                                                              |
...
| **[React](./react/README.md)**           | 4 parts · 210 topics | Pending — [208 pages](./react/pages/README.md), **phases 0–9 complete**, phase 10 writing (17/19)                                                                                                                                 |
