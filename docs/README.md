...
| **JavaScript · lane B** — phases **9–12, 17, 18** (platform + applied) | session `b4ffc223` | 2026-08-14 | 🔴 **Active — LANE B of the two-way split.** DOM, events, network/storage, browser platform, machine coding, and the three kept storefront topics. **74 topics left**, all Understand/Know. Same rules as lane A: tier-locked to Understand+Know, Master is closed and not to be reopened, the scope cut applies, per-file save cadence. **Phase 9 · 07 · Traversal ✅** (chunked, 3 files). Next: **phase 9 topic 08 · Classes and styles from JavaScript**. See the [JavaScript claim notice](javascript/pages/README.md) for the lane table and the shared-file rules |
