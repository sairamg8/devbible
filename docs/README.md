...
|---|---|---|---|
| **React** — all of `docs/react/` | session `6ffd754d` | 2026-08-14 | 🔴 **Active.** **Phases 0–4 COMPLETE** (106 files, 0 broken links). **Phase 5 · Refs, context and reducers** in progress — **4 of 16 topics** (112 files), then straight through 6–14. |
...
| **[React](./react/README.md)**           | 4 parts · 244 topics | In progress — [112 pages](./react/pages/README.md), **phases 0–4 complete**, phase 5 at 4/16 |
