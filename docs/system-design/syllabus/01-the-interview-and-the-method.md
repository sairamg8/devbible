...
| **How to practise** — timed drills on the canonical questions ([Part 12](12-the-hld-catalogue.md)), mock interviews with a peer who grades against the rubric, recording yourself, and a written post-mortem per session | <span className="db-tier t-understand">Understand</span> |
