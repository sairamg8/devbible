...
notice that, not to disable rules. [chunk 10 · Adoption and the CI cost](./10-adoption-and-ci-cost.md) is the
arithmetic.
...
it pays. [chunk 10 · Adoption and the CI cost](./10-adoption-and-ci-cost.md) uses them.
...
[chunk 10 · Adoption and the CI cost](./10-adoption-and-ci-cost.md) is about running one type-check instead
of two.
