...
| 12 | [Assertion discipline](./12-assertion-discipline/README.md) *(🚧 1 chunk)* | <span className="db-tier t-understand">Understand</span> | Treating every `as` as a review comment, and the guard that should have been written |
