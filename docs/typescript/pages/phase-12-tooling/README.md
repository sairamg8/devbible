...
| 06 | [Diagnosing a slow compile](./06-diagnosing-a-slow-compile/README.md) *(🚧 1 chunk)* | <span className="db-tier t-understand">Understand</span> | 🔴 Read the **phase split** first — *too many files* and *types too complex* present identically and have opposite fixes |
