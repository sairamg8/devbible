...
|---|---|---|---|
| 01 | [`module` and `moduleResolution`](./01-module-and-moduleresolution/README.md) *(8 chunks)* | <span className="db-tier t-master">Master</span> | `node16`/`nodenext` vs `bundler` vs the legacy `node10`; picking the one that matches what actually loads your code |
