...
| **B · strictness + tooling** | `phase-10-strictness/` **and** `phase-12-tooling/` | 🏁 **0 — COMPLETE** | session `c01e37bb`, 2026-08-17 (took over from `ede9cd9f`) |
...
| [5 · Type-level programming](./phase-5-type-level/README.md) | Types at scale | 16 / 16 | ✅ written |
...
| [12 · Tooling, performance and testing](./phase-12-tooling/README.md) | Rigour and tooling | 15 / 15 | ✅ written |
