...
| [4 · Classes, objects and declaration merging](./phase-4-classes-declarations/README.md) | Types at scale | 1 / 14 | 🚧 writing |
| 5 · Type-level programming | Types at scale | — | planned |
| 6 · Modules, declarations and the build | Types at scale | — | planned |
| [7 · TypeScript on the server](./phase-7-server/README.md) | In the stack | 3 / 15 | 🚧 writing |
