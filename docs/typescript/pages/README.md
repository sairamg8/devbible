...
| [5 · Type-level programming](./phase-5-type-level/README.md) | Types at scale | 10 / 16 | 🚧 writing |
| [6 · Modules, declarations and the build](./phase-6-modules-build/README.md) | Types at scale | 6 / 16 | 🚧 writing |
