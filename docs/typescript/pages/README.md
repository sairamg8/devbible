...
|---|---|---|---|
| **A · type-level** | `phase-5-type-level/` topics **08–16** | 1 | session `65de22b3`, 2026-08-17 |
| **B · strictness + tooling** | `phase-10-strictness/` **and** `phase-12-tooling/` | 11 | session `c01e37bb`, 2026-08-17 (took over from `ede9cd9f`) |
...
| [5 · Type-level programming](./phase-5-type-level/README.md) | Types at scale | 15 / 16 | 🚧 writing |
...
| [12 · Tooling, performance and testing](./phase-12-tooling/README.md) | Rigour and tooling | 4 / 15 | 🚧 writing |
