...
| **B · strictness + tooling** | `phase-10-strictness/` **and** `phase-12-tooling/` | 3 | session `c01e37bb`, 2026-08-17 (took over from `ede9cd9f`) |
...
| [12 · Tooling, performance and testing](./phase-12-tooling/README.md) | Rigour and tooling | 12 / 15 | 🚧 writing |
