---
title: "Seq vs index vs bitmap"
sidebar_label: "04 · Scans"
sidebar_position: 4
---
...
`psql` is how you prove every later claim. Seq vs index vs bitmap is daily operator skill.
...
**★ What is the core idea of “Seq vs index vs bitmap”?**  
Sequential scan can be the right plan for large fractions of a table.
