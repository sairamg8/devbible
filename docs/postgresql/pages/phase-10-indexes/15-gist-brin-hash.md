---
title: "GiST BRIN hash"
sidebar_label: "15 · Other indexes"
sidebar_position: 15
---
...
`psql` is how you prove every later claim. GiST BRIN hash is daily operator skill.
...
**★ What is the core idea of “GiST BRIN hash”?**  
GiST for ranges/geo, BRIN for huge append-only time series, hash rarely needed.
