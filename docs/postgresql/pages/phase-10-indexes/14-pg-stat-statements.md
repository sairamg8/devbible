...
sidebar_label: "14 · stat_statements"
sidebar_position: 14
---
...
`psql` is how you prove every later claim. pg_stat_statements is daily operator skill.
...
**★ What is the core idea of “pg_stat_statements”?**  
pg_stat_statements finds the queries that actually cost you.
...
← [Unused and duplicate indexes](13-unused-indexes.md) · Next → [GiST BRIN hash](15-gist-brin-hash.md)
