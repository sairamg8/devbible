...
`psql` is how you prove every later claim. Expression indexes is daily operator skill.
...
**★ What is the core idea of “Expression indexes”?**  
Expression indexes require the query to match the expression exactly.
...
← [Partial indexes](09-partial.md) · Next → [GIN jsonb arrays FTS trgm](11-gin-trgm.md)
