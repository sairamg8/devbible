...
`psql` is how you prove every later claim. Unused and duplicate indexes is daily operator skill.
...
**★ What is the core idea of “Unused and duplicate indexes”?**  
Find unused/duplicate indexes with pg_stat_user_indexes before dropping carefully.
