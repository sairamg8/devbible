---
title: "Index bloat REINDEX"
sidebar_label: "17 · Bloat"
sidebar_position: 17
---
...
`psql` is how you prove every later claim. Index bloat REINDEX is daily operator skill.
...
**★ What is the core idea of “Index bloat REINDEX”?**  
Indexes bloat; REINDEX CONCURRENTLY rebuilds with less locking.
...
← [Statistics and ANALYZE](16-statistics.md) · [Phase index](README.md)
