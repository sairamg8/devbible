...
`psql` is how you prove every later claim. CREATE INDEX CONCURRENTLY is daily operator skill.
...
**★ What is the core idea of “CREATE INDEX CONCURRENTLY”?**  
CONCURRENTLY builds without long write locks; failure modes leave invalid indexes.
...
← [GIN jsonb arrays FTS trgm](11-gin-trgm.md) · Next → [Unused and duplicate indexes](13-unused-indexes.md)
