---
title: "Index-only scans and INCLUDE"
sidebar_label: "08 · Index-only"
sidebar_position: 8
---
...
`psql` is how you prove every later claim. Index-only scans and INCLUDE is daily operator skill.
...
**★ What is the core idea of “Index-only scans and INCLUDE”?**  
Index-only scans use the index and visibility map; INCLUDE adds non-key columns for covering indexes.
