...
`psql` is how you prove every later claim. Why an index is not used is daily operator skill.
...
**★ What is the core idea of “Why an index is not used”?**  
Type mismatch, functions on the column, low selectivity, stale stats — classic reasons indexes are ignored.
