---
title: "GIN jsonb arrays FTS trgm"
sidebar_label: "11 · GIN"
sidebar_position: 11
---
...
`psql` is how you prove every later claim. GIN jsonb arrays FTS trgm is daily operator skill.
...
**★ What is the core idea of “GIN jsonb arrays FTS trgm”?**  
GIN supports jsonb/arrays/FTS; pg_trgm can make %x% searchable.
