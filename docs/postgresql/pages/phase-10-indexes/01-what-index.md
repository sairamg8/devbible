...
`psql` is how you prove every later claim. What an index is is daily operator skill.
...
**★ What is the core idea of “What an index is”?**  
An index speeds reads you plan for and costs writes on every insert/update/delete.
...
← [Phase index](README.md) · Next → [B-tree indexes](02-btree.md)
