...
Correct SQL is the product surface of your API. Window frames shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Window frames”?**  
Frame clauses control which rows enter the window aggregate.
...
← [Ordered-set aggregates](13-ordered-set.md) · Next → [Recursive CTEs](15-recursive-cte.md)
