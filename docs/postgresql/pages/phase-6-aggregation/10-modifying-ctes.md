...
sidebar_label: "10 · Modifying CTEs"
sidebar_position: 10
---
...
Correct SQL is the product surface of your API. Data-modifying CTEs shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Data-modifying CTEs”?**  
Keep transaction boundaries obvious from Node.
...
← [CTEs WITH](09-ctes.md) · Next → [Subqueries](11-subqueries.md)
