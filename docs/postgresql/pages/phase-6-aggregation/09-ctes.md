...
Correct SQL is the product surface of your API. CTEs WITH shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “CTEs WITH”?**  
WITH names subqueries; PostgreSQL 12+ inlines CTEs unless MATERIALIZED.
