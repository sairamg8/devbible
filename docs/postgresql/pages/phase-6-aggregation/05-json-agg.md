---
title: "jsonb_agg and friends"
sidebar_label: "05 · jsonb_agg"
sidebar_position: 5
---
...
Correct SQL is the product surface of your API. jsonb_agg and friends shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “jsonb_agg and friends”?**  
string_agg, array_agg, jsonb_agg build payloads the API can return directly.
...
← [FILTER WHERE aggregates](04-filter-clause.md) · Next → [Window functions intro](06-windows-intro.md)
