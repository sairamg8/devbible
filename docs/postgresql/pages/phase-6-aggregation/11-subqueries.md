...
Correct SQL is the product surface of your API. Subqueries shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Subqueries”?**  
Scalar, row, and correlated subqueries — correlated can be N+1 inside one statement.
...
← [Data-modifying CTEs](10-modifying-ctes.md) · Next → [Counting for pagination](12-pagination-counts.md)
