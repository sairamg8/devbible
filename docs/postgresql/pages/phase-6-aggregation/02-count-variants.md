...
Correct SQL is the product surface of your API. count variants shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “count variants”?**  
Pick deliberately — they answer different questions.
...
← [GROUP BY and aggregates](01-group-by.md) · Next → [HAVING vs WHERE](03-having.md)
