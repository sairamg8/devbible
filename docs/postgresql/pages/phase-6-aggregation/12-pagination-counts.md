...
sidebar_label: "12 · Pagination counts"
sidebar_position: 12
---
...
Correct SQL is the product surface of your API. Counting for pagination shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Counting for pagination”?**  
Many products do not need total page counts.
...
← [Subqueries](11-subqueries.md) · Next → [Ordered-set aggregates](13-ordered-set.md)
