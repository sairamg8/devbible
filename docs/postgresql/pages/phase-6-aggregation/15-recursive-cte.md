...
sidebar_label: "15 · Recursive CTE"
sidebar_position: 15
---
...
Correct SQL is the product surface of your API. Recursive CTEs shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Recursive CTEs”?**  
WITH RECURSIVE walks trees and graphs; guard cycles and cap depth.
...
← [Window frames](14-frames.md) · Next → [GROUPING SETS ROLLUP CUBE](16-grouping-sets.md)
