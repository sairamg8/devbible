...
Correct SQL is the product surface of your API. Ordered-set aggregates shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Ordered-set aggregates”?**  
percentile_cont and friends compute stats — know they exist.
...
← [Counting for pagination](12-pagination-counts.md) · Next → [Window frames](14-frames.md)
