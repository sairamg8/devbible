---
title: "lag lead first_value"
sidebar_label: "08 · lag lead"
sidebar_position: 8
---
...
Correct SQL is the product surface of your API. lag lead first_value shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “lag lead first_value”?**  
lag/lead look at other rows in the partition for deltas and sessions.
...
← [Ranking functions](07-ranking.md) · Next → [CTEs WITH](09-ctes.md)
