...
Correct SQL is the product surface of your API. GROUP BY and aggregates shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “GROUP BY and aggregates”?**  
GROUP BY collapses rows; aggregates compute per group.
...
← [Phase index](README.md) · Next → [count variants](02-count-variants.md)
