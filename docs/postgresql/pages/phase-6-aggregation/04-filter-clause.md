---
title: "FILTER WHERE aggregates"
sidebar_label: "04 · FILTER"
sidebar_position: 4
---
...
Correct SQL is the product surface of your API. FILTER WHERE aggregates shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “FILTER WHERE aggregates”?**  
Readable conditional aggregation without nested queries.
...
← [HAVING vs WHERE](03-having.md) · Next → [jsonb_agg and friends](05-json-agg.md)
