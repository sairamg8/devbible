...
`psql` is how you prove every later claim. Long-running transactions is daily operator skill.
...
**★ What is the core idea of “Long-running transactions”?**  
Long transactions block vacuum and create bloat — keep them short.
