---
title: "Row locks FOR UPDATE"
sidebar_label: "07 · Row locks"
sidebar_position: 7
---
...
`psql` is how you prove every later claim. Row locks FOR UPDATE is daily operator skill.
...
**★ What is the core idea of “Row locks FOR UPDATE”?**  
FOR UPDATE / NO KEY UPDATE / SHARE control what concurrent txs may do.
