...
`psql` is how you prove every later claim. BEGIN COMMIT ROLLBACK is daily operator skill.
...
**★ What is the core idea of “BEGIN COMMIT ROLLBACK”?**  
Each pool.query is auto-commit unless you BEGIN on a held client.
