...
`psql` is how you prove every later claim. Table locks and DDL is daily operator skill.
...
**★ What is the core idea of “Table locks and DDL”?**  
DDL takes locks that block other operations — know the dangerous ALTERs.
