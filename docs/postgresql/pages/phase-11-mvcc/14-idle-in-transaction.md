...
`psql` is how you prove every later claim. Idle in transaction is daily operator skill.
...
**★ What is the core idea of “Idle in transaction”?**  
Idle-in-transaction from a leaked BEGIN in Node freezes vacuum progress.
