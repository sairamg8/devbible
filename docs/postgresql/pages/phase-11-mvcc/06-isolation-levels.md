---
title: "REPEATABLE READ SERIALIZABLE"
sidebar_label: "06 · Isolation"
sidebar_position: 6
---
...
`psql` is how you prove every later claim. REPEATABLE READ SERIALIZABLE is daily operator skill.
...
**★ What is the core idea of “REPEATABLE READ SERIALIZABLE”?**  
Higher isolation can throw serialization failures — Node must retry safely.
