...
sidebar_label: "06 · Scripting psql"
sidebar_position: 6
---

<span className="db-tier t-understand">Understand</span>

**-c -f ON_ERROR_STOP exit codes.**

## Why it matters

`psql` is how you prove every later claim. Scripting psql is daily operator skill.
...
const {rows} = await pool.query('select $1::text as topic', ['Scripting psql']);
console.log(rows[0]);
await pool.end();
```
...
**★ What is the core idea of “Scripting psql”?**  
-c -f ON_ERROR_STOP exit codes.
