---
title: ".psqlrc and prompt"
sidebar_label: "13 · .psqlrc and prompt"
sidebar_position: 13
---

<span className="db-tier t-know">Know</span>

**Config, HISTFILE, autocomplete.**

## Why it matters

`psql` is how you prove every later claim. .psqlrc and prompt is daily operator skill.
...
const {rows} = await pool.query('select $1::text as topic', ['.psqlrc and prompt']);
console.log(rows[0]);
await pool.end();
```
...
**★ What is the core idea of “.psqlrc and prompt”?**  
Config, HISTFILE, autocomplete.
