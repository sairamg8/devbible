...
`psql` is how you prove every later claim. Logical replication is daily operator skill.
...
**★ What is the core idea of “Logical replication”?**  
Logical replication can enable near-zero-downtime major upgrades.
...
← [Physical backup PITR](15-physical-backup.md) · Next → [Major version upgrades](17-major-upgrades.md)
