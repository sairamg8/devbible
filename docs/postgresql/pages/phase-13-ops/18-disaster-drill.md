...
`psql` is how you prove every later claim. Disaster drill is daily operator skill.
...
**★ What is the core idea of “Disaster drill”?**  
Restore a backup into a scratch database and verify it on a schedule.
...
← [Major version upgrades](17-major-upgrades.md) · [Phase index](README.md)
