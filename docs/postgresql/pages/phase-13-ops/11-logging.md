...
`psql` is how you prove every later claim. Logging slow queries is daily operator skill.
...
**★ What is the core idea of “Logging slow queries”?**  
log_min_duration_statement finds slow SQL in production logs.
...
← [Key configuration](10-config-keys.md) · Next → [Zero-downtime schema changes](12-zero-downtime-ddl.md)
