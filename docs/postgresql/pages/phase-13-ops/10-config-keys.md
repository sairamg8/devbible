...
`psql` is how you prove every later claim. Key configuration is daily operator skill.
...
**★ What is the core idea of “Key configuration”?**  
shared_buffers, work_mem, max_connections, effective_cache_size — know what they buy.
...
← [Monitoring views](09-monitoring.md) · Next → [Logging slow queries](11-logging.md)
