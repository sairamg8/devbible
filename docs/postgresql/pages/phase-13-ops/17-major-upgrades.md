...
`psql` is how you prove every later claim. Major version upgrades is daily operator skill.
...
**★ What is the core idea of “Major version upgrades”?**  
pg_upgrade vs dump/restore vs logical replication — pick for downtime budget.
