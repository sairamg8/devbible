---
title: "Physical backup PITR"
sidebar_label: "15 · PITR"
sidebar_position: 15
---
...
`psql` is how you prove every later claim. Physical backup PITR is daily operator skill.
...
**★ What is the core idea of “Physical backup PITR”?**  
Physical backup + WAL archiving enables point-in-time recovery.
...
← [Row-level security](14-rls.md) · Next → [Logical replication](16-logical-replication.md)
