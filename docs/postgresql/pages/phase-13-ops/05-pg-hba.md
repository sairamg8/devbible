...
`psql` is how you prove every later claim. pg_hba.conf is daily operator skill.
...
**★ What is the core idea of “pg_hba.conf”?**  
pg_hba.conf chooses auth methods and host rules — scram-sha-256 is modern default.
...
← [pg_dump and pg_restore](04-pg-dump-restore.md) · Next → [TLS to the database](06-tls.md)
