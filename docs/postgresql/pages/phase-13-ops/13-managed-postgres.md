...
`psql` is how you prove every later claim. Managed PostgreSQL is daily operator skill.
...
**★ What is the core idea of “Managed PostgreSQL”?**  
Managed Postgres trades control for ops — superuser and extension limits differ.
...
← [Zero-downtime schema changes](12-zero-downtime-ddl.md) · Next → [Row-level security](14-rls.md)
