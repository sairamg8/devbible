---
title: "App role should not own schema"
sidebar_label: "03 · App role"
sidebar_position: 3
---
...
`psql` is how you prove every later claim. App role should not own schema is daily operator skill.
...
**★ What is the core idea of “App role should not own schema”?**  
Application role should not own the schema — prevents accidental DDL and privilege creep.
...
← [Secrets](02-secrets.md) · Next → [pg_dump and pg_restore](04-pg-dump-restore.md)
