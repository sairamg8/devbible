---
title: "Roles GRANT REVOKE"
sidebar_label: "01 · GRANT"
sidebar_position: 1
---
...
`psql` is how you prove every later claim. Roles GRANT REVOKE is daily operator skill.
...
**★ What is the core idea of “Roles GRANT REVOKE”?**  
GRANT/REVOKE at table, column, schema, default privileges — least privilege for apps.
...
← [Phase index](README.md) · Next → [Secrets](02-secrets.md)
