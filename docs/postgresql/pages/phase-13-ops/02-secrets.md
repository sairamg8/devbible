...
`psql` is how you prove every later claim. Secrets is daily operator skill.
...
**★ What is the core idea of “Secrets”?**  
Keep connection strings out of repos, logs, and error messages.
...
← [Roles GRANT REVOKE](01-roles-grant.md) · Next → [App role should not own schema](03-app-role-not-owner.md)
