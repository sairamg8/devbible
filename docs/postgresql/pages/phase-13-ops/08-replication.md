...
`psql` is how you prove every later claim. Streaming replication replicas is daily operator skill.
...
**★ What is the core idea of “Streaming replication replicas”?**  
Streaming replicas lag; read-your-writes can fail if you read the replica immediately.
...
← [Connection limits and PgBouncer](07-pgbouncer.md) · Next → [Monitoring views](09-monitoring.md)
