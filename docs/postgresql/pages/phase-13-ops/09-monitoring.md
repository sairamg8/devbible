...
`psql` is how you prove every later claim. Monitoring views is daily operator skill.
...
**★ What is the core idea of “Monitoring views”?**  
pg_stat_activity, database/table stats, cache hit ratio — basic observability.
...
← [Streaming replication replicas](08-replication.md) · Next → [Key configuration](10-config-keys.md)
