...
`psql` is how you prove every later claim. Zero-downtime schema changes is daily operator skill.
...
**★ What is the core idea of “Zero-downtime schema changes”?**  
Know locks per ALTER; safe ordering: add nullable → backfill → constrain.
...
← [Logging slow queries](11-logging.md) · Next → [Managed PostgreSQL](13-managed-postgres.md)
