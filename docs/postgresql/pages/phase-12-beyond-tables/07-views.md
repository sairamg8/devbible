...
`psql` is how you prove every later claim. Views is daily operator skill.
...
**★ What is the core idea of “Views”?**  
Views name a query; they are not free performance and take no parameters.
...
← [pg_trgm fuzzy](06-pg-trgm.md) · Next → [Triggers](08-triggers.md)
