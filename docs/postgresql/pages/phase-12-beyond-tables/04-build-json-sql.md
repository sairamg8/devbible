...
`psql` is how you prove every later claim. Building JSON in SQL is daily operator skill.
...
**★ What is the core idea of “Building JSON in SQL”?**  
jsonb_build_object, jsonb_agg, row_to_json shape responses in SQL.
...
← [Indexing jsonb](03-index-jsonb.md) · Next → [Full-text search](05-full-text.md)
