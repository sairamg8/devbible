...
`psql` is how you prove every later claim. jsonb operators is daily operator skill.
...
**★ What is the core idea of “jsonb operators”?**  
->, ->>, #>, @>, ? and path queries are the jsonb daily drivers.
...
← [Phase index](README.md) · Next → [When a column beats JSON](02-column-vs-json.md)
