...
`psql` is how you prove every later claim. Extensions is daily operator skill.
...
**★ What is the core idea of “Extensions”?**  
pgcrypto, uuid-ossp, citext, pg_stat_statements, pg_trgm, pgvector — know create and host limits.
...
← [Triggers](08-triggers.md) · Next → [Set-returning functions in FROM](10-srf.md)
