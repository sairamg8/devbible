...
|---|---|---|---|
| 01 | **[jsonb operators](./01-jsonb-operators/README.md)** | <span className="db-tier t-master">Master</span> | arrow and containment |
...
| 05 | **[Full-text search](./05-full-text/README.md)** | <span className="db-tier t-understand">Understand</span> | tsvector |
...
← Syllabus: [Part 4](../../syllabus/04-performance-and-production.md) · Start → [jsonb operators](./01-jsonb-operators/README.md)
