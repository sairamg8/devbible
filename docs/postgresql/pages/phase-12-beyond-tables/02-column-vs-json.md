...
`psql` is how you prove every later claim. When a column beats JSON is daily operator skill.
...
**★ What is the core idea of “When a column beats JSON”?**  
Stable queried fields want columns; optional bag-of-attrs can be jsonb.
...
← [jsonb operators](01-jsonb-operators.md) · Next → [Indexing jsonb](03-index-jsonb.md)
