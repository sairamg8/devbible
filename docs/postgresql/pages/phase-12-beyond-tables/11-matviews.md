...
`psql` is how you prove every later claim. Materialized views is daily operator skill.
...
**★ What is the core idea of “Materialized views”?**  
Materialized views cache query results; REFRESH CONCURRENTLY needs unique indexes.
...
← [Set-returning functions in FROM](10-srf.md) · Next → [PL/pgSQL functions](12-plpgsql.md)
