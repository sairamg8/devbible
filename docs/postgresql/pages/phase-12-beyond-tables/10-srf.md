...
`psql` is how you prove every later claim. Set-returning functions in FROM is daily operator skill.
...
**★ What is the core idea of “Set-returning functions in FROM”?**  
generate_series, unnest, jsonb_to_recordset belong in FROM.
