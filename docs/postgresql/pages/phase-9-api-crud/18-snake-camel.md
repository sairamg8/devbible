...
This is the Node-facing half of PostgreSQL: how snake_case to camelCase shows up in a real process using `pg`.
...
**★ What is the core idea of “snake_case to camelCase”?**  
Map snake_case columns to camelCase fields in exactly one place.
...
← [created_at updated_at](17-timestamps-trigger.md) · [Phase index](README.md)
