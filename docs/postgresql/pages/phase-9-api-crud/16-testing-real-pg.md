---
title: "Testing against real PostgreSQL"
sidebar_label: "16 · Testcontainers"
sidebar_position: 16
---
...
This is the Node-facing half of PostgreSQL: how Testing against real PostgreSQL shows up in a real process using `pg`.
...
**★ What is the core idea of “Testing against real PostgreSQL”?**  
Test against real PostgreSQL (Testcontainers) with per-test rollback when possible.
...
← [Shape in SQL vs JS](15-shape-sql-vs-js.md) · Next → [created_at updated_at](17-timestamps-trigger.md)
