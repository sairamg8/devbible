...
This is the Node-facing half of PostgreSQL: how Optimistic concurrency shows up in a real process using `pg`.
...
**★ What is the core idea of “Optimistic concurrency”?**  
version column with WHERE version = $n; rowCount 0 means conflict.
...
← [Passing client through services](12-client-propagation.md) · Next → [SELECT FOR UPDATE](14-for-update.md)
