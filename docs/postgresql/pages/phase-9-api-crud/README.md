...
|---|---|---|---|
| 01 | **[Repository module per resource](01-repository.md)** | <span className="db-tier t-master">Master</span> | plain functions |
...
| 05 | **[Transactions in a request](05-transactions-request.md)** | <span className="db-tier t-master">Master</span> | try catch finally |
...
| 10 | **[Keyset pagination](10-keyset.md)** | <span className="db-tier t-understand">Understand</span> | tuple + index |
...
← Syllabus: [Part 3](../../syllabus/03-node-and-pg.md) · Start → [Repository module per resource](01-repository.md)
