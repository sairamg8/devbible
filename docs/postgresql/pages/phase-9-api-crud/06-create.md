...
This is the Node-facing half of PostgreSQL: how create INSERT RETURNING shows up in a real process using `pg`.
...
**★ What is the core idea of “create INSERT RETURNING”?**  
create uses INSERT ... RETURNING and maps the row to a domain object.
...
← [Transactions in a request](05-transactions-request.md) · Next → [findById](07-find-by-id.md)
