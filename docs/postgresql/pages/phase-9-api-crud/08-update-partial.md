...
This is the Node-facing half of PostgreSQL: how Partial updates shows up in a real process using `pg`.
...
**★ What is the core idea of “Partial updates”?**  
Partial updates: COALESCE($n, col) or dynamically build SET with allowlisted columns.
