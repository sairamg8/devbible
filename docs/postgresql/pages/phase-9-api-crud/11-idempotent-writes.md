...
This is the Node-facing half of PostgreSQL: how Idempotent writes shows up in a real process using `pg`.
...
**★ What is the core idea of “Idempotent writes”?**  
Idempotent writes use upsert or idempotency keys for clients that retry.
...
← [Keyset pagination](10-keyset.md) · Next → [Passing client through services](12-client-propagation.md)
