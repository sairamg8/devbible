...
This is the Node-facing half of PostgreSQL: how Transactions in a request shows up in a real process using `pg`.
...
**★ What is the core idea of “Transactions in a request”?**  
BEGIN/COMMIT/ROLLBACK on one checked-out client with try/catch/finally.
...
← [Sort and filter allowlists](./allowlists/) · Next → [create INSERT RETURNING](06-create.md)
