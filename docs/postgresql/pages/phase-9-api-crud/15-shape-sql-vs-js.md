---
title: "Shape in SQL vs JS"
sidebar_label: "15 · Shape trade-off"
sidebar_position: 15
---
...
This is the Node-facing half of PostgreSQL: how Shape in SQL vs JS shows up in a real process using `pg`.
...
**★ What is the core idea of “Shape in SQL vs JS”?**  
Shape aggregates in SQL (jsonb_agg) or assemble in JS — name the trade-off.
...
← [SELECT FOR UPDATE](14-for-update.md) · Next → [Testing against real PostgreSQL](16-testing-real-pg.md)
