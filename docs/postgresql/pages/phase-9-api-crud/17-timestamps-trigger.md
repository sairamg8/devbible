...
This is the Node-facing half of PostgreSQL: how created_at updated_at shows up in a real process using `pg`.
...
**★ What is the core idea of “created_at updated_at”?**  
created_at/updated_at via trigger usually beats scattered app code.
...
← [Testing against real PostgreSQL](16-testing-real-pg.md) · Next → [snake_case to camelCase](18-snake-camel.md)
