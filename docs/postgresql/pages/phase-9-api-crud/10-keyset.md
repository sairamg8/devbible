...
This is the Node-facing half of PostgreSQL: how Keyset pagination shows up in a real process using `pg`.
...
**★ What is the core idea of “Keyset pagination”?**  
Keyset uses tuple comparison plus a matching index — faster than deep OFFSET.
...
← [delete hard vs soft](09-delete-soft-hard.md) · Next → [Idempotent writes](11-idempotent-writes.md)
