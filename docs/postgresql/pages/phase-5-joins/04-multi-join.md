...
Correct SQL is the product surface of your API. Multi-table joins shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Multi-table joins”?**  
Text join order is not execution order; format long queries for humans.
...
← [Semi and anti joins](03-semi-anti.md) · Next → [Reading N-N relationships](05-nn-join-table.md)
