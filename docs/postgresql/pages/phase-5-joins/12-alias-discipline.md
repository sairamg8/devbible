...
Correct SQL is the product surface of your API. Alias discipline shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Alias discipline”?**  
Qualify every column in multi-table queries — ambiguity errors are gifts.
