...
Correct SQL is the product surface of your API. Semi and anti joins shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Semi and anti joins”?**  
EXISTS/NOT EXISTS are the safe semi/anti patterns; NOT IN breaks with NULLs.
...
← [LEFT JOIN](02-left-join.md) · Next → [Multi-table joins](04-multi-join.md)
