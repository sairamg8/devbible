...
Correct SQL is the product surface of your API. LEFT JOIN shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “LEFT JOIN”?**  
LEFT JOIN keeps left rows; filtering the right table in WHERE turns it into an inner join.
...
← [INNER JOIN](01-inner-join.md) · Next → [Semi and anti joins](03-semi-anti.md)
