...
Correct SQL is the product surface of your API. ON vs USING vs NATURAL shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “ON vs USING vs NATURAL”?**  
Prefer ON; USING is ok for same column names; avoid NATURAL JOIN.
