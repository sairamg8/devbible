...
Correct SQL is the product surface of your API. RIGHT and FULL OUTER shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “RIGHT and FULL OUTER”?**  
RIGHT is LEFT with sides flipped; FULL keeps non-matches from both.
