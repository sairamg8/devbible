...
Correct SQL is the product surface of your API. Joining on expressions shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Joining on expressions”?**  
You can join on expressions and ranges; indexes may not follow — measure.
