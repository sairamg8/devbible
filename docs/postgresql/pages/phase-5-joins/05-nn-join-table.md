...
Correct SQL is the product surface of your API. Reading N-N relationships shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “Reading N-N relationships”?**  
Traverse N-N through the join table with two joins or EXISTS.
