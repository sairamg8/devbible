...
Correct SQL is the product surface of your API. INNER JOIN shows up in list/detail/write paths constantly.
...
**★ What is the core idea of “INNER JOIN”?**  
INNER JOIN keeps rows with matches on both sides — the default relationship read.
...
← [Phase index](README.md) · Next → [LEFT JOIN](02-left-join.md)
