---
title: "Network, geometric, citext"
sidebar_label: "14 · Network types"
sidebar_position: 14
---

<span className="db-tier t-know">Know</span>

**Specialized types exist; use them when queries need their operators.**

## Why it matters

Type choices are expensive to reverse. Getting Network, geometric, citext wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “Network, geometric, citext”?**  
Specialized types exist; use them when queries need their operators.
