...
sidebar_label: "03 · text"
sidebar_position: 3
---

<span className="db-tier t-master">Master</span>

**In PostgreSQL, prefer text; length limits belong in CHECK if needed.**

## Why it matters

Type choices are expensive to reverse. Getting text vs varchar vs char wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “text vs varchar vs char”?**  
In PostgreSQL, prefer text; length limits belong in CHECK if needed.
