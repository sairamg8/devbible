---
title: "jsonb vs json"
sidebar_label: "08 · jsonb"
sidebar_position: 8
---

<span className="db-tier t-understand">Understand</span>

**jsonb is the storage/query format you want; json preserves exact text.**

## Why it matters

Type choices are expensive to reverse. Getting jsonb vs json wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “jsonb vs json”?**  
jsonb is the storage/query format you want; json preserves exact text.
