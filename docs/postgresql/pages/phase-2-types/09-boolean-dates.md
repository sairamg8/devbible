---
title: "boolean, date, interval"
sidebar_label: "09 · bool and dates"
sidebar_position: 9
---

<span className="db-tier t-understand">Understand</span>

**Use boolean with NOT NULL when tri-state is not required; date/interval for calendar math.**

## Why it matters

Type choices are expensive to reverse. Getting boolean, date, interval wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “boolean, date, interval”?**  
Use boolean with NOT NULL when tri-state is not required; date/interval for calendar math.
