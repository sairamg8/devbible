---
title: "Domains and composites"
sidebar_label: "15 · Domains"
sidebar_position: 15
---

<span className="db-tier t-know">Know</span>

**Domains package a base type + CHECK; composites are row types in a column.**

## Why it matters

Type choices are expensive to reverse. Getting Domains and composites wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “Domains and composites”?**  
Domains package a base type + CHECK; composites are row types in a column.
