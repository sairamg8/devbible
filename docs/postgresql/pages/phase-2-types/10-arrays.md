...
**Arrays are for ordered lists you query as a whole; relations still need tables.**

## Why it matters

Type choices are expensive to reverse. Getting Arrays wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “Arrays”?**  
Arrays are for ordered lists you query as a whole; relations still need tables.
