...
**Prefer bigint for identifiers; know the ranges and overflow behavior.**

## Why it matters

Type choices are expensive to reverse. Getting Integer types wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “Integer types”?**  
Prefer bigint for identifiers; know the ranges and overflow behavior.
