---
title: "Range types"
sidebar_label: "16 · Ranges"
sidebar_position: 16
---

<span className="db-tier t-when">When Needed</span>

**Range types + exclusion constraints model scheduling without homemade overlap bugs.**

## Why it matters

Type choices are expensive to reverse. Getting Range types wrong creates classes of bugs (money, time zones, ids) that appear only under load or in another region.
...
**★ What is the core idea of “Range types”?**  
Range types + exclusion constraints model scheduling without homemade overlap bugs.
