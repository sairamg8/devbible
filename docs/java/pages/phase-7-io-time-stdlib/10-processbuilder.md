...
← Prev: [Localization basics](09-localization-basics.md) · Index: [Phase 7 — I/O, time and the everyday stdlib](README.md) · Next → [Console I/O and Scanner](11-console-io-scanner.md)
