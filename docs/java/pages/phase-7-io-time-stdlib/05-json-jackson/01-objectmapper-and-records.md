...
**Fix:** validate all invariants in the compact constructor; absent-vs-null policy is [chunk 2](02-policy-decisions.md)'s subject
...
← Prev: [JSON with Jackson](README.md) · Index: [Phase 7 — I/O, time and the everyday stdlib](../README.md) · Next → [The policy decisions](02-policy-decisions.md)
