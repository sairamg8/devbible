...
🚧 **3 of 11 closed, 4 more in flight — 174 chunks and ~41,000 lines on disk.** ✅ **01 · JUnit 5 is CLOSED — 62 chunks, ~14,500 lines, plus its index**, the largest topic in the Java corpus; closing it also repaired four live 404s in the already-closed topics 02 and 03, which had been linking an index nobody had written. 02 · AssertJ (25 chunks) and 03 · Parameterized tests (38) are closed. 04 · Mockito (44, ~10,500) is written but **not yet closed — it still needs three chunks, a renumber and its `README.md` index**. 05 · The test pyramid, 06 · MockMvc and 07 · Testcontainers have opened at 2 chunks each.
...
| 04 | **Mockito** *(44 chunks, index pending)* | <span className="db-tier t-master">Master</span> | Mock boundaries, never the class under test |
