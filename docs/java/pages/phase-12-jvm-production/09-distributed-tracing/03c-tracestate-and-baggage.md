...
← [03b2 · Mutations and processing](03b2-traceparent-mutations-and-processing.md) · **Topic index** *(not written yet)* · Next → **03d · B3 and the other formats** *(not written yet)*
