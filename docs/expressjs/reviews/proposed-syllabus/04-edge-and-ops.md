---
title: "Part 4 — Edge correctness & ops boundary (proposed)"
...
## Proposed grand total (all parts)
...
### Applied from Claude verdict (2026-08-11) — additive only

Rows added (not removed): app settings · `router.param` · query parser ·
cookie-parser · SPA `/*splat` · request-id middleware. Tier flip: boundary →
Master, Zod schemas → Understand. CSRF row notes `csurf` archived.

---

← Prev: [Part 3 — API product](03-api-product.md) · Index: [Proposed syllabus](./)
