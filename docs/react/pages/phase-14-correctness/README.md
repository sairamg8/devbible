...
🚧 **1 of 14 topics written** — 3 leaf pages.
...
| 02 | **[React Testing Library's model](02-the-rtl-model.md)** | <span className="db-tier t-master">Master</span> | `render`, `screen`, and what RTL deliberately refuses to give you |
