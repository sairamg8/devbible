---
sidebar_position: 3
title: "Static vs. dynamic rendering (`force-dynamic`, `force-static`, `revalidate`)."
sidebar_label: "Static vs. dynamic rendering (`force-dynamic`, `force-static`, `revalidate`)."
description: "Static vs. dynamic rendering (`force-dynamic`, `force-static`, `revalidate`)."
---

# ▲ Static vs. dynamic rendering (`force-dynamic`, `force-static`, `revalidate`).

> **Syllabus chapter:** 4. Data Fetching in the App Router  
> **Exact concept:** Static vs. dynamic rendering (`force-dynamic`, `force-static`, `revalidate`).  
