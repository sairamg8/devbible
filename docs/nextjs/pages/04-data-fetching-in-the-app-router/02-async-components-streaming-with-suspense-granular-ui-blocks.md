---
sidebar_position: 2
title: "Async components, streaming with `<Suspense>`, granular UI blocks."
sidebar_label: "Async components, streaming with `<Suspense>`, granular UI blocks."
description: "Async components, streaming with `<Suspense>`, granular UI blocks."
---

# ▲ Async components, streaming with `<Suspense>`, granular UI blocks.

> **Syllabus chapter:** 4. Data Fetching in the App Router  
> **Exact concept:** Async components, streaming with `<Suspense>`, granular UI blocks.  
