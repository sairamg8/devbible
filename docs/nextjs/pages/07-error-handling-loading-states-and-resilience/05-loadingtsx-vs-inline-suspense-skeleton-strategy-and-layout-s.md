---
sidebar_position: 5
title: "`loading.tsx` vs. inline `<Suspense>`: skeleton strategy and layout-shift avoidance."
sidebar_label: "`loading.tsx` vs. inline `<Suspense>`: skeleton strategy and layout-shift avoidance."
description: "`loading.tsx` vs. inline `<Suspense>`: skeleton strategy and layout-shift avoidance."
---
...
> **Exact concept:** `loading.tsx` vs. inline `<Suspense>`: skeleton strategy and layout-shift avoidance.  
