---
sidebar_position: 3
title: "Server Action error contracts: returning typed errors vs. throwing; pairing with `useActionState`."
sidebar_label: "Server Action error contracts: returning typed errors vs. throwing; pairing with `useActionState`."
description: "Server Action error contracts: returning typed errors vs. throwing; pairing with `useActionState`."
---
...
> **Exact concept:** Server Action error contracts: returning typed errors vs. throwing; pairing with `useActionState`.  
