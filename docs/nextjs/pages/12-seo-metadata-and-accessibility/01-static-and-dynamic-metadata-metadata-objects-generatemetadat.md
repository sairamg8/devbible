---
sidebar_position: 1
title: "Static and dynamic metadata: `metadata` objects, `generateMetadata()` at scale."
sidebar_label: "Static and dynamic metadata: `metadata` objects, `generateMetadata()` at scale."
description: "Static and dynamic metadata: `metadata` objects, `generateMetadata()` at scale."
---

# ▲ Static and dynamic metadata: `metadata` objects, `generateMetadata()` at scale.

> **Syllabus chapter:** 12. SEO, Metadata, and Accessibility  
> **Exact concept:** Static and dynamic metadata: `metadata` objects, `generateMetadata()` at scale.  
