...
← [Offline strategy and the `useOffline` boundary](10i-offline-strategy-and-the-useoffline-boundary.md) · [Chapter 12 overview](01-explanation.md) · Next → [Cache budget and eviction](10k-service-worker-cache-budget-and-eviction.md)
