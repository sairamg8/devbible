---
sidebar_position: 5
title: "Turbopack build caches, persistent build cache, and memory eviction."
sidebar_label: "Turbopack build caches, persistent build cache, and memory eviction."
description: "Turbopack build caches, persistent build cache, and memory eviction."
---

# ▲ Turbopack build caches, persistent build cache, and memory eviction.

> **Syllabus chapter:** 5. Caching, PPR, and Cache Components  
> **Exact concept:** Turbopack build caches, persistent build cache, and memory eviction.  
