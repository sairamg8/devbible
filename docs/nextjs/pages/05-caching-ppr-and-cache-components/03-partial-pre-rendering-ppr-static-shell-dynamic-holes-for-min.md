---
sidebar_position: 3
title: "**Partial Pre-Rendering (PPR):** static shell + dynamic holes for minimal TTFB."
sidebar_label: "**Partial Pre-Rendering (PPR):** static shell + dynamic holes for minimal TTFB."
description: "**Partial Pre-Rendering (PPR):** static shell + dynamic holes for minimal TTFB."
---

# ▲ **Partial Pre-Rendering (PPR):** static shell + dynamic holes for minimal TTFB.

> **Syllabus chapter:** 5. Caching, PPR, and Cache Components  
> **Exact concept:** **Partial Pre-Rendering (PPR):** static shell + dynamic holes for minimal TTFB.  
