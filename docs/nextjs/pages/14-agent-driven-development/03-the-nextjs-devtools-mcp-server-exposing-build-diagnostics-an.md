---
sidebar_position: 3
title: "The Next.js DevTools MCP server: exposing build diagnostics and structural information to externa…"
sidebar_label: "The Next.js DevTools MCP server: exposing build diagnostics and structural information to externa…"
description: "The Next.js DevTools MCP server: exposing build diagnostics and structural information to external tools."
---

# ▲ The Next.js DevTools MCP server: exposing build diagnostics and structural information to externa…

> **Syllabus chapter:** 14. Agent-Driven Development  
> **Exact concept:** The Next.js DevTools MCP server: exposing build diagnostics and structural information to external tools.  
