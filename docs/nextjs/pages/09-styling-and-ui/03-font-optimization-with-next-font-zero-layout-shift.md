---
sidebar_position: 3
title: "Font optimization with `next/font` (zero layout shift)."
sidebar_label: "Font optimization with `next/font` (zero layout shift)."
description: "Font optimization with `next/font` (zero layout shift)."
---

# ▲ Font optimization with `next/font` (zero layout shift).

> **Syllabus chapter:** 9. Styling and UI  
> **Exact concept:** Font optimization with `next/font` (zero layout shift).  
