...
sidebar_label: "Dynamic routes (`[slug]`), catch-all, optional catch-all."
description: "Dynamic routes (`[slug]`), catch-all, optional catch-all."
---

# ▲ Dynamic routes (`[slug]`), catch-all, optional catch-all.

> **Syllabus chapter:** 2. Routing and Navigation  
> **Exact concept:** Dynamic routes (`[slug]`), catch-all, optional catch-all.  
