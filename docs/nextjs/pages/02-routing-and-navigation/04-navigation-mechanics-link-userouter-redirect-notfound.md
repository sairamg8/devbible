---
sidebar_position: 4
title: "Navigation mechanics: `<Link>`, `useRouter`, `redirect()`, `notFound()`."
sidebar_label: "Navigation mechanics: `<Link>`, `useRouter`, `redirect()`, `notFound()`."
description: "Navigation mechanics: `<Link>`, `useRouter`, `redirect()`, `notFound()`."
---

# ▲ Navigation mechanics: `<Link>`, `useRouter`, `redirect()`, `notFound()`.

> **Syllabus chapter:** 2. Routing and Navigation  
> **Exact concept:** Navigation mechanics: `<Link>`, `useRouter`, `redirect()`, `notFound()`.  
