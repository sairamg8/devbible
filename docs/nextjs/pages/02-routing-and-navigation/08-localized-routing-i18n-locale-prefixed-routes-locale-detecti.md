---
sidebar_position: 8
title: "**Localized routing (i18n):** locale-prefixed routes, locale detection in `proxy.ts`, and diction…"
sidebar_label: "**Localized routing (i18n):** locale-prefixed routes, locale detection in `proxy.ts`, and diction…"
description: "**Localized routing (i18n):** locale-prefixed routes, locale detection in `proxy.ts`, and dictionary loading patterns. *(Merged here from the former standalone "
---

# ▲ **Localized routing (i18n):** locale-prefixed routes, locale detection in `proxy.ts`, and diction…

> **Syllabus chapter:** 2. Routing and Navigation  
> **Exact concept:** **Localized routing (i18n):** locale-prefixed routes, locale detection in `proxy.ts`, and dictionary loading patterns. *(Merged here from the former standalone i18n chapter — it is fundamentally a routing concern.)*  
