---
sidebar_position: 1
title: "Server Actions for mutations with `useActionState` and `useOptimistic`."
sidebar_label: "Server Actions for mutations with `useActionState` and `useOptimistic`."
description: "Server Actions for mutations with `useActionState` and `useOptimistic`."
---
...
> **Exact concept:** Server Actions for mutations with `useActionState` and `useOptimistic`.  
