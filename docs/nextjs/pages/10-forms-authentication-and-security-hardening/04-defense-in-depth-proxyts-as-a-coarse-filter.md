---
sidebar_position: 4
title: "Defense in depth: `proxy.ts` as a coarse filter, **data-access-layer authorization as the real ga…"
sidebar_label: "Defense in depth: `proxy.ts` as a coarse filter, **data-access-layer authorization as the real ga…"
description: "Defense in depth: `proxy.ts` as a coarse filter, **data-access-layer authorization as the real gate**, per-route runtime checks."
---

# ▲ Defense in depth: `proxy.ts` as a coarse filter, **data-access-layer authorization as the real ga…

> **Syllabus chapter:** 10. Forms, Authentication, and Security Hardening  
> **Exact concept:** Defense in depth: `proxy.ts` as a coarse filter, **data-access-layer authorization as the real gate**, per-route runtime checks.  
