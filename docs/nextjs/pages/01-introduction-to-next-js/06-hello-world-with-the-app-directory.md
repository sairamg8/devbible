---
sidebar_position: 7
title: "Hello World with the `app/` directory."
sidebar_label: "Hello World with the `app/` directory."
description: "Hello World with the `app/` directory."
---

# ▲ Hello World with the `app/` directory.

> **Syllabus chapter:** 1. Introduction to Next.js  
> **Exact concept:** Hello World with the `app/` directory.  
