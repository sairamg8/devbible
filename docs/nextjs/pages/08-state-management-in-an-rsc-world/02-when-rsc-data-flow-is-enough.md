---
sidebar_position: 2
title: "When RSC data flow is enough"
sidebar_label: "When RSC data flow is enough"
description: "When RSC data flow is enough — and when it isn't (optimistic UI, cross-component client state, real-time sync)."
---

# ▲ When RSC data flow is enough

> **Syllabus chapter:** 8. State Management in an RSC World  
> **Exact concept:** When RSC data flow is enough — and when it isn't (optimistic UI, cross-component client state, real-time sync).  
