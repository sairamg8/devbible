---
sidebar_position: 6
title: "`useOptimistic` and `useActionState` as framework-native alternatives to heavy client stores."
sidebar_label: "`useOptimistic` and `useActionState` as framework-native alternatives to heavy client stores."
description: "`useOptimistic` and `useActionState` as framework-native alternatives to heavy client stores."
---
...
> **Exact concept:** `useOptimistic` and `useActionState` as framework-native alternatives to heavy client stores.  
