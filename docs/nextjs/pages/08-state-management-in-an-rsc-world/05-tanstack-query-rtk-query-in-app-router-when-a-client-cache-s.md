---
sidebar_position: 5
title: "TanStack Query / RTK Query in App Router: when a client cache still earns its place (polling, inf…"
sidebar_label: "TanStack Query / RTK Query in App Router: when a client cache still earns its place (polling, inf…"
description: "TanStack Query / RTK Query in App Router: when a client cache still earns its place (polling, infinite scroll, websocket-driven data) and when it's redundant wi"
---

# ▲ TanStack Query / RTK Query in App Router: when a client cache still earns its place (polling, inf…

> **Syllabus chapter:** 8. State Management in an RSC World  
> **Exact concept:** TanStack Query / RTK Query in App Router: when a client cache still earns its place (polling, infinite scroll, websocket-driven data) and when it's redundant with the framework cache.  
