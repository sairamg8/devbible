---
sidebar_position: 3
title: "URL as state: `searchParams`, `nuqs`-style patterns, shareable filter/sort state."
sidebar_label: "URL as state: `searchParams`, `nuqs`-style patterns, shareable filter/sort state."
description: "URL as state: `searchParams`, `nuqs`-style patterns, shareable filter/sort state."
---
...
> **Exact concept:** URL as state: `searchParams`, `nuqs`-style patterns, shareable filter/sort state.  
