---
sidebar_position: 4
title: "Client-state tools compared: React Context, Zustand, Jotai"
sidebar_label: "Client-state tools compared: React Context, Zustand, Jotai"
description: "Client-state tools compared: React Context, Zustand, Jotai — trade-offs, hydration pitfalls, per-request store instantiation to avoid state leaking between user"
---

# ▲ Client-state tools compared: React Context, Zustand, Jotai

> **Syllabus chapter:** 8. State Management in an RSC World  
> **Exact concept:** Client-state tools compared: React Context, Zustand, Jotai — trade-offs, hydration pitfalls, per-request store instantiation to avoid state leaking between users.  
