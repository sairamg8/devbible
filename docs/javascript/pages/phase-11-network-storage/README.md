...
## Status — 🚧 **Understand tier under way — 10 of 21** (2026-08-15)

**Master tier ✅ COMPLETE** — all five Master topics (01–05), written in syllabus order.

🚧 **Now the Understand tier (06–15), then Know (16–21).** **06–10 are written**; 11 onward remain.
...
| 11–15 | Uploads, `Blob`/`File`, WebSocket, `postMessage`, CSP | <span className="db-tier t-understand">Understand</span> | 🚧 next |
