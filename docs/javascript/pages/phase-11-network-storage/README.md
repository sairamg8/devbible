...
## Status — 🚧 **Understand tier under way — 12 of 21** (2026-08-15)

**Master tier ✅ COMPLETE** — all five Master topics (01–05), written in syllabus order.

🚧 **Now the Understand tier (06–15), then Know (16–21).** **06–12 are written**; 13 onward remain.
...
| 13–15 | WebSocket, same-origin and `postMessage`, CSP | <span className="db-tier t-understand">Understand</span> | 🚧 next |
