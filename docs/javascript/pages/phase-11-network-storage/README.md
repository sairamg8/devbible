...
## Status — 🚧 **Know tier under way — 16 of 21** (2026-08-15)

**Master tier ✅ COMPLETE** — all five Master topics (01–05), written in syllabus order.

✅ **The Understand tier is COMPLETE (06–15).** 🚧 **The Know tier is under way — 16 written, 17–21 remain.**
...
| 17–21 | Service workers, SSE, streams, `sendBeacon`, `XMLHttpRequest` | <span className="db-tier t-know">Know</span> | 🚧 next |
