...
## Status — 🚧 **Understand tier under way — 11 of 21** (2026-08-15)

**Master tier ✅ COMPLETE** — all five Master topics (01–05), written in syllabus order.

🚧 **Now the Understand tier (06–15), then Know (16–21).** **06–11 are written**; 12 onward remain.
...
| 12–15 | `Blob`/`File`/`FileReader`, WebSocket, `postMessage`, CSP | <span className="db-tier t-understand">Understand</span> | 🚧 next |
