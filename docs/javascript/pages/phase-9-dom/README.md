...
## Status — 🚧 **Understand tier under way — 11 of 19** (2026-08-14)
...
**07–11 are written** — Traversal, Classes and styles, Forms, Removing and replacing, Batching; 12 onward remain. Lane B of the
...
| 12–15 | Layout thrashing, measuring, scrolling, focus and accessibility | <span className="db-tier t-understand">Understand</span> | 🚧 next |
