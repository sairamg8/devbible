...
## Status — 🚧 **Master ✅ 4/4 · Understand under way — 12 of 18**
...
| 13–15 | `curry`/`pipe`/`compose`, `promisify`, a rate limiter | <span className="db-tier t-understand">Understand</span> | deferred |
