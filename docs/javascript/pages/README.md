...
| **[9 · The DOM](./phase-9-dom/README.md)** | Web APIs | 19 | 🟡 **in progress** — Master tier 05 of 6 |
...
| **Last touched** | **Phase 9 topic 05 · Attributes versus properties** — 2026-08-14 |
...
| **Next** | **Phase 9 topic 06 · Sanitising HTML** — the syllabus's flagged security topic, and the last of phase 9's Master tier |
| **Totals** | **147 pages**, 194 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
