...
| **[6 · Iteration, destructuring and generators](./phase-6-iteration-and-destructuring/README.md)** | Data & async | 13 | 🚧 **Master ✅** (01–03) · **Understand ✅ 5/5** (04–08) · Know next — **8/13** |
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🚧 **Master ✅ 11/11** · Understand under way (**12–15** ✅) — **15/22** |
...
| **[12 · The browser platform](./phase-12-browser-platform/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–02) · Understand under way (**03–06** ✅) |
...
| **B** | **6**, **17** | **19** — 6 (5: 09–13) · 17 (14: 05–18) | Iteration, generators and iterator helpers; then machine coding | 🔴 session `7c6611b4`, 2026-08-15 |
| **C** | **7**, **8** | **21** — 7 (7: 16–22) · 8 (14: 05–18) | Async beyond the Master tier; then modules, errors, memory and the toolchain | 🔴 session `f6dffd4a`, 2026-08-15 |
...
| **B** | 6 · Iteration, destructuring and generators (**8/13**) | 5 | **09 · Two-way generators** (Know) | 10 `yield*` · 11 Iterator helpers · 12 A collection class · **When Needed** 13 Driving an iterator by hand |
...
| **C** | 7 · Asynchronous JavaScript (**15**/22) | **7** | **16 · Concurrency limiting** (Understand) — ✅ 12–15 done | 17 Race conditions in a UI · 18 `queueMicrotask` · 19 Event loop: browser vs Node · **Know** 20 `Promise.withResolvers` · 21 Thenables · 22 Backpressure |
