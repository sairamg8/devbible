...
| **B** | **6**, **17** | **9** — ✅ **phase 6 COMPLETE (13/13)** · 17 (9: 10–18) | Iteration, generators and iterator helpers; then machine coding | 🔴 session `7c6611b4`, 2026-08-15 |
...
| **B** | 17 · Machine coding (**9/18**) | 9 | **10 · A Promise from scratch** (Understand) | 11 `memoize` · 12 Deep equality · 13 `curry`/`pipe`/`compose` · 14 `promisify` · 15 Rate limiter · **Know** 16 `new`/`Object.create` by hand · 17 pub/sub and signals · 18 virtual-DOM diff |
