...
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🚧 **Master ✅ 11/11** · Understand under way (**12–17** ✅) — **17/22** |
...
| **C** | **7**, **8** | **19** — 7 (5: 18–22) · 8 (14: 05–18) | Async beyond the Master tier; then modules, errors, memory and the toolchain | 🔴 session `f6dffd4a`, 2026-08-15 |
...
| **C** | 7 · Asynchronous JavaScript (**17**/22) | **5** | **18 · `queueMicrotask`** (Understand) — ✅ 12–17 done | 19 Event loop: browser vs Node · **Know** 20 `Promise.withResolvers` · 21 Thenables · 22 Backpressure |
