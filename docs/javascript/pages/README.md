...
| **[10 · Events and user input](./phase-10-events/README.md)** | Web APIs | 14 | 🚧 **Master ✅** (01–04) · Understand under way (**05–10** ✅) |
...
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **56** | session `75e511e6` |
...
| **Last touched** | **Phase 10 topic 10 · Page lifecycle** — 2026-08-15, 3 files, 409 lines. ✅ **Phase 9 before it is COMPLETE — 19 of 19, every tier, 59 files** |
| **Next** | **Phase 10 topic 11 · Default actions you should not block** — closes the Understand tier — then Know 12–14 |
| **Remaining** | **56 topics** — 10 (4), 11 (16), 12 (19), 17 (14), 18 (3) |
