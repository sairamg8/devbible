...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · **Understand tier ✅ COMPLETE** (06–15) · Know under way (**16–20** ✅) — **20/21** |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **1** — 5 ✅ **DONE 26/26** · 11 (1: **21 · `XMLHttpRequest`**) | The built-in library ✅ finished; now network, storage and data transfer | 🔴 session `3d9f98b8`, 2026-08-15 |
...
| **A** | 11 · Network, storage and data transfer (20/21) | 1 | **21 · `XMLHttpRequest`** (Know) | ✅ **Understand tier complete (06–15)** · ~~16 IndexedDB ✅~~ · ~~17 service workers ✅~~ · ~~18 SSE ✅~~ · ~~19 Streams ✅~~ · ~~20 `sendBeacon` ✅~~ · 21 `XMLHttpRequest` |
