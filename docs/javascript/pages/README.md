...
| **[10 · Events and user input](./phase-10-events/README.md)** | Web APIs | 14 | 🚧 **Master ✅** (01–04) · Understand under way (**05–09** ✅) |
...
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **57** | session `75e511e6` |
...
| **Last touched** | **Phase 10 topic 09 · Scroll, resize and visibility** — 2026-08-15, 3 files, 435 lines. ✅ **Phase 9 before it is COMPLETE — 19 of 19, every tier, 59 files** |
| **Next** | **Phase 10 topic 10 · Page lifecycle** (Understand), then 11, then Know 12–14 |
| **Remaining** | **57 topics** — 10 (5), 11 (16), 12 (19), 17 (14), 18 (3) |
