...
| **[6 · Iteration, destructuring and generators](./phase-6-iteration-and-destructuring/README.md)** | Data & async | 13 | 🚧 **Master ✅** (01–03) · Understand under way (**04–05** ✅) — **5/13** |
...
| **B** | 6 · Iteration, destructuring and generators (**5/13**) | 8 | **06 · Async iterators** (Understand) | 07 Paginating with an async generator · 08 Early exit · **Know** 09 Two-way generators · 10 `yield*` · 11 Iterator helpers · 12 A collection class · **When Needed** 13 Driving an iterator by hand |
