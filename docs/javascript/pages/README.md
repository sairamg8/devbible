...
| **A** | 11 · Network, storage and data transfer (14/21) | 7 | **15 · CSP** (Understand) | ~~13 WebSocket ✅~~ · ~~14 same-origin and `postMessage` ✅~~ · 15 CSP · **Know** 16 IndexedDB · 17 service workers · 18 SSE · 19 Streams · 20 `sendBeacon` · 21 `XMLHttpRequest` |
