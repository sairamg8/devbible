...
| **[8 · Modules, errors, memory and the toolchain](./phase-8-modules-errors/README.md)** | Data & async | 18 | 🟡 **in progress** — Master tier 02 of 4 |
...
| **Last touched** | **Phase 8 topic 02 · Modules are singletons, strict, deferred, hoisted** (2 chunks) — 2026-08-14 |
...
| **Next** | **Phase 8 topic 03 · `Error` and its subclasses**, then 04 (leaks you will actually cause) |
| **Totals** | **138 pages**, 178 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
