...
| **Next** | **Phase 3 topic 12 · Composition (`pipe`/`compose`)**, then 13–20, then phase 4. Inside each phase: **Understand → Know → When Needed** |
| **Remaining** | **205 topics** — Understand **147**, Know **55**, When Needed **3**. Thinnest phases: 12 (2/21), 16 (3/16), 13 (3/10), 6 (3/13) |
| **Totals** | **132 of 337 topics** · **231 pages** (non-`README.md` `.md` files; 336 counting every README), 312 carrying `> Verified:`, **53,684 lines**, **0 files over 300 lines**, **0 broken links**. ⚠️ The earlier "253 pages / 311 verified" figure was wrong — audited 2026-08-14 |
