...
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🟡 **in progress** — Master tier (01–03 done; 04–11 to go). The syllabus's centre of gravity |
...
| **Last touched** | Phase 6 topic 03 — **Phase 6 Master tier complete** |
...
| **Next** | **Phase 7 · Asynchronous JavaScript** — Master topics |
