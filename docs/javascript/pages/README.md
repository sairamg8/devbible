...
| **[4 · Objects, prototypes and classes](./phase-4-objects-and-classes/README.md)** | Language core | 20 | 🟡 **Master ✅** (01, 03–08) · Understand under way (02, 09, 10 done) |
...
|---|---|---|---|
| **A · The language** | **3, 4, 5, 6, 7, 8** — functions, objects, the built-in library, iteration, async, modules/errors | **63** | session `ec7d13f7` |
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **68** | session `b4ffc223` |
...
| **Last touched** | **Phase 4 topic 10 · Getters and setters** — 2026-08-14, 284 lines. ✅ **Phase 3 is COMPLETE at every tier (20/20)** |
...
| **Next** | **Phase 4 topic 11 · Property descriptors**, then 12–16 (Understand), then 17–20 (Know). Inside each phase: **Understand → Know → When Needed** |
| **Remaining** | **138 topics in the active queue** — Understand **94**, Know **41**, When Needed **3**. Plus **34 parked** (phases 13, 14, 15) and **21 dropped** (phases 16, 18). Thinnest live phase: **12 · browser platform, 2/21** |
| **Totals** | **144 of 316 in scope** (337 syllabus rows − 21 dropped) · **244 pages** (non-`README.md` `.md` files; 352 counting every README — includes lane B's), 328 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links under `docs/javascript/`**. ⚠️ The earlier "253 pages / 311 verified" figure was wrong — audited 2026-08-14 |
