...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🟡 **in progress** — Master tier 01 of 5 |
...
| **Last touched** | **Phase 11 topic 01 · `fetch`** — 2026-08-14 |
...
| **Next** | **Phase 11 topic 02 · Request bodies**, then 03–05 (a fetch wrapper, `URL`/`URLSearchParams`, CORS) |
| **Totals** | **153 pages**, 206 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
