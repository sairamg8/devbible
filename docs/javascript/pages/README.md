...
| **[4 · Objects, prototypes and classes](./phase-4-objects-and-classes/README.md)** | Language core | 20 | 🚧 **Master ✅** (01, 03–08) · Understand under way (02, 09–**12** done) |
...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · Understand under way (**06** ✅) |
...
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **51** | session `75e511e6` |
...
| **Last touched** | **Phase 4 topic 12 · `Object.freeze` and `seal`** — 2026-08-14, 3 chunks + index / 734 lines. ✅ **Phase 3 is COMPLETE at every tier (20/20)** |
...
| **Next** | **Phase 4 topic 13 · `instanceof` and `Symbol.hasInstance`**, then 14–16 (Understand), then 17–20 (Know). Inside each phase: **Understand → Know → When Needed** |
| **Remaining** | **136 topics in the active queue** — Understand **92**, Know **41**, When Needed **3**. Plus **34 parked** (phases 13, 14, 15) and **21 dropped** (phases 16, 18). Thinnest live phase: **12 · browser platform, 2/21** |
...
| **Last touched** | **Phase 11 topic 06 · `Request`, `Response` and `Headers`** — 2026-08-15, 2 files, 253 lines. ✅ **Phases 9 and 10 before it are both COMPLETE at every tier.** ✅ **Phase 10's Understand tier is COMPLETE (05–11)**. ✅ **Phase 9 before it is COMPLETE — 19 of 19, every tier, 59 files** |
| **Next** | **Phase 11 topic 07 · Reading responses** (Understand), then 08–15, then Know 16–21 |
| **Remaining** | **51 topics** — 11 (15), 12 (19), 17 (14), 18 (3). ✅ Phases **9 and 10 are both complete at every tier** |
