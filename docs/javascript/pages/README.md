...
| **[5 · The built-in library](./phase-5-built-in-library/README.md)** | Data & async | 26 | 🚧 **Master ✅ 8/8** · Understand under way (03, 08, 11–16 done) |
...
|---|---|---|---|
| **A · The language** | **3, 4, 5, 6, 7, 8** — functions, objects, the built-in library, iteration, async, modules/errors | **45** | session `edbfba95` |
...
| **Next** | **Phase 5 · 17 · `Set`**, then 18–22 and the four Know topics. **10 left in phase 5.** Inside each phase: **Understand → Know → When Needed** |
| **Remaining** | **120 topics in the active queue** — Understand **80**, Know **37**, When Needed **3**. Plus **34 parked** (phases 13, 14, 15) and **21 dropped** (phases 16, 18). Thinnest live phase: **12 · browser platform, 2/21** |
