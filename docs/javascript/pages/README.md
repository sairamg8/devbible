...
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🟡 **in progress** — Master tier **04 of 11 done** (01–04; 05–11 to go). The syllabus's centre of gravity |
...
| **Last touched** | **Phase 7 topic 04 · Callbacks** (4 chunks, 921 lines) — 2026-08-14 |
| **Done and committed** | Phases 0–2 complete · **Master tiers complete** for Phase 3 (01–08), Phase 4 (01, 03–08), Phase 5 (01, 02, 04–07, 09, 10), Phase 6 (01–03) · **Phase 7 Master 01–04** |
| **Next** | **Phase 7 topic 05 · Promises**, then 06–11 (chaining, `async`/`await`, async error handling, sequential vs parallel `await`, the `Promise` combinators, anti-patterns) |
| **Totals** | **114 pages**, 145 carrying `> Verified:`, **0 files over 300 lines** |
