...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · **Understand tier ✅ COMPLETE** (06–15) — **15/21** |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **6** — 5 ✅ **DONE 26/26** · 11 (6: 16–21, all Know) | The built-in library ✅ finished; now network, storage and data transfer | 🔴 session `3d9f98b8`, 2026-08-15 |
...
| **A** | 11 · Network, storage and data transfer (15/21) | 6 | **16 · IndexedDB** (Know) | ✅ **Understand tier complete (06–15)** · **Know** 16 IndexedDB · 17 service workers · 18 SSE · 19 Streams · 20 `sendBeacon` · 21 `XMLHttpRequest` |
