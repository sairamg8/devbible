...
| **[8 · Modules, errors, memory and the toolchain](./phase-8-modules-errors/README.md)** | Data & async | 18 | 🟡 **in progress** — Master tier 01 of 4 |
...
| **Last touched** | **Phase 8 topic 01 · ES modules** (2 chunks) — 2026-08-14 |
...
| **Next** | **Phase 8 topic 02 · Modules are singletons, strict, deferred and hoisted**, then 03–04 (`Error` and subclasses, leaks) |
| **Totals** | **136 pages**, 175 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
