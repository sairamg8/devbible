...
| **[10 · Events and user input](./phase-10-events/README.md)** | Web APIs | 14 | 🚧 **Master ✅** (01–04) · **Understand ✅** (05–11) · Know under way (**12** ✅, 13–14 left) |
...
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **54** | session `75e511e6` |
...
| **Last touched** | **Phase 10 topic 12 · `EventTarget` as a base class** — 2026-08-15, 2 files, 232 lines. ✅ **Phase 10's Understand tier is COMPLETE (05–11)**. ✅ **Phase 9 before it is COMPLETE — 19 of 19, every tier, 59 files** |
| **Next** | **Phase 10 topic 13 · Touch and gestures** (Know), then 14 closes the phase |
| **Remaining** | **54 topics** — 10 (2), 11 (16), 12 (19), 17 (14), 18 (3) |
