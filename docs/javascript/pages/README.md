...
| **[9 · The DOM](./phase-9-dom/README.md)** | Web APIs | 19 | 🚧 **Master ✅** (01–06) · **Understand ✅** (07–15) · **Know ✅** (16–18) · only 19 (When Needed) left |
...
| **Last touched** | **Phase 9 topic 18 · Shadow DOM and custom elements** — 2026-08-14, 4 files, 680 lines. ✅ **Phase 9's Know tier is COMPLETE (16–18)** |
| **Next** | **Phase 9 topic 19 · Selection, `Range` and `contenteditable`** (When Needed) closes the phase; then phase 10 from topic 05 |
| **Remaining** | **63 topics** — 9 (1), 10 (10), 11 (16), 12 (19), 17 (14), 18 (3) |
