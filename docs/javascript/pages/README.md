...
| **[3 · Functions, scope and closures](./phase-3-functions/README.md)** | Language core | 20 | 🟡 **Master ✅** (01–08) · **Understand ✅** (09–17) · Know 18 done, 19–20 left |
...
| **[9 · The DOM](./phase-9-dom/README.md)** | Web APIs | 19 | 🚧 **Master ✅** (01–06) · Understand under way (**07–09** ✅) |
...
|---|---|---|---|
| **A · The language** | **3, 4, 5, 6, 7, 8** — functions, objects, the built-in library, iteration, async, modules/errors | **68** | session `ec7d13f7` |
| **B · Platform and applied** | **9, 10, 11, 12, 17, 18** — DOM, events, network/storage, browser platform, machine coding, storefront | **72** | session `b4ffc223` |
...
| | |
|---|---|
| **Claimed by** | session `ec7d13f7` (Opus 5), from 2026-08-14 — took over from `016cfc46` ← `c5329658` ← `01ECVvH5` |
...
| **Last touched** | **Phase 3 topic 18 · IIFE and the module pattern** — 2026-08-14, 276 lines. 🔴 **Phase 3 Understand is COMPLETE (09–17); Know is 1 of 3** |
...
| **Next** | **Phase 3 topic 19 · Function properties**, then 20 · `new.target` to close phase 3, then phase 4. Inside each phase: **Understand → Know → When Needed** |
| **Remaining** | **143 topics in the active queue** — Understand **97**, Know **43**, When Needed **3**. Plus **34 parked** (phases 13, 14, 15) and **21 dropped** (phases 16, 18). Thinnest live phase: **12 · browser platform, 2/21** |
| **Totals** | **139 of 316 in scope** (337 syllabus rows − 21 dropped) · **244 pages** (non-`README.md` `.md` files; 352 counting every README — includes lane B's), 328 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links under `docs/javascript/`**. ⚠️ The earlier "253 pages / 311 verified" figure was wrong — audited 2026-08-14 |
...
| **Last touched** | **Phase 9 topic 09 · Forms** — 2026-08-14, 4 files |
| **Next** | **Phase 9 topic 10 · Removing and replacing**, then 11–15 (Understand), 16–18 (Know), 19 (When Needed); then phase 10 from topic 05 |
| **Remaining** | **72 topics** — 9 (10), 10 (10), 11 (16), 12 (19), 17 (14), 18 (3) |
