...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · **Understand tier ✅ COMPLETE** (06–15) · Know under way (**16** ✅) — **16/21** |
| **[12 · The browser platform](./phase-12-browser-platform/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–02) · **Understand tier ✅ COMPLETE** (03–13) · Know under way (**14–18** ✅) — **18/21** |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **5** — 5 ✅ **DONE 26/26** · 11 (5: 17–21, all Know) | The built-in library ✅ finished; now network, storage and data transfer | 🔴 session `3d9f98b8`, 2026-08-15 |
...
| **D** | **12**, **18** | **6** — 12 (3: 19–21) · 18 (**3**: 11, 12, 15 only) | The browser platform; then the three kept storefront topics | 🔴 session `dbaa68e7`, 2026-08-15 |
...
| **A** | 11 · Network, storage and data transfer (16/21) | 5 | **17 · Service workers and the Cache API** (Know) | ✅ **Understand tier complete (06–15)** · ~~16 IndexedDB ✅~~ · 17 service workers · 18 SSE · 19 Streams · 20 `sendBeacon` · 21 `XMLHttpRequest` |
...
| **D** | 12 · The browser platform (**18**/21) | 3 | **19 · Page Visibility, Wake Lock and Battery** (Know) — ✅ 15–18 written | 20 i18n in the browser · **When Needed** 21 `SharedArrayBuffer` |
