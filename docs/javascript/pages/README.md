...
| **[5 · The built-in library](./phase-5-built-in-library/README.md)** | Data & async | 26 | 🚧 **Master ✅ 8/8 · Understand ✅ 14/14** — **23/26**; Know 1/4, topics 24–26 remain |
...
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🚧 **Master ✅ 11/11** · **Understand ✅ 8/8** (12–19) · Know under way (**20–21** ✅) — **21/22** |
...
| **C** | **7**, **8** | **15** — 7 (**1**: Know 22) · 8 (14: 05–18) | Async beyond the Master tier; then modules, errors, memory and the toolchain | 🔴 session `f6dffd4a`, 2026-08-15 |
...
| **C** | 7 · Asynchronous JavaScript (**21**/22) | **1** | **22 · Async work and backpressure** (Know) — the LAST topic of phase 7 | then phase 7 closes and the chunk moves to phase 8 topic 05 |
