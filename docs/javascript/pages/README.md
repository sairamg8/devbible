...
| **[3 · Functions, scope and closures](./phase-3-functions/README.md)** | Language core | 20 | 🟡 **Master ✅** (01–08) · Understand under way (09) |
...
| **Last touched** | **Phase 3 topic 09 · Higher-order functions** — 2026-08-14. 🔴 **All Master tiers complete; Understand tier begun** |
...
| **Next** | **Phase 3 topic 10 · Debounce and throttle**, then 11–20, then phase 4 |
| **Totals** | **251 pages**, 309 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
