...
| **[8 · Modules, errors, memory and the toolchain](./phase-8-modules-errors/README.md)** | Data & async | 18 | 🚧 **Master ✅ 4/4** · Understand under way (**05–09** ✅) — **9/18** |
...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · Understand under way (**06–09** ✅) — **9/21** |
...
| **[17 · Machine coding: implement it yourself](./phase-17-machine-coding/README.md)** | DSA | 18 | 🚧 **Master ✅ 4/4** · Understand under way (**05–09** ✅) — **9/18** |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **12** — 5 ✅ **DONE 26/26** · 11 (12: 10–21) | The built-in library ✅ finished; now network, storage and data transfer | 🔴 session `21d2f5de`, 2026-08-15 |
...
| **C** | **7**, **8** | **9** — ✅ **phase 7 COMPLETE 22/22** · 8 (9: 10–18) | Async beyond the Master tier; then modules, errors, memory and the toolchain | 🔴 session `f6dffd4a`, 2026-08-15 |
...
| **A** | 11 · Network, storage and data transfer (9/21) | 12 | **10 · Web storage** (Understand) | 11 Uploading files · 12 `Blob`/`File` · 13 WebSocket · 14 same-origin and `postMessage` · 15 CSP · **Know** 16 IndexedDB · 17 service workers · 18 SSE · 19 Streams · 20 `sendBeacon` · 21 `XMLHttpRequest` |
...
| **C** | 8 · Modules, errors, memory and the toolchain (**9**/18) | **9** | **10 · Global error handling** (Understand) — ✅ 05–09 done | 11 The memory model · 12 Finding a leak · 13 Bundlers · 14 Testing · **Know** 15 CommonJS today · 16 `AggregateError` · 17 GC · 18 Linting |
