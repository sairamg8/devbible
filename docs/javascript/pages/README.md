...
| **[11 · Network, storage and data transfer](./phase-11-network-storage/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–05) · **Understand tier ✅ COMPLETE** (06–15) · Know under way (**16–19** ✅) — **19/21** |
| **[12 · The browser platform](./phase-12-browser-platform/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–02) · **Understand tier ✅ COMPLETE** (03–13) · **Know ✅ COMPLETE** (14–20) — **20/21**, only `SharedArrayBuffer` left |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **2** — 5 ✅ **DONE 26/26** · 11 (2: 20–21, all Know) | The built-in library ✅ finished; now network, storage and data transfer | 🔴 session `3d9f98b8`, 2026-08-15 |
...
| **D** | **12**, **18** | **4** — 12 (1: 21) · 18 (**3**: 11, 12, 15 only) | The browser platform; then the three kept storefront topics | 🔴 session `dbaa68e7`, 2026-08-15 |
...
| **A** | 11 · Network, storage and data transfer (19/21) | 2 | **20 · `sendBeacon` and keepalive** (Know) | ✅ **Understand tier complete (06–15)** · ~~16 IndexedDB ✅~~ · ~~17 service workers ✅~~ · ~~18 SSE ✅~~ · ~~19 Streams ✅~~ · 20 `sendBeacon` · 21 `XMLHttpRequest` |
...
| **D** | 12 · The browser platform (**20**/21) | 1 | **21 · `SharedArrayBuffer` and `Atomics`** (When Needed) — ✅ 15–20 written, Know tier complete | then phase 18's three kept topics |
