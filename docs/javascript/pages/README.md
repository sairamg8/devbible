...
| **[5 · The built-in library](./phase-5-built-in-library/README.md)** | Data & async | 26 | 🚧 **Master ✅ 8/8** · Understand under way (03, 08, 11–21 done) — **21/26** |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **19** — 5 (5: 22–26) · 11 (14: 08–21) | The built-in library, finished; then network, storage and data transfer | 🔴 session `21d2f5de`, 2026-08-15 |
...
|---|---|---|---|---|
| **A** | 5 · The built-in library (21/26) | 5 | **22 · Array-likes and iterables** (Understand) | **Know** 23 `WeakMap`/`WeakSet` · 24 `Temporal` · 25 typed arrays · 26 text encoding |
