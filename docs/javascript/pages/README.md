...
| **[10 · Events and user input](./phase-10-events/README.md)** | Web APIs | 14 | 🟡 **in progress** — Master tier 01 of 4 |
...
| **Last touched** | **Phase 10 topic 01 · The event model** — 2026-08-14 |
...
| **Next** | **Phase 10 topic 02 · `addEventListener`**, then 03–04 (the event object, delegation) |
| **Totals** | **149 pages**, 198 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
