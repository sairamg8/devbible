...
| **[5 · The built-in library](./phase-5-built-in-library/README.md)** | Data & async | 26 | 🚧 **Master ✅ 8/8** · Understand under way (03, 08, 11–20 done) — **20/26** |
| **[6 · Iteration, destructuring and generators](./phase-6-iteration-and-destructuring/README.md)** | Data & async | 13 | 🚧 **Master ✅** (01–03) · **Understand ✅ 5/5** (04–08) · Know under way (**09** ✅) — **9/13** |
| **[7 · Asynchronous JavaScript](./phase-7-async/README.md)** | Data & async | 22 | 🚧 **Master ✅ 11/11** · Understand under way (**12–16** ✅) — **16/22** |
...
| **[12 · The browser platform](./phase-12-browser-platform/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–02) · Understand under way (**03–07** ✅) |
...
|---|---|---|---|---|
| **A** | **5**, **11** | **20** — 5 (6: 21–26) · 11 (14: 08–21) | The built-in library, finished; then network, storage and data transfer | 🔴 session `21d2f5de`, 2026-08-15 |
| **B** | **6**, **17** | **18** — 6 (4: 10–13) · 17 (14: 05–18) | Iteration, generators and iterator helpers; then machine coding | 🔴 session `7c6611b4`, 2026-08-15 |
| **C** | **7**, **8** | **20** — 7 (6: 17–22) · 8 (14: 05–18) | Async beyond the Master tier; then modules, errors, memory and the toolchain | 🔴 session `f6dffd4a`, 2026-08-15 |
...
|---|---|---|---|---|
| **A** | 5 · The built-in library (20/26) | 6 | **21 · `structuredClone`** (Understand) | 22 Array-likes · **Know** 23 `WeakMap`/`WeakSet` · 24 `Temporal` · 25 typed arrays · 26 text encoding |
...
| **B** | 6 · Iteration, destructuring and generators (**9/13**) | 4 | **10 · `yield*` delegation** (Know) | 11 Iterator helpers · 12 A collection class · **When Needed** 13 Driving an iterator by hand |
...
| **C** | 7 · Asynchronous JavaScript (**16**/22) | **6** | **17 · Race conditions in a UI** (Understand) — ✅ 12–16 done | 18 `queueMicrotask` · 19 Event loop: browser vs Node · **Know** 20 `Promise.withResolvers` · 21 Thenables · 22 Backpressure |
...
| **D** | 12 · The browser platform (7/21) | 14 | **08 · History API and client-side routing** (Understand) | 09 `window`/`document`/`navigator` · 10 WebCrypto · 11 Accessibility · 12 Feature detection · 13 What belongs on the server · **Know** 14 Yielding to the main thread · 15 Cross-tab · 16 Clipboard/Share/FS Access · 17 Permissions/Geolocation · 18 Media · 19 Page Visibility · 20 i18n · **When Needed** 21 `SharedArrayBuffer` |
