...
| **[10 · Events and user input](./phase-10-events/README.md)** | Web APIs | 14 | 🟡 **in progress** — Master tier 03 of 4 |
...
| **Last touched** | **Phase 10 topic 03 · The event object** — 2026-08-14 |
...
| **Next** | **Phase 10 topic 04 · Event delegation** — the row the syllabus says pays for the phase, and the last of its Master tier |
| **Totals** | **151 pages**, 202 carrying `> Verified:`, **0 files over 300 lines**, **0 broken links** |
