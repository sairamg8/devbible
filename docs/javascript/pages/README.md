...
| **[6 · Iteration, destructuring and generators](./phase-6-iteration-and-destructuring/README.md)** | Data & async | 13 | 🚧 **Master ✅** (01–03) · **Understand ✅ 5/5** (04–08) · Know under way (**09–10** ✅) — **10/13** |
...
| **B** | **6**, **17** | **17** — 6 (3: 11–13) · 17 (14: 05–18) | Iteration, generators and iterator helpers; then machine coding | 🔴 session `7c6611b4`, 2026-08-15 |
...
| **B** | 6 · Iteration, destructuring and generators (**10/13**) | 3 | **11 · Iterator helpers** (Know) | 12 A collection class · **When Needed** 13 Driving an iterator by hand |
