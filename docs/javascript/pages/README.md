...
| **[8 · Modules, errors, memory and the toolchain](./phase-8-modules-errors/README.md)** | Data & async | 18 | 🚧 **Master ✅ 4/4** · Understand under way (**05–13** ✅) — **13/18** |
...
| **[12 · The browser platform](./phase-12-browser-platform/README.md)** | Web APIs | 21 | 🚧 **Master ✅** (01–02) · **Understand tier ✅ COMPLETE** (03–13) · Know under way (**14** ✅) |
...
| **[17 · Machine coding: implement it yourself](./phase-17-machine-coding/README.md)** | DSA | 18 | 🚧 **Master ✅ 4/4** · Understand under way (**05–14** ✅) — **14/18** |
...
| **B** | **6**, **17** | **4** — ✅ **phase 6 COMPLETE (13/13)** · 17 (4: 15–18) | Iteration, generators and iterator helpers; then machine coding | 🔴 session `233dede7`, 2026-08-15 (took over from `7c6611b4`) |
...
| **B** | 17 · Machine coding (**14/18**) | 4 | **15 · A rate limiter** (Understand) — ✅ 14 · `promisify` done | **Know** 16 `new`/`Object.create` by hand · 17 pub/sub and signals · 18 virtual-DOM diff |
