...
| **B** | 6 · Iteration, destructuring and generators (**4/13**) | 9 | **05 · Generators** (Understand) | 06 Async iterators · 07 Paginating with an async generator · 08 Early exit · **Know** 09 Two-way generators · 10 `yield*` · 11 Iterator helpers · 12 A collection class · **When Needed** 13 Driving an iterator by hand |
