...
## Status — 🚧 **7 of 21** · Master ✅ (01–02) · Understand under way
...
| 08–13 | History API, `window`/`document`/`navigator`, `WebCrypto`, accessibility, feature detection, what belongs on the server | <span className="db-tier t-understand">Understand</span> | 🚧 next |
...
| <span className="db-tier t-understand">Understand</span> | 11 | **5** (03–07) |
