...
|---|---|---|---|
| 01 | **`pyproject.toml`** *(not written yet)* | <span className="db-tier t-master">Master</span> | The one config file: metadata, dependencies, tool config, and the death of `setup.py` |
