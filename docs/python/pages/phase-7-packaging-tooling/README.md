...
| 06 | **[Entry points](./06-entry-points/README.md)** · 14 chunks | <span className="db-tier t-understand">Understand</span> | `[project.scripts]` — a function installed as a command |
...
group — and why a library's committed lockfile constrains only its own CI, never the projects
that depend on it ([03 · Roles, not project types](./03-dependencies/14-roles-not-project-types.md)).
