...
✅ **Phase complete — 12 of 12.** 134 files, 31,030 lines; 0 files over the 300-line cap, **0 dangling of 877 links** resolved against the filesystem, 0 MDX hazards, and every topic carrying an index that lists every chunk that exists.
...
| 06 | **[Running code](06-running-code/README.md)** | <span className="db-tier t-understand">Understand</span> | `python -m` vs `python file.py`, the rewritten REPL, `-c`, shebangs |
