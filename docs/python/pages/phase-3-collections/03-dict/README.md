...
- [06 · `collections`](../06-collections-module/README.md) owns `defaultdict`, `Counter`, `OrderedDict` and `ChainMap`, which this topic uses only at their boundary with `dict`.
