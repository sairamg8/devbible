...
🚧 **In flight — 7 of 10.** Phase 1 is 14 of 16 with one topic in flight.
...
| 06 | **[functools](./06-functools/README.md)** | <span className="db-tier t-understand">Understand</span> | `partial`, `cache`, `singledispatch`, `reduce` |
