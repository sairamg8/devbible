...
← Prev: [When it should have been a loop](08-when-it-should-have-been-a-loop.md) · Index: [Comprehensions](README.md) · Next → [When the comprehension is right](08c-when-the-comprehension-is-right.md)
