...
🚧 **In flight — 8 of 16.** Complete: **01 · Syntax and indentation** (8 chunks + index, 1,900 lines), **02 · Numbers** (69 + index, 17,166), **03 · Strings** (9 + index, ~2,150), **04 · `bytes` vs `str`** (4 + index, ~1,100), **05 · Truthiness** (12 + index, 3,261), **06 · Comparisons** (23 + index, 5,531), **07 · Assignment and aliasing** (25 + index, 6,662) and **08 · Control flow** (6 + index, 1,692). **Topics 05, 06, 07 and 08 all closed 2026-09-02** — a coordinator and two author forks running in parallel, each owning a whole topic directory. Together they add **17,146 lines, 497 gotchas and 473 interview questions**, and every one closed at **0 over the 300-line cap, 0 MDX hazards, 0 dangling links, unbroken footer chains and no duplicate `sidebar_position`**; a link resolve over all of `docs/python/pages` reports zero dangling. **Topic 09 · Comprehensions is being written now.** Topic 04 is still short one planned chunk. Topics 10–16 are unwritten.
