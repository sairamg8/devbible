...
🚧 **In flight — 10 of 16.** Complete: **01 · Syntax and indentation** (8 chunks + index, 1,900 lines), **02 · Numbers** (69 + index, 17,166), **03 · Strings** (9 + index, ~2,150), **04 · `bytes` vs `str`** (4 + index, ~1,100), **05 · Truthiness** (12 + index, 3,261), **06 · Comparisons** (23 + index, 5,531), **07 · Assignment and aliasing** (25 + index, 6,662), **08 · Control flow** (6 + index, 1,692), **10 · `match`** (4 + index, 1,101) and **13 · Unpacking** (3 + index, 802). **Six topics closed 2026-09-02** — 05, 06, 07, 08, 10 and 13 — by a coordinator and two author forks running in parallel, each owning a whole topic directory. Together they add **19,049 lines, 558 gotchas and 524 interview questions**, and every one closed at **0 over the 300-line cap, 0 MDX hazards, 0 dangling links, unbroken footer chains and no duplicate `sidebar_position`**; a link resolve over all of `docs/python/pages` reports zero dangling. **Topics 09 · Comprehensions and 11 · Exceptions are being written now.** Topic 04 is still short one planned chunk. Topics 12, 14, 15 and 16 are unwritten.
