...
← Prev: [The race between look and leap](02-the-race-between-look-and-leap.md) · Index: **EAFP vs LBYL** *(not written yet)* · Next → **Databases, networks and where the race test clears LBYL** *(not written yet)*
