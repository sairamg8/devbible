...
| 5j | **Type checkers and silent APIs** *(not written yet)* | *Being written — this row is linked the moment the file lands.* |
...
| 6g | **Width at a boundary** *(not written yet)* | *Being written — this row is linked the moment the file lands.* |
