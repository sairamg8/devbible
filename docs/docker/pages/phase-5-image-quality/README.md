...
| 02 | **The classic mistakes** *(not written yet)* | <span className="db-tier t-master">Master</span> | `apt` lists, npm cache, `.git`, `node_modules`, secrets in an early layer |
