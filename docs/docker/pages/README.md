...
| **C** | 8 · 9 | 31 (**4 left**) | 🏁 phase 8 **done 17/17** · 🚧 phase 9 **10/14** — next: **09 · 11 · Debugging Node inside a container** | 🔴 session `016J3KVb` (2026-08-15, took over from `9219957a`) |
...
| **[09 · The MERN/PERN stack in containers](./phase-9-mern-pern-stack/README.md)** | 14 | 10 | 🚧 **Writing — chunk C** |
