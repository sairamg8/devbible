...
| **D** | 10 · 11 · 12 | 44 (**16 left**) | 🏁 **Phase 10 COMPLETE 16/16** · 🚧 phase 11 **12/16** — next: **Phase 11 · 13 · Docker CLI compatibility** | 🔴 session `8e7b6e12` (2026-08-16, took over from `75a196a7`) |
...
| **[11 · Podman in depth](./phase-11-podman-in-depth/README.md)** | 16 | 12 | 🚧 **Writing — chunk D** |
