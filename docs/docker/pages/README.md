...
| **C** | 8 · 9 | 31 (**3 left**) | 🏁 phase 8 **done 17/17** · 🚧 phase 9 **11/14** — next: **09 · 12 · A React/Vite frontend** | 🔴 session `016J3KVb` (2026-08-15, took over from `9219957a`) |
...
| **[09 · The MERN/PERN stack in containers](./phase-9-mern-pern-stack/README.md)** | 14 | 11 | 🚧 **Writing — chunk C** |
