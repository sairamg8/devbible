...
| **[04 · Build strategy: cache, multi-stage, BuildKit](./phase-4-build-strategy/README.md)** | 16 | 5 | 🚧 **Writing — chunk A** |
| **05 · Image quality, size and supply chain** | 12 | 0 | ⏳ Not started — **chunk A** |
| **[06 · Storage: volumes, mounts and data](./phase-6-storage/README.md)** | 12 | 3 | 🚧 **Writing — chunk B** |
