...
| **C** | 8 · 9 | 31 (**6 left**) | 🏁 phase 8 **done 17/17** · 🚧 phase 9 **8/14** — next: **09 · 09 · Redis in a container** | 🔴 session `016J3KVb` (2026-08-15, took over from `9219957a`) |
...
| **[09 · The MERN/PERN stack in containers](./phase-9-mern-pern-stack/README.md)** | 14 | 8 | 🚧 **Writing — chunk C** |
