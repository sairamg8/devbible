...
| **C** | 8 · 9 | 31 (**11 left**) | 🏁 phase 8 **done 17/17** · 🚧 phase 9 **3/14** — next: **09 · 04 · Waiting for the database** | 🔴 session `9219957a` (2026-08-15) |
...
| **[09 · The MERN/PERN stack in containers](./phase-9-mern-pern-stack/README.md)** | 14 | 3 | 🚧 **Writing — chunk C** |
