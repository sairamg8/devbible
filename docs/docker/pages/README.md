...
| **[04 · Build strategy: cache, multi-stage, BuildKit](./phase-4-build-strategy/README.md)** | 16 | 14 | 🚧 **Writing — chunk A** |
| **05 · Image quality, size and supply chain** | 12 | 0 | ⏳ Not started — **chunk A** |
| **[06 · Storage: volumes, mounts and data](./phase-6-storage/README.md)** | 12 | 8 | 🚧 **Writing — chunk B** |
...
| **[10 · Running containers in production](./phase-10-production/README.md)** | 16 | 4 | 🚧 **Writing — chunk D** |
