...
| **D** | 10 · 11 · 12 | 44 (**21 left**) | 🏁 **Phase 10 COMPLETE 16/16** · 🚧 phase 11 **7/16** — next: **Phase 11 · 08 · `podman pod create` / `ps` / `rm`** | 🔴 session `8e7b6e12` (2026-08-16, took over from `75a196a7`) |
...
| **[11 · Podman in depth](./phase-11-podman-in-depth/README.md)** | 16 | 7 | 🚧 **Writing — chunk D** |
