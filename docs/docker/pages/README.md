...
| **C** | 8 · 9 | 31 (**7 left**) | 🏁 phase 8 **done 17/17** · 🚧 phase 9 **7/14** — next: **09 · 08 · MongoDB in a container** | 🔴 session `016J3KVb` (2026-08-15, took over from `9219957a`) |
...
| **[09 · The MERN/PERN stack in containers](./phase-9-mern-pern-stack/README.md)** | 14 | 7 | 🚧 **Writing — chunk C** |
| **[10 · Running containers in production](./phase-10-production/README.md)** | 16 | 16 | ✅ **Complete — chunk D** |
| **[11 · Podman in depth](./phase-11-podman-in-depth/README.md)** | 16 | 4 | 🚧 **Writing — chunk D** |
