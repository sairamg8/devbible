...
| **D** | 10 · 11 · 12 | 44 (**14 left**) | 🏁 **Phase 10 COMPLETE 16/16** · 🚧 phase 11 **14/16** — next: **Phase 11 · 15 · `podman machine`** | 🔴 session `8e7b6e12` (2026-08-16, took over from `75a196a7`) |
...
| **[11 · Podman in depth](./phase-11-podman-in-depth/README.md)** | 16 | 14 | 🚧 **Writing — chunk D** |
