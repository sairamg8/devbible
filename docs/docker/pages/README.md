...
| **B** | 6 · 7 | 26 | 🏁 phase 6 **done 12/12** · 🚧 phase 7 **9/14** — next: **07 · 10 · `--network=host`** | 🔴 session `d0c46f84` (2026-08-15) |
...
| **[07 · Networking](./phase-7-networking/README.md)** | 14 | 9 | 🚧 **Writing — chunk B** |
