...
| **[6 — TypeScript](./phase-6-typescript/README.md)** | Shared types, zod inference, typed `pg` results, the order state machine, typed Express handlers, typed custom hooks | 🚧 6 / 8 |
