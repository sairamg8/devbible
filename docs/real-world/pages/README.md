...
| **[6 — TypeScript](./phase-6-typescript/README.md)** | Shared types, zod inference, typed `pg` results, the order state machine, typed Express handlers, typed custom hooks, the typed API client | 🚧 7 / 8 |
...
| **[8 — The MongoDB mirror](./phase-8-mongodb-mirror/README.md)** | The same data layer on MongoDB for MERN | 🚧 4 / 6 |
