...
← Prev: [`providedIn: 'root'` vs the array](14-providedin-root-vs-the-array.md) · Index: [Topic index](README.md) · Next → [What `'root'` resolves to](14c-what-root-resolves-to-and-the-other-scopes.md)
