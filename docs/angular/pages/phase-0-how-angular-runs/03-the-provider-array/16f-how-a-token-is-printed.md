...
← Prev: [The two message shapes](16e-the-two-message-shapes.md) · Index: [Topic index](README.md) · Next → [Not there, or not reachable](16g-not-there-or-not-reachable.md)
