...
🚧 **In progress — 5 of 12 closed** (measured off disk 2026-09-09).
...
12 concepts. Topic **06** is open and being written. Topics **07–12** are unstarted but all six have
a research bank. The table below is the phase's running order, tier by tier. A title that is
