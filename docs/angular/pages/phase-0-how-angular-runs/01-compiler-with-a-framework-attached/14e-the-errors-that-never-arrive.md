...
the rest of the unswitchable checks in **[14k · The checks with no switch](14k-the-checks-with-no-switch.md)**.
...
**[14j · The event, reference and generics flags](14j-the-event-reference-and-generics-flags.md)**. Recognise the shape: an implicitly-`any`
...
`strictContextGenerics`, in **[14j · The event, reference and generics flags](14j-the-event-reference-and-generics-flags.md)**. The point
