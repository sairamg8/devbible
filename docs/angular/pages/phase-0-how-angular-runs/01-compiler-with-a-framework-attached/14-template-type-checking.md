...
- **`typeParamsStr`** — the component's own generic parameters are copied onto the generated
  ...
  `strictContextGenerics` (**[14j](14j-the-event-reference-and-generics-flags.md)**).
...
what `strictDomLocalRefTypes` toggles (**[14j](14j-the-event-reference-and-generics-flags.md)**).
...
(**[14k](14k-the-checks-with-no-switch.md)**).
