...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-type-level', name: 'Type-level programming', part: 'Types at scale', topics: 16, pages: 7, pagesPlanned: 16},
      ...
      {n: 10, slug: 'phase-10-strictness', name: 'Strictness and correctness', part: 'Rigour and tooling', topics: 13, pages: 8, pagesPlanned: 13},
