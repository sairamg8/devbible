...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 9, slug: 'phase-9-dom', name: 'The DOM', part: 'Web APIs', topics: 19, pages: 12, pagesPlanned: 19},
  ...
  react: {
    ...
    phases: [
      ...
      {n: 10, slug: 'phase-10-server-components', name: 'Server Components and Server Functions', part: 'Concurrent and server', topics: 19, pages: 6, pagesPlanned: 19},
