...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 10, slug: 'phase-10-events', name: 'Events and user input', part: 'Web APIs', topics: 14, pages: 1, pagesPlanned: 14},
  ...
  react: {
    ...
    phases: [
      ...
      {n: 6, slug: 'phase-6-performance', name: 'Rendering performance and the React Compiler', part: 'Hooks, completely', topics: 17, pages: 6, pagesPlanned: 17},
