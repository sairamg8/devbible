...
export const LANGUAGES = {
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-image-quality', name: 'Image quality, size and supply chain', part: 'Building images', topics: 12, pages: 1, pagesPlanned: 12},
      ...
      {n: 8, slug: 'phase-8-compose', name: 'Compose', part: 'Running a real stack', topics: 17, pages: 9, pagesPlanned: 17},
