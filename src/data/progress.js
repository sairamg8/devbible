...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-built-in-library', name: 'The built-in library', part: 'Data & async', topics: 26, pages: 25, pagesPlanned: 26},
      ...
      {n: 11, slug: 'phase-11-network-storage', name: 'Network, storage and data transfer', part: 'Web APIs', topics: 21, pages: 7, pagesPlanned: 21},
      {n: 12, slug: 'phase-12-browser-platform', name: 'The browser platform', part: 'Web APIs', topics: 21, pages: 9, pagesPlanned: 21},
      ...
      {n: 17, slug: 'phase-17-machine-coding', name: 'Machine coding: implement it yourself', part: 'DSA & machine coding', topics: 18, pages: 6, pagesPlanned: 18},
      {n: 18, slug: 'phase-18-storefront', name: 'Building the store front end', part: 'Applied storefront', topics: 10, pages: 7, pagesPlanned: 10},
    ],
  },
  typescript: {
    label: 'TypeScript',
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-generics', name: 'Generics', part: 'The type system', topics: 14, pages: 11, pagesPlanned: 14},
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 4, slug: 'phase-4-build-strategy', name: 'Build strategy: cache, multi-stage, BuildKit', part: 'Building images', topics: 16, pages: 0},
      {n: 5, slug: 'phase-5-image-quality', name: 'Image quality, size and supply chain', part: 'Building images', topics: 12, pages: 0},
      {n: 6, slug: 'phase-6-storage', name: 'Storage: volumes, mounts and data', part: 'Running a real stack', topics: 12, pages: 0},
