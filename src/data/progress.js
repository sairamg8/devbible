...
export const LANGUAGES = {
  ...
  'tanstack-query': {
    ...
    phases: [
      ...
      {n: 2, slug: '02-usequery-deep-dive', name: "Usequery deep dive", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 3, slug: '03-query-states', name: "Query states", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 4, slug: '04-caching-and-invalidation', name: "Caching and invalidation", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
