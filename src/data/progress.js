...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-functions', name: 'Functions, scope and closures', part: 'Language core', topics: 20, pages: 10, pagesPlanned: 20},
      ...
      {n: 18, slug: 'phase-18-storefront', name: 'Building the store front end', part: 'Applied storefront', topics: 18, pages: 7, pagesPlanned: 18},
    ],
  },
  typescript: {
    label: 'TypeScript',
