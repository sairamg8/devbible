...
export const LANGUAGES = {
  ...
  nextjs: {
    ...
    phases: [
      ...
      {n: 2, slug: '02-routing-and-navigation', name: "Routing and navigation", part: 'Imported corpus', topics: 20, pages: 20},
      ...
      {n: 4, slug: '04-data-fetching-in-the-app-router', name: "Data fetching in the App Router", part: 'Imported corpus', topics: 18, pages: 18},
      ...
      {n: 7, slug: '07-error-handling-loading-states-and-resilience', name: "Error handling, loading states and resilience", part: 'Imported corpus', topics: 14, pages: 14},
      {n: 8, slug: '08-state-management-in-an-rsc-world', name: "State management in an RSC world", part: 'Imported corpus', topics: 10, pages: 10},
      {n: 9, slug: '09-styling-and-ui', name: "Styling and UI", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 10, slug: '10-forms-authentication-and-security-hardening', name: "Forms, authentication and security hardening", part: 'Imported corpus', topics: 13, pages: 13},
      {n: 11, slug: '11-performance-optimization-turbopack', name: "Performance optimization and Turbopack", part: 'Imported corpus', topics: 10, pages: 10},
      {n: 12, slug: '12-seo-metadata-and-accessibility', name: "SEO, metadata and accessibility", part: 'Imported corpus', topics: 24, pages: 24},
      {n: 13, slug: '13-testing-and-developer-experience', name: "Testing and developer experience", part: 'Imported corpus', topics: 10, pages: 10},
      {n: 14, slug: '14-agent-driven-development', name: "Agent-driven development", part: 'Imported corpus', topics: 8, pages: 8},
      {n: 15, slug: '15-databases-apis-and-full-stack-patterns', name: "Databases, APIs and full-stack patterns", part: 'Imported corpus', topics: 12, pages: 12},
      {n: 16, slug: '16-deployment-scaling-and-observability', name: "Deployment, scaling and observability", part: 'Imported corpus', topics: 16, pages: 16},
