...
export const LANGUAGES = {
  css: {
    ...
    phases: [
      ...
      {n: 2, slug: 'phase-2-cascade', name: 'Cascade control', part: 'How CSS resolves', topics: 7, pages: 0},
      {n: 3, slug: 'phase-3-custom-properties', name: 'Custom properties and modern values', part: 'Values and layout', topics: 8, pages: 0},
      {n: 4, slug: 'phase-4-flexbox', name: 'Flexbox, deeply', part: 'Values and layout', topics: 12, pages: 0},
      {n: 5, slug: 'phase-5-grid', name: 'Grid, deeply', part: 'Values and layout', topics: 16, pages: 0},
      {n: 6, slug: 'phase-6-container-queries', name: 'Container queries and intrinsic responsive', part: 'Adaptive and visual', topics: 8, pages: 0},
      {n: 7, slug: 'phase-7-positioning', name: 'Positioning, stacking and overlay', part: 'Adaptive and visual', topics: 7, pages: 0},
      {n: 8, slug: 'phase-8-color-theming', name: 'Colour and theming', part: 'Adaptive and visual', topics: 7, pages: 0},
      {n: 9, slug: 'phase-9-motion', name: 'Motion and the cost model', part: 'Adaptive and visual', topics: 8, pages: 0},
      {n: 10, slug: 'phase-10-scss', name: 'SCSS in 2026', part: 'SCSS and architecture', topics: 9, pages: 0},
      {n: 11, slug: 'phase-11-architecture', name: 'Architecture and the stack', part: 'SCSS and architecture', topics: 9, pages: 0},
    ],
  },
  javascript: {
    label: 'JavaScript',
    ...
    phases: [
      ...
      {n: 4, slug: 'phase-4-objects', name: 'Objects, prototypes and classes', part: 'Language core', topics: 20, pages: 0},
      {n: 5, slug: 'phase-5-builtins', name: 'The built-in library', part: 'Data & async', topics: 26, pages: 0},
      {n: 6, slug: 'phase-6-iteration', name: 'Iteration, destructuring and generators', part: 'Data & async', topics: 13, pages: 0},
      {n: 7, slug: 'phase-7-async', name: 'Asynchronous JavaScript', part: 'Data & async', topics: 22, pages: 0},
