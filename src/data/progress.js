...
export const LANGUAGES = {
  css: {
    ...
    phases: [
      ...
      {n: 10, slug: 'phase-10-scss', name: 'SCSS, practically', part: 'SCSS', topics: 8, pages: 6, pagesPlanned: 8},
    ],
  },
  javascript: {
    label: 'JavaScript',
    ...
    phases: [
      ...
      {n: 9, slug: 'phase-9-dom', name: 'The DOM', part: 'Web APIs', topics: 19, pages: 2, pagesPlanned: 19},
  ...
  expressjs: {
    ...
    phases: [
      ...
      {n: 8, slug: 'phase-8-validation-authz', name: 'Validation and authorization', part: 'Edge & ops', topics: 13, pages: 3, pagesPlanned: 13},
