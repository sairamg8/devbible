...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 11, slug: 'phase-11-testing', name: 'Testing', part: 'Production', topics: 11, pages: 7, pagesPlanned: 11},
      {n: 12, slug: 'phase-12-jvm-production', name: 'The JVM in production', part: 'Production', topics: 15, pages: 0},
      {n: 13, slug: 'phase-13-oauth2-oidc', name: 'OAuth2, OIDC and service security', part: 'Distributed', topics: 14, pages: 0},
  ...
  python: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-language-core', name: 'Language core', part: 'Foundations', topics: 16, pages: 3, pagesPlanned: 16},
