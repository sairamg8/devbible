...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-type-level', name: 'Type-level programming', part: 'Types at scale', topics: 16, pages: 10, pagesPlanned: 16},
      {n: 6, slug: 'phase-6-modules-build', name: 'Modules, declarations and the build', part: 'Types at scale', topics: 16, pages: 6, pagesPlanned: 16},
      {n: 7, slug: 'phase-7-server', name: 'TypeScript on the server (Master rows only — rest dropped)', part: 'In the stack', topics: 5, pages: 5},
      {n: 10, slug: 'phase-10-strictness', name: 'Strictness and correctness', part: 'Rigour and tooling', topics: 13, pages: 10, pagesPlanned: 13},
