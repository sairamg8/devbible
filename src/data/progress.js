...
export const LANGUAGES = {
  ...
  dsa: {
    label: 'DSA',
    updated: '2026-09-07 07:21',
    docsPath: '/docs/dsa',
    pagesPath: '/docs/dsa/pages',
    // Syllabus complete 2026-09-07 (session ebd67cf9) — 301 topics, 21 phases, 8 parts. No pages yet.
    phases: [
      {n: 0, slug: 'phase-0-the-interview-and-practice', name: "The DSA interview and the practice system", part: "Foundations", topics: 14, pages: 0},
  ...
  'system-design': {
    label: 'System Design',
    updated: '2026-09-07 07:08',
    docsPath: '/docs/system-design',
    pagesPath: '/docs/system-design/pages',
    // Syllabus complete 2026-09-07 (session ebd67cf9) — 472 topics, 24 phases, 13 parts. No pages yet.
    phases: [
      {n: 0, slug: 'phase-0-the-interview', name: "What system design interviews test", part: "The method", topics: 13, pages: 0},
      {n: 1, slug: 'phase-1-the-method', name: "The method: requirements to deep dives", part: "The method", topics: 18, pages: 0},
      {n: 2, slug: 'phase-2-request-path', name: "The request path: DNS to gateway", part: "Network path & caching", topics: 18, pages: 0},
