...
export const LANGUAGES = {
  ...
  nextjs: {
    ...
    phases: [
      ...
      {n: 2, slug: '02-routing-and-navigation', name: "Routing and navigation", part: 'Imported corpus', topics: 9, pages: 9},
      ...
      {n: 4, slug: '04-data-fetching-in-the-app-router', name: "Data fetching in the App Router", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 5, slug: '05-caching-ppr-and-cache-components', name: "Caching, PPR and Cache Components", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 6, slug: '06-ssg-isr-and-ssr-strategy', name: "SSG, ISR and SSR strategy", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 7, slug: '07-error-handling-loading-states-and-resilience', name: "Error handling, loading states and resilience", part: 'Imported corpus', topics: 8, pages: 8},
      {n: 8, slug: '08-state-management-in-an-rsc-world', name: "State management in an RSC world", part: 'Imported corpus', topics: 8, pages: 8},
      {n: 9, slug: '09-styling-and-ui', name: "Styling and UI", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 10, slug: '10-forms-authentication-and-security-hardening', name: "Forms, authentication and security hardening", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 11, slug: '11-performance-optimization-turbopack', name: "Performance optimization and Turbopack", part: 'Imported corpus', topics: 8, pages: 8},
      {n: 12, slug: '12-seo-metadata-and-accessibility', name: "SEO, metadata and accessibility", part: 'Imported corpus', topics: 7, pages: 7},
      {n: 13, slug: '13-testing-and-developer-experience', name: "Testing and developer experience", part: 'Imported corpus', topics: 6, pages: 6},
  ...
  java: {
    ...
    phases: [
      ...
      {n: 12, slug: 'phase-12-jvm-production', name: 'The JVM in production', part: 'Production', topics: 15, pages: 11, pagesPlanned: 15},
