...
export const LANGUAGES = {
  ...
  react: {
    ...
    phases: [
      ...
      {n: 15, slug: 'patterns', name: 'Patterns — choosing a shape', part: 'Patterns', topics: 6, pages: 2, pagesPlanned: 6},
    ],
  },
  nodejs: {
    label: 'Node.js',
  ...
  realworld: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-js-functions', name: 'JavaScript custom functions', part: 'Frontend', topics: 10, pages: 5, pagesPlanned: 10},
