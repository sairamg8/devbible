...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 9, slug: 'phase-9-dom', name: 'The DOM', part: 'Web APIs', topics: 19, pages: 13, pagesPlanned: 19},
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 2, slug: 'phase-2-narrowing', name: 'Narrowing and control flow analysis', part: 'The type system', topics: 13, pages: 8, pagesPlanned: 13},
  ...
  react: {
    ...
    phases: [
      ...
      {n: 11, slug: 'phase-11-ssr-hydration', name: 'Server rendering, hydration and the DOM APIs', part: 'Concurrent and server', topics: 17, pages: 10, pagesPlanned: 17},
