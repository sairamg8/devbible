...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 11, slug: 'phase-11-testing', name: 'Testing', part: 'Production', topics: 11, pages: 5, pagesPlanned: 11},
  ...
  python: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-language-core', name: 'Language core', part: 'Foundations', topics: 16, pages: 1, pagesPlanned: 16},
