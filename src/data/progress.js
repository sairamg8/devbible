...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 10, slug: 'phase-10-data-access', name: 'Data access', part: 'Application', topics: 14, pages: 11, pagesPlanned: 14},
  ...
  python: {
    ...
    phases: [
      {n: 0, slug: 'phase-0-runtime', name: 'The runtime', part: 'Foundations', topics: 12, pages: 0},
