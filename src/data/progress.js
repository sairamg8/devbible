...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 11, slug: 'phase-11-testing', name: 'Testing', part: 'Production', topics: 11, pages: 3, pagesPlanned: 11},
  ...
  python: {
    ...
    phases: [
      {n: 0, slug: 'phase-0-runtime', name: 'The runtime', part: 'Foundations', topics: 12, pages: 11, pagesPlanned: 12},
