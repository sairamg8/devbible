...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-generics-collections', name: 'Generics and collections', part: 'Core library', topics: 16, pages: 11, pagesPlanned: 16},
      {n: 4, slug: 'phase-4-lambdas-streams', name: 'Lambdas, streams and Optional', part: 'Core library', topics: 13, pages: 3, pagesPlanned: 13},
