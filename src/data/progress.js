...
export const LANGUAGES = {
  ...
  nextjs: {
    ...
    phases: [
      ...
      {n: 7, slug: '07-error-handling-loading-states-and-resilience', name: "Error handling, loading states and resilience", part: 'Refreshed for 16.3', topics: 14, pages: 6, pagesPlanned: 14},
