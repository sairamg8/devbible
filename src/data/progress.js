...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-functions', name: 'Functions, scope and closures', part: 'Language core', topics: 20, pages: 13, pagesPlanned: 20},
  ...
  git: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-everyday-loop', name: 'The everyday loop', part: 'How Git works', topics: 16, pages: 1, pagesPlanned: 16},
