...
export const LANGUAGES = {
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 6, slug: 'phase-6-storage', name: 'Storage: volumes, mounts and data', part: 'Running a real stack', topics: 12, pages: 10},
      {n: 7, slug: 'phase-7-networking', name: 'Networking', part: 'Running a real stack', topics: 14, pages: 0},
      {n: 8, slug: 'phase-8-compose', name: 'Compose', part: 'Running a real stack', topics: 17, pages: 7, pagesPlanned: 17},
