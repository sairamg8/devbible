...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-functions', name: 'Functions, scope and closures', part: 'Language core', topics: 20, pages: 15, pagesPlanned: 20},
  ...
  git: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-everyday-loop', name: 'The everyday loop', part: 'How Git works', topics: 12, pages: 6, pagesPlanned: 12},
