...
export const LANGUAGES = {
  ...
  'system-design': {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-the-method', name: "The method: requirements to deep dives", part: "The method", topics: 18, pages: 12},
