...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 4, slug: 'phase-4-classes-declarations', name: 'Classes, objects and declaration merging', part: 'Types at scale', topics: 14, pages: 5, pagesPlanned: 14},
      ...
      {n: 7, slug: 'phase-7-server', name: 'TypeScript on the server', part: 'In the stack', topics: 15, pages: 5, pagesPlanned: 15},
