...
export const LANGUAGES = {
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 9, slug: 'phase-9-mern-pern-stack', name: 'The MERN/PERN stack in containers', part: 'Running a real stack', topics: 14, pages: 7, pagesPlanned: 14},
      {n: 10, slug: 'phase-10-production', name: 'Running containers in production', part: 'Production and depth', topics: 16, pages: 16},
      {n: 11, slug: 'phase-11-podman-in-depth', name: 'Podman in depth', part: 'Production and depth', topics: 16, pages: 4, pagesPlanned: 16},
