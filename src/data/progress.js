...
export const LANGUAGES = {
  css: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-grid', name: 'Grid, deeply', part: 'Values and layout', topics: 10, pages: 6, pagesPlanned: 16},
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 8, slug: 'phase-8-modules-errors', name: 'Modules, errors, memory and the toolchain', part: 'Data & async', topics: 18, pages: 1, pagesPlanned: 18},
  ...
  react: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-refs-context-reducers', name: 'Refs, context and reducers', part: 'Hooks, completely', topics: 16, pages: 3, pagesPlanned: 16},
