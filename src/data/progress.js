...
export const LANGUAGES = {
  ...
  python: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-collections', name: 'Collections in depth', part: 'Data model', topics: 12, pages: 3},
      ...
      {n: 7, slug: 'phase-7-packaging-tooling', name: 'Packaging, projects and tooling', part: 'Application', topics: 12, pages: 3, pagesPlanned: 12},
