...
export const LANGUAGES = {
  ...
  'vite': {
    ...
    phases: [
      {n: 1, slug: '01-core-architecture', name: "Core architecture", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 2, slug: '02-cli-and-scaffolding', name: "Cli and scaffolding", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 3, slug: '03-configuration', name: "Configuration", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 4, slug: '04-dev-server-mechanics', name: "Dev server mechanics", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
  ...
  'tanstack-query': {
    ...
    phases: [
      ...
      {n: 8, slug: '08-dependent-and-parallel-queries', name: "Dependent and parallel queries", part: 'Imported corpus', topics: 1, pages: 7, verified: 7},
      {n: 9, slug: '09-prefetching-and-ssr', name: "Prefetching and ssr", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      {n: 10, slug: '10-suspense-integration', name: "Suspense integration", part: 'Imported corpus', topics: 1, pages: 4, verified: 4},
      {n: 11, slug: '11-devtools', name: "Devtools", part: 'Imported corpus', topics: 1, pages: 6, verified: 6},
      {n: 12, slug: '12-query-cancellation', name: "Query cancellation", part: 'Imported corpus', topics: 1, pages: 1, verified: 1},
      ...
      {n: 16, slug: '16-migration-recipes', name: "Migration recipes", part: 'Imported corpus', topics: 1, pages: 10, verified: 10},
      {n: 17, slug: '17-the-2026-toolchain-landscape', name: "The 2026 toolchain landscape", part: 'Written for this bible', topics: 1, pages: 6, verified: 6},
    ],
  },
  'framer-motion': {
  ...
  dsa: {
    label: 'DSA',
    updated: '2026-09-08 19:25',
    docsPath: '/docs/dsa',
    pagesPath: '/docs/dsa/pages',
    // Syllabus complete 2026-09-07 (session ebd67cf9) — 301 topics, 21 phases, 8 parts. Pages: phases 0-2 complete.
    phases: [
      {n: 0, slug: 'phase-0-the-interview-and-practice', name: "The DSA interview and the practice system", part: "Foundations", topics: 14, pages: 14},
      {n: 1, slug: 'phase-1-complexity', name: "Complexity analysis", part: "Foundations", topics: 11, pages: 11},
      {n: 2, slug: 'phase-2-recursion-maths-bits', name: "Recursion, maths and bits", part: "Foundations", topics: 13, pages: 13},
      {n: 3, slug: 'phase-3-arrays-hashing-prefix', name: "Arrays, hashing and prefix sums", part: "Arrays, strings & hashing", topics: 16, pages: 0},
      {n: 4, slug: 'phase-4-two-pointers-sliding-window', name: "Two pointers and sliding window", part: "Arrays, strings & hashing", topics: 13, pages: 0},
      {n: 5, slug: 'phase-5-strings', name: "Strings", part: "Arrays, strings & hashing", topics: 13, pages: 0},
      {n: 6, slug: 'phase-6-stacks-queues-monotonic', name: "Stacks, queues and monotonic structures", part: "Linear structures & binary search", topics: 11, pages: 0},
      {n: 7, slug: 'phase-7-linked-lists', name: "Linked lists", part: "Linear structures & binary search", topics: 13, pages: 0},
      {n: 8, slug: 'phase-8-binary-search', name: "Binary search", part: "Linear structures & binary search", topics: 12, pages: 0},
      {n: 9, slug: 'phase-9-trees-and-bsts', name: "Binary trees and BSTs", part: "Trees, heaps & tries", topics: 14, pages: 0},
      {n: 10, slug: 'phase-10-heaps', name: "Heaps and priority queues", part: "Trees, heaps & tries", topics: 11, pages: 0},
      {n: 11, slug: 'phase-11-tries-segment-fenwick', name: "Tries, segment trees and Fenwick trees", part: "Trees, heaps & tries", topics: 11, pages: 0},
      {n: 12, slug: 'phase-12-graph-fundamentals', name: "Graph fundamentals, traversal and union-find", part: "Graphs", topics: 16, pages: 0},
      {n: 13, slug: 'phase-13-shortest-paths-advanced', name: "Shortest paths and advanced graph algorithms", part: "Graphs", topics: 15, pages: 0},
      {n: 14, slug: 'phase-14-backtracking', name: "Backtracking", part: "Backtracking, greedy & DP", topics: 13, pages: 0},
      {n: 15, slug: 'phase-15-greedy', name: "Greedy", part: "Backtracking, greedy & DP", topics: 14, pages: 0},
      {n: 16, slug: 'phase-16-dynamic-programming', name: "Dynamic programming", part: "Backtracking, greedy & DP", topics: 26, pages: 0},
      {n: 17, slug: 'phase-17-design-flavoured-concurrency', name: "Design-flavoured problems and concurrency", part: "Design-flavoured & applied", topics: 15, pages: 0},
      {n: 18, slug: 'phase-18-applied-algorithms', name: "The algorithms behind the systems you run", part: "Design-flavoured & applied", topics: 18, pages: 0},
      {n: 19, slug: 'phase-19-the-ladder', name: "The problem ladder, pattern by pattern", part: "The ladder & the plan", topics: 22, pages: 0},
      {n: 20, slug: 'phase-20-the-plan', name: "Interview formats, the plan and the last two weeks", part: "The ladder & the plan", topics: 10, pages: 0},
    ],
  },
  'system-design': {
    label: 'System Design',
    updated: '2026-09-07 18:02',
    ...
    phases: [
      ...
      {n: 2, slug: 'phase-2-request-path', name: "The request path: DNS to gateway", part: "Network path & caching", topics: 18, pages: 18},
      ...
      {n: 6, slug: 'phase-6-consistency-and-consensus', name: "Consistency, clocks and consensus", part: "Distributed theory", topics: 18, pages: 0},
      {n: 7, slug: 'phase-7-distributed-transactions', name: "Distributed transactions, IDs and the probabilistic toolkit", part: "Distributed theory", topics: 17, pages: 0},
      {n: 8, slug: 'phase-8-messaging-fundamentals', name: "Messaging fundamentals and choosing a broker", part: "Event streaming", topics: 19, pages: 0},
      {n: 9, slug: 'phase-9-kafka-and-cdc', name: "Kafka, CDC and event-driven architecture", part: "Event streaming", topics: 18, pages: 0},
      {n: 10, slug: 'phase-10-rest', name: "REST done properly", part: "API design", topics: 19, pages: 0},
      {n: 11, slug: 'phase-11-graphql-grpc-contracts', name: "GraphQL, gRPC, tRPC, realtime and contracts", part: "API design", topics: 17, pages: 0},
      {n: 12, slug: 'phase-12-cloud-aws', name: "Cloud on AWS, with the GCP and Azure map", part: "Cloud, K8s & IaC", topics: 18, pages: 0},
      {n: 13, slug: 'phase-13-kubernetes', name: "Kubernetes", part: "Cloud, K8s & IaC", topics: 22, pages: 0},
      {n: 14, slug: 'phase-14-iac-and-delivery', name: "Infrastructure as code and delivery", part: "Cloud, K8s & IaC", topics: 18, pages: 0},
      {n: 15, slug: 'phase-15-reliability', name: "Reliability engineering", part: "Reliability & observability", topics: 17, pages: 0},
      {n: 16, slug: 'phase-16-observability', name: "Observability at scale", part: "Reliability & observability", topics: 15, pages: 0},
      {n: 17, slug: 'phase-17-security-compliance', name: "Security and compliance at scale", part: "Security & compliance", topics: 25, pages: 0},
      {n: 18, slug: 'phase-18-ai-systems', name: "LLM applications in the stack", part: "AI systems", topics: 28, pages: 0},
      {n: 19, slug: 'phase-19-oo-design-machine-coding', name: "Object-oriented design and the machine-coding round", part: "Low-level design", topics: 21, pages: 0},
      {n: 20, slug: 'phase-20-lld-catalogue', name: "The LLD problem catalogue", part: "Low-level design", topics: 30, pages: 0},
      {n: 21, slug: 'phase-21-classic-systems', name: "The classic systems", part: "HLD catalogue", topics: 35, pages: 0},
      {n: 22, slug: 'phase-22-india-scale-systems', name: "Product-company systems, India-scale", part: "HLD catalogue", topics: 18, pages: 0},
      {n: 23, slug: 'phase-23-senior-loop', name: "The senior loop, proof of work and the plan", part: "The senior loop", topics: 18, pages: 0},
    ],
  },
  java: {
    label: 'Java',
  ...
  python: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-language-core', name: 'Language core', part: 'Foundations', topics: 16, pages: 16, pagesPlanned: 16},
      {n: 2, slug: 'phase-2-functions', name: 'Functions, closures and decorators', part: 'Foundations', topics: 10, pages: 10, pagesPlanned: 10},
      {n: 3, slug: 'phase-3-collections', name: 'Collections in depth', part: 'Data model', topics: 12, pages: 7},
      ...
      {n: 7, slug: 'phase-7-packaging-tooling', name: 'Packaging, projects and tooling', part: 'Application', topics: 12, pages: 5, pagesPlanned: 12},
