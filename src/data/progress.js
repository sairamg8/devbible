...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 6, slug: 'phase-6-modules-build', name: 'Modules, declarations and the build', part: 'Types at scale', topics: 16, pages: 12, pagesPlanned: 16},
      ...
      {n: 12, slug: 'phase-12-tooling', name: 'Tooling, performance and testing', part: 'Rigour and tooling', topics: 15, pages: 1, pagesPlanned: 15},
    ],
  },
  mongodb: {
    label: 'MongoDB',
