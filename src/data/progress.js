...
export const LANGUAGES = {
  ...
  dsa: {
    label: 'DSA',
    updated: '2026-09-07 08:20',
    docsPath: '/docs/dsa',
    pagesPath: '/docs/dsa/pages',
    // Syllabus complete 2026-09-07 (session ebd67cf9) — 301 topics, 21 phases, 8 parts. No pages yet.
    phases: [
      {n: 0, slug: 'phase-0-the-interview-and-practice', name: "The DSA interview and the practice system", part: "Foundations", topics: 14, pages: 11},
