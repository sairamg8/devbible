...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-type-level', name: 'Type-level programming', part: 'Types at scale', topics: 16, pages: 11, pagesPlanned: 16},
      {n: 6, slug: 'phase-6-modules-build', name: 'Modules, declarations and the build', part: 'Types at scale', topics: 16, pages: 7, pagesPlanned: 16},
