...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 3, slug: 'phase-3-generics', name: 'Generics', part: 'The type system', topics: 14, pages: 13, pagesPlanned: 14},
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 9, slug: 'phase-9-mern-pern-stack', name: 'The MERN/PERN stack in containers', part: 'Running a real stack', topics: 14, pages: 1, pagesPlanned: 14},
      {n: 10, slug: 'phase-10-production', name: 'Running containers in production', part: 'Production and depth', topics: 16, pages: 12, pagesPlanned: 16},
