...
export const LANGUAGES = {
  css: {
    ...
    phases: [
      ...
      {n: 4, slug: 'phase-4-flexbox', name: 'Flexbox, deeply', part: 'Values and layout', topics: 7, pages: 13},
      ...
      {n: 8, slug: 'phase-8-color-theming', name: 'Colour and theming', part: 'Adaptive and visual', topics: 3, pages: 0},
      {n: 9, slug: 'phase-9-motion', name: 'Motion and the cost model', part: 'Adaptive and visual', topics: 3, pages: 0},
      {n: 10, slug: 'phase-10-scss', name: 'SCSS, practically', part: 'SCSS', topics: 8, pages: 0},
    ],
  },
  javascript: {
    label: 'JavaScript',
    ...
    phases: [
      ...
      {n: 8, slug: 'phase-8-modules-errors', name: 'Modules, errors, memory and the toolchain', part: 'Data & async', topics: 18, pages: 2, pagesPlanned: 18},
      ...
      {n: 11, slug: 'phase-11-network-storage', name: 'Network, storage and data transfer', part: 'Web APIs', topics: 21, pages: 0},
      {n: 12, slug: 'phase-12-browser-platform', name: 'The browser platform', part: 'Web APIs', topics: 21, pages: 0},
  ...
  mongodb: {
    ...
    phases: [
      {n: 0, slug: 'phase-0-how-mongodb-runs', name: 'How MongoDB runs', part: 'The document model', topics: 14, pages: 0},
      {n: 1, slug: 'phase-1-documents-and-bson', name: 'Documents, BSON types and _id', part: 'The document model', topics: 13, pages: 0},
      {n: 2, slug: 'phase-2-mongosh', name: 'mongosh, mastered', part: 'The document model', topics: 12, pages: 0},
      {n: 3, slug: 'phase-3-schema-design', name: 'Schema design and modelling', part: 'The document model', topics: 16, pages: 0},
      {n: 4, slug: 'phase-4-crud', name: 'CRUD and DML', part: 'Querying', topics: 16, pages: 0},
      {n: 5, slug: 'phase-5-query-operators', name: 'Query operators and projection', part: 'Querying', topics: 14, pages: 0},
      {n: 6, slug: 'phase-6-aggregation', name: 'The aggregation pipeline', part: 'Querying', topics: 20, pages: 0},
      {n: 7, slug: 'phase-7-indexes', name: 'Indexes and the query planner', part: 'Querying', topics: 12, pages: 0},
      {n: 8, slug: 'phase-8-node-driver', name: 'The Node.js driver, end to end', part: 'From Node', topics: 16, pages: 0},
      {n: 9, slug: 'phase-9-mongoose', name: 'Mongoose', part: 'From Node', topics: 18, pages: 0},
      {n: 10, slug: 'phase-10-transactions', name: 'Transactions, sessions and consistency', part: 'From Node', topics: 12, pages: 0},
      {n: 11, slug: 'phase-11-replication-sharding', name: 'Replication, sharding and the cluster', part: 'Production', topics: 12, pages: 0},
      {n: 12, slug: 'phase-12-performance-ops', name: 'Performance, monitoring and operations', part: 'Production', topics: 11, pages: 0},
      {n: 13, slug: 'phase-13-security', name: 'Security and deployment', part: 'Production', topics: 10, pages: 0},
      {n: 14, slug: 'phase-14-storefront', name: 'The storefront data layer', part: 'Production', topics: 8, pages: 0},
    ],
  },
  react: {
    label: 'React',
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-refs-context-reducers', name: 'Refs, context and reducers', part: 'Hooks, completely', topics: 16, pages: 8, pagesPlanned: 16},
  ...
  expressjs: {
    ...
    phases: [
      ...
      {n: 6, slug: 'phase-6-rest-surface', name: 'REST surface and API features', part: 'API product', topics: 14, pages: 3, pagesPlanned: 14},
