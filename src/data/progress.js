...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      ...
      {n: 5, slug: 'phase-5-type-level', name: 'Type-level programming', part: 'Types at scale', topics: 16, pages: 1, pagesPlanned: 16},
      ...
      {n: 10, slug: 'phase-10-strictness', name: 'Strictness and correctness', part: 'Rigour and tooling', topics: 13, pages: 6, pagesPlanned: 13},
  ...
  realworld: {
    ...
    phases: [
      ...
      {n: 7, slug: 'phase-7-css-recipes', name: 'CSS recipes', part: 'Completion', topics: 6, pages: 1, pagesPlanned: 6},
