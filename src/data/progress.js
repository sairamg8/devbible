...
export const LANGUAGES = {
  ...
  java: {
    ...
    phases: [
      ...
      {n: 11, slug: 'phase-11-testing', name: 'Testing', part: 'Production', topics: 11, pages: 2, pagesPlanned: 11},
  ...
  python: {
    label: 'Python',
    updated: '2026-08-28 12:32',
    docsPath: '/docs/python',
    pagesPath: '/docs/python/pages',
    phases: [
      {n: 0, slug: 'phase-0-runtime', name: 'The runtime', part: 'Foundations', topics: 12, pages: 7, pagesPlanned: 12},
