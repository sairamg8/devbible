...
export const LANGUAGES = {
  ...
  javascript: {
    ...
    phases: [
      ...
      {n: 8, slug: 'phase-8-modules-errors', name: 'Modules, errors, memory and the toolchain', part: 'Data & async', topics: 18, pages: 17, pagesPlanned: 18},
      ...
      {n: 11, slug: 'phase-11-network-storage', name: 'Network, storage and data transfer', part: 'Web APIs', topics: 21, pages: 13, pagesPlanned: 21},
      {n: 12, slug: 'phase-12-browser-platform', name: 'The browser platform', part: 'Web APIs', topics: 21, pages: 15, pagesPlanned: 21},
      ...
      {n: 17, slug: 'phase-17-machine-coding', name: 'Machine coding: implement it yourself', part: 'DSA & machine coding', topics: 18, pages: 16, pagesPlanned: 18},
