...
export const LANGUAGES = {
  ...
  realworld: {
    ...
    phases: [
      ...
      {n: 6, slug: 'phase-6-typescript', name: 'TypeScript across the stack', part: 'Frontend', topics: 8, pages: 4, pagesPlanned: 8},
  ...
  java: {
    ...
    phases: [
      ...
      {n: 12, slug: 'phase-12-jvm-production', name: 'The JVM in production', part: 'Production', topics: 15, pages: 7},
  ...
  python: {
    ...
    phases: [
      ...
      {n: 1, slug: 'phase-1-language-core', name: 'Language core', part: 'Foundations', topics: 16, pages: 4, pagesPlanned: 16},
