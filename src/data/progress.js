...
export const LANGUAGES = {
  ...
  typescript: {
    ...
    phases: [
      {n: 0, slug: 'phase-0-how-typescript-runs', name: 'How TypeScript runs', part: 'The type system', topics: 13, pages: 0},
      {n: 1, slug: 'phase-1-type-vocabulary', name: 'The type vocabulary', part: 'The type system', topics: 17, pages: 0},
