...
export const LANGUAGES = {
  ...
  docker: {
    ...
    phases: [
      ...
      {n: 7, slug: 'phase-7-networking', name: 'Networking', part: 'Running a real stack', topics: 14, pages: 8, pagesPlanned: 14},
      {n: 8, slug: 'phase-8-compose', name: 'Compose', part: 'Running a real stack', topics: 17, pages: 14, pagesPlanned: 17},
